...
#define KEXEC_CONTROL_CODE	TO_CAC(0x100000UL)
#define KEXEC_CMDLINE_ADDR	TO_CAC(0x108000UL)
...
static atomic_t kexec_ready_to_reboot = ATOMIC_INIT(0);
#endif
