...
{
	if (cpu_has_rixi) {
		protection_map[0]  = __pgprot(_page_cachable_default | _PAGE_PROTNONE | _PAGE_NO_EXEC | _PAGE_NO_READ);
		...
		protection_map[8]  = __pgprot(_page_cachable_default | _PAGE_PROTNONE | _PAGE_NO_EXEC | _PAGE_NO_READ);
