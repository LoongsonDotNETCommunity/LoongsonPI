...
static bool lt9721_chip_id_verify(struct bridge_phy *phy, char *str)
{
...
static enum hpd_status lt9721_get_hpd_status(struct bridge_phy *phy)
{
	u32 val;
...
int lt9721_hdmi_rx_cdr(struct bridge_phy *phy)
{
...
int lt9721_rx_pll(struct bridge_phy *phy)
{
...
static int lt9721_tx_phy(struct bridge_phy *phy)
{
...
static int lt9721_tx_pll_cfg(struct bridge_phy *phy)
{
...
int lt9721_hdmi_format(struct bridge_phy *phy)
{
...
static int lt9721_bl_ctrl(struct bridge_phy *phy, int mode)
{
...
static int lt9721_mode_set(struct drm_bridge *bridge,
...
static int lt9721_video_input_cfg(struct bridge_phy *phy)
{
	lt9721_tx_phy(phy);
...
static int lt9721_video_output_cfg(struct bridge_phy *phy)
{
