...
//
static void ResetLedStatus(PLED_871x	pLed)
{
		...
		case LED_PIN_LED0:
			if (BOARD_USB_COMBO == pHalData->BoardType) {
				...
				if (pHalData->bLedOpenDrain ==
				    _TRUE) // Open-drain arrangement for controlling the LED
