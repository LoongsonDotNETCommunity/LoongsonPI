...
static u32
RF_REG_Param_for_C_CUT_5G_internalPA[3][RF_REG_NUM_for_C_CUT_5G_internalPA]
= {
...
struct hal_data_8192de {
	...
	IQKMatrixRegSetting[IQK_Matrix_Settings_NUM];	// 1->2G,24->5G 20M channel,21->5G 40M channel.
#endif
...
void InterruptRecognized8192DE(PADAPTER Adapter,
			       PRT_ISR_CONTENT pIsrContent);
VOID UpdateInterruptMask8192DE(PADAPTER Adapter, u32 AddMSR,
			       u32 RemoveMSR);
#endif
...
VOID rtl8192d_EfuseParseChnlPlan(PADAPTER Adapter, u8 *hwinfo,
				 BOOLEAN AutoLoadFail);
VOID rtl8192d_ReadTxPowerInfo(PADAPTER Adapter, u8 *PROMContent,
			      BOOLEAN AutoLoadFail);
...
extern void Hal_MPT_CCKTxPowerAdjustbyIndex(PADAPTER pAdapter,
		BOOLEAN beven);
