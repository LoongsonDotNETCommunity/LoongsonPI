...
extern void init_addba_retry_timer(_adapter *padapter,
				   struct sta_info *psta);
...
int judge_network_type(_adapter *padapter, unsigned char *rate,
		       int ratelen);
...
int update_sta_support_rate(_adapter *padapter, u8 *pvar_ie,
...
int rtw_get_ch_setting_union(_adapter *adapter, u8 *ch, u8 *bw,
			     u8 *offset);
