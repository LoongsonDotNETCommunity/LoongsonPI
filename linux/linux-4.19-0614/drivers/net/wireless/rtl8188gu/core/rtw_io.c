...
int rf_read_sniff_num = sizeof(rf_read_sniff_ranges) / sizeof(
				struct rf_sniff_ent);
int rf_write_sniff_num = sizeof(rf_write_sniff_ranges) / sizeof(
				 struct rf_sniff_ent);
...
u8 dbg_rtw_read8(_adapter *adapter, u32 addr, const char *caller,
		 const int line)
{
...
u16 dbg_rtw_read16(_adapter *adapter, u32 addr, const char *caller,
		   const int line)
{
...
u32 dbg_rtw_read32(_adapter *adapter, u32 addr, const char *caller,
		   const int line)
{
...
int dbg_rtw_write8(_adapter *adapter, u32 addr, u8 val, const char *caller,
		   const int line)
{
...
int dbg_rtw_write16(_adapter *adapter, u32 addr, u16 val,
...
int dbg_rtw_write32(_adapter *adapter, u32 addr, u32 val,
		    const char *caller, const int line)
{
...
int dbg_rtw_writeN(_adapter *adapter, u32 addr, u32 length, u8 *data,
		   const char *caller, const int line)
{
