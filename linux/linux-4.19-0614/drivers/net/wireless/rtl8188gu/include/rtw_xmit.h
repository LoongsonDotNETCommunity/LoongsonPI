...
extern struct xmit_frame *__rtw_alloc_cmdxmitframe(struct xmit_priv
		*pxmitpriv,
		enum cmdbuf_type buf_type);
#define rtw_alloc_cmdxmitframe(p) __rtw_alloc_cmdxmitframe(p, CMDBUF_RSVD)
#if defined(CONFIG_RTL8192E) && defined(CONFIG_PCI_HCI)
extern struct xmit_frame *__rtw_alloc_cmdxmitframe_8192ee(
...
extern struct xmit_frame *__rtw_alloc_cmdxmitframe_8822be(
	struct xmit_priv *pxmitpriv,
	enum cmdbuf_type buf_type);
...
extern struct xmit_frame *__rtw_alloc_cmdxmitframe_8821ce(
	struct xmit_priv *pxmitpriv,
	enum cmdbuf_type buf_type);
...
void rtw_count_tx_stats(_adapter *padapter, struct xmit_frame *pxmitframe,
			int sz);
...
extern s32 rtw_make_wlanhdr(_adapter *padapter, u8 *hdr,
			    struct pkt_attrib *pattrib);
...
extern s32 rtw_xmitframe_enqueue(_adapter *padapter,
				 struct xmit_frame *pxmitframe);
extern struct xmit_frame *rtw_dequeue_xframe(struct xmit_priv *pxmitpriv,
		struct hw_xmit *phwxmit_i, sint entry);

extern s32 rtw_xmit_classifier(_adapter *padapter,
			       struct xmit_frame *pxmitframe);
extern u32 rtw_calculate_wlan_pkt_size_by_attribue(struct pkt_attrib
		*pattrib);
#define rtw_wlan_pkt_size(f) rtw_calculate_wlan_pkt_size_by_attribue(&f->attrib)
extern s32 rtw_xmitframe_coalesce(_adapter *padapter, _pkt *pkt,
				  struct xmit_frame *pxmitframe);
#ifdef CONFIG_IEEE80211W
extern s32 rtw_mgmt_xmitframe_coalesce(_adapter *padapter, _pkt *pkt,
				       struct xmit_frame *pxmitframe);
...
extern void rtw_amsdu_set_timer_status(_adapter *padapter, u8 priority,
				       u8 status);
...
extern s32 rtw_xmitframe_coalesce_amsdu(_adapter *padapter,
...
extern struct xmit_frame *rtw_get_xframe(struct xmit_priv *pxmitpriv,
		int *num_frame);
#endif
...
static void do_queue_select(_adapter *padapter,
			    struct pkt_attrib *pattrib);
