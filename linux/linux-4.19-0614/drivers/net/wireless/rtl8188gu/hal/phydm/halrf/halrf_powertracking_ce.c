...
)
{
	...
	if (p_dm->support_ic_type == ODM_RTL8188E
		...
		if (p_dm->support_ic_type == ODM_RTL8812
			...
			bb_swing = phy_get_tx_bb_swing_8812a(adapter,
							     p_hal_data->current_band_type, RF_PATH_A);
...
)
{
	...
	if (!p_dm->rf_calibrate_info.tm_trigger) {
		...
		if (IS_HARDWARE_TYPE_8188E(adapter) || IS_HARDWARE_TYPE_8188F(adapter)
		    ...
		    || IS_HARDWARE_TYPE_8723B(adapter) || IS_HARDWARE_TYPE_JAGUAR(adapter)
