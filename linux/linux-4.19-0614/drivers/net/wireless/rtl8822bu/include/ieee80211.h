...
u8 *rtw_set_ie(u8 *pbuf, sint index, uint len, const u8 *source,
	       uint *frlen);
...
u8 *rtw_set_ie_mesh_ch_switch_parm(u8 *buf, u32 *buf_len, u8 ttl, u8 flags,
				   u16 reason, u16 precedence);
...
u8 *rtw_bss_ex_get_p2p_ie(WLAN_BSSID_EX *bss_ex, u8 *p2p_ie,
			  uint *p2p_ielen);
...
u8 *rtw_bss_ex_get_wfd_ie(WLAN_BSSID_EX *bss_ex, u8 *wfd_ie,
			  uint *wfd_ielen);
