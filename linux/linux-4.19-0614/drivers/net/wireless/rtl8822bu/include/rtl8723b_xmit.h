...
void rtl8723b_fill_fake_txdesc(PADAPTER padapter, u8 *pDesc, u32 BufferLen,
...
s32	rtl8723bs_hal_xmitframe_enqueue(_adapter *padapter,
...
s32	 rtl8723bu_hal_xmitframe_enqueue(_adapter *padapter,
		struct xmit_frame *pxmitframe);
/* s32 rtl8812au_xmit_buf_handler(PADAPTER padapter); */
void rtl8723bu_xmit_tasklet(void *priv);
s32 rtl8723bu_xmitframe_complete(_adapter *padapter,
...
s32	rtl8723be_hal_xmitframe_enqueue(_adapter *padapter,
					struct xmit_frame *pxmitframe);
