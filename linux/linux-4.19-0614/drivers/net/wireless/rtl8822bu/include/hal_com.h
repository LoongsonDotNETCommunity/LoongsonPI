...
void rtw_restore_mac_addr(_adapter
			  *adapter);/*set mac addr when hal_init for all iface*/
...
u8 rtw_hal_busagg_qsel_check(_adapter *padapter, u8 pre_qsel,
			     u8 next_qsel);
...
int rtw_hal_get_rsvd_page(_adapter *adapter, u32 page_offset, u32 page_num,
			  u8 *buffer, u32 buffer_size);
void rtw_hal_construct_beacon(_adapter *padapter, u8 *pframe,
			      u32 *pLength);
