...
void rtl8188f_fill_fake_txdesc(PADAPTER padapter, u8 *pDesc, u32 BufferLen,
...
s32	rtl8188fs_hal_xmitframe_enqueue(_adapter *padapter,
...
s32	 rtl8188fu_hal_xmitframe_enqueue(_adapter *padapter,
		struct xmit_frame *pxmitframe);
/* s32 rtl8812au_xmit_buf_handler(PADAPTER padapter); */
void rtl8188fu_xmit_tasklet(void *priv);
s32 rtl8188fu_xmitframe_complete(_adapter *padapter,
...
s32	rtl8188fe_hal_xmitframe_enqueue(_adapter *padapter,
					struct xmit_frame *pxmitframe);
