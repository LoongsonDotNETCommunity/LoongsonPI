...
u8 rtw_wapi_check_for_drop(_adapter *padapter,
			   union recv_frame *precv_frame, u8 *ehdr_ops);
...
int rtw_wapi_create_event_send(_adapter *padapter, u8 EventId, u8 *MacAddr,
			       u8 *Buff, u16 BufLen);
