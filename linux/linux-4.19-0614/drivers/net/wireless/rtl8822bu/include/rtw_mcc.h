...
u8 rtw_hal_dl_mcc_fw_rsvd_page(_adapter *adapter, u8 *pframe, u16 *index
			       , u8 tx_desc, u32 page_size, u8 *total_page_num,
			       RSVDPAGE_LOC *rsvd_page_loc, u8 *page_num);
...
void update_mcc_mgntframe_attrib(_adapter *padapter,
...
void rtw_hal_mcc_update_macid_bitmap(PADAPTER padapter, int mac_id,
				     u8 add);
