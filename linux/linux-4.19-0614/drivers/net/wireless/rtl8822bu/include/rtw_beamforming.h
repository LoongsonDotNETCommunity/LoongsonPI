...
enum beamforming_cap rtw_bf_bfee_get_entry_cap_by_macid(void *mlmepriv,
		u8 mac_id);
...
u8 rtw_bf_send_vht_gid_mgnt_packet(PADAPTER, u8 *ra, u8 *gid,
				   u8 *position);
...
void rtw_bf_update_attrib(PADAPTER, struct pkt_attrib *,
			  struct sta_info *);
