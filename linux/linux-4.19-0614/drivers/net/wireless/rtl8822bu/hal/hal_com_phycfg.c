...
static void dump_pg_txpwr_info_2g(void *sel, TxPowerInfo24G *txpwr_info,
				  u8 rfpath_num, u8 max_tx_cnt)
{
	...
	for (path = 0; path < MAX_RF_PATH && path < rfpath_num; path++) {
		RTW_PRINT_SEL(sel, "[%c]: ", rf_path_char(path));
		for (tx_idx = RF_1TX; tx_idx < MAX_TX_COUNT
		     && tx_idx < max_tx_cnt; tx_idx++)
...
static void dump_pg_txpwr_info_5g(void *sel, TxPowerInfo5G *txpwr_info,
				  u8 rfpath_num, u8 max_tx_cnt)
{
	int path, group, tx_idx;
...
const struct map_t pg_txpwr_def_info =
	MAP_ENT(0xB8, 1, 0xFF
		, MAPSEG_ARRAY_ENT(0x10, 168,
				   ...
				   ,
...
static const struct map_t rtl8821a_pg_txpwr_def_info =
	MAP_ENT(0xB8, 1, 0xFF
		, MAPSEG_ARRAY_ENT(0x10, 39,
				   0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x24,
				   0xFF, 0xFF, 0xFF, 0xFF,
				   0xFF, 0xFF, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A,
				   0x2A, 0x2A, 0x2A, 0x2A,
...
static const struct map_t rtl8821c_pg_txpwr_def_info =
	MAP_ENT(0xB8, 1, 0xFF
		, MAPSEG_ARRAY_ENT(0x10, 54,
				   0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x02,
				   0xFF, 0xFF, 0xFF, 0xFF,
				   0xFF, 0xFF, 0x28, 0x28, 0x28, 0x28, 0x28, 0x28, 0x28, 0x28, 0x28, 0x28,
				   0x28, 0x28, 0x28, 0x28,
				   0x02, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xEC, 0xFF, 0xFF, 0xFF, 0x2D, 0x2D,
				   0x2D, 0x2D, 0x2D, 0x2D,
...
static const struct map_t rtl8812a_pg_txpwr_def_info =
	MAP_ENT(0xB8, 1, 0xFF
		, MAPSEG_ARRAY_ENT(0x10, 82,
				   ...
				   0xFF, 0xFF, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A,
				   0x2A, 0x2A, 0x2A, 0x2A,
				   0x02, 0xEE, 0xFF, 0xFF, 0xEE, 0xFF, 0x00, 0xEE, 0xFF, 0xFF, 0x2D, 0x2D,
				   0x2D, 0x2D, 0x2D, 0x2D,
				   0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x02, 0xEE, 0xEE, 0xFF, 0xFF, 0xFF, 0xFF,
				   0x2A, 0x2A, 0x2A, 0x2A,
				   0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x02, 0xEE,
				   0xFF, 0xFF, 0xEE, 0xFF,
				   0x00, 0xEE)
	       );
#endif
...
static const struct map_t rtl8822b_pg_txpwr_def_info =
	MAP_ENT(0xB8, 1, 0xFF
		, MAPSEG_ARRAY_ENT(0x10, 82,
				   ...
				   0xFF, 0xFF, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A,
				   0x2A, 0x2A, 0x2A, 0x2A,
				   0x02, 0xEE, 0xFF, 0xFF, 0xEE, 0xFF, 0xEC, 0xEC, 0xFF, 0xFF, 0x2D, 0x2D,
				   0x2D, 0x2D, 0x2D, 0x2D,
				   0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x02, 0xEE, 0xEE, 0xFF, 0xFF, 0xFF, 0xFF,
				   0x2A, 0x2A, 0x2A, 0x2A,
				   0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x02, 0xEE,
...
static const struct map_t rtl8814a_pg_txpwr_def_info =
	MAP_ENT(0xB8, 1, 0xFF
		, MAPSEG_ARRAY_ENT(0x10, 168,
				   ...
				   ,
...
static u8 hal_chk_pg_txpwr_info_2g(_adapter *adapter,
...
static u8 hal_chk_pg_txpwr_info_5g(_adapter *adapter,
...
static inline void hal_init_pg_txpwr_info_2g(_adapter *adapter,
		TxPowerInfo24G *pwr_info)
{
	struct hal_spec_t *hal_spec = GET_HAL_SPEC(adapter);
	u8 path, group, tx_idx;
...
static inline void hal_init_pg_txpwr_info_5g(_adapter *adapter,
		TxPowerInfo5G *pwr_info)
{
#ifdef CONFIG_IEEE80211_BAND_5GHZ
	struct hal_spec_t *hal_spec = GET_HAL_SPEC(adapter);
	...
	u16 pg_offset)
{
			...
			if (!IS_PG_TXPWR_BASE_INVALID(tmp_base)
				...
				if (LOAD_PG_TXPWR_WARN_COND(txpwr_src))
					RTW_INFO("[%c] 2G G%02d CCK-1T base:%u from %s\n", rf_path_char(path),
						 group, tmp_base, pg_txpwr_src_str(txpwr_src));
			}
		}
		offset++;
	}
	...
	for (tx_idx = 0; tx_idx < MAX_TX_COUNT; tx_idx++) {
		if (tx_idx == 0) {
			if (HAL_SPEC_CHK_RF_PATH_2G(hal_spec, path)
			    && HAL_SPEC_CHK_TX_CNT(hal_spec, tx_idx)) {
	...
	u16 pg_offset)
{
	...
	/* OFDM diff 2T ~ 3T */
	if (HAL_SPEC_CHK_RF_PATH_5G(hal_spec, path)
	    && HAL_SPEC_CHK_TX_CNT(hal_spec, 1)) {
		val = map_read8(txpwr_map, offset);
		tmp_diff = PG_TXPWR_MSB_DIFF_TO_S8BIT(val);
		if (!IS_PG_TXPWR_DIFF_INVALID(tmp_diff)
	...
	/* OFDM diff 4T */
	if (HAL_SPEC_CHK_RF_PATH_5G(hal_spec, path)
	    && HAL_SPEC_CHK_TX_CNT(hal_spec, 3)) {
		val = map_read8(txpwr_map, offset);
		tmp_diff = PG_TXPWR_LSB_DIFF_TO_S8BIT(val);
		if (!IS_PG_TXPWR_DIFF_INVALID(tmp_diff)
...
)
{
	...
	struct map_t pg_data_map = MAP_ENT(184, 1, 0xFF, MAPSEG_PTR_ENT(0x00, 184,
					   pg_data));
...
select_src:
	...
	for (path = 0; path < MAX_RF_PATH ; path++) {
		if (!HAL_SPEC_CHK_RF_PATH_2G(hal_spec, path)
		    && !HAL_SPEC_CHK_RF_PATH_5G(hal_spec, path))
			break;
		pg_offset = hal_load_pg_txpwr_info_path_2g(adapter, pwr_info_2g, path,
				txpwr_src, txpwr_map, pg_offset);
		pg_offset = hal_load_pg_txpwr_info_path_5g(adapter, pwr_info_5g, path,
				txpwr_src, txpwr_map, pg_offset);
	}
...
static u8 _check_phy_efuse_tx_power_info_valid(u8 *pg_data, int base_len,
		u16 pg_offset)
{
	int ff_cnt = 0;
	int i;
...
int check_phy_efuse_tx_power_info_valid(_adapter *adapter)
{
	...
	for (path = 0; path < MAX_RF_PATH; path++) {
		...
		if (HAL_SPEC_CHK_RF_PATH_2G(hal_spec, path)) {
			ret = _check_phy_efuse_tx_power_info_valid(pg_data,
					PG_TXPWR_BASE_BYTE_NUM_2G, pg_offset);
			if (ret == _TRUE)
		...
		if (HAL_SPEC_CHK_RF_PATH_5G(hal_spec, path)) {
			ret = _check_phy_efuse_tx_power_info_valid(pg_data,
					PG_TXPWR_BASE_BYTE_NUM_5G, pg_offset);
			if (ret == _TRUE)
...
)
{
	...
	for (rfpath = 0; rfpath < MAX_RF_PATH; rfpath++) {
		...
		for (ch_idx = 0; ch_idx < CENTER_CH_2G_NUM; ch_idx++) {
			...
			hal_data->Index24G_CCK_Base[rfpath][ch_idx] =
				pwr_info_2g->IndexCCK_Base[rfpath][cck_group];
			hal_data->Index24G_BW40_Base[rfpath][ch_idx] =
		...
		for (tx_idx = 0; tx_idx < MAX_TX_COUNT; tx_idx++) {
			...
			hal_data->CCK_24G_Diff[rfpath][tx_idx] =
				pwr_info_2g->CCK_Diff[rfpath][tx_idx];
			hal_data->OFDM_24G_Diff[rfpath][tx_idx] =
				pwr_info_2g->OFDM_Diff[rfpath][tx_idx];
			hal_data->BW20_24G_Diff[rfpath][tx_idx] =
				pwr_info_2g->BW20_Diff[rfpath][tx_idx];
			hal_data->BW40_24G_Diff[rfpath][tx_idx] =
				pwr_info_2g->BW40_Diff[rfpath][tx_idx];
		}
bypass_2g:
		;
		...
		for (ch_idx = 0; ch_idx < CENTER_CH_5G_ALL_NUM; ch_idx++) {
			if (rtw_get_ch_group(center_ch_5g_all[ch_idx], &group, NULL) != BAND_ON_5G)
				continue;
			hal_data->Index5G_BW40_Base[rfpath][ch_idx] =
		...
		for (tx_idx = 0; tx_idx < MAX_TX_COUNT; tx_idx++) {
			...
			hal_data->OFDM_5G_Diff[rfpath][tx_idx] =
				pwr_info_5g->OFDM_Diff[rfpath][tx_idx];
			hal_data->BW20_5G_Diff[rfpath][tx_idx] =
				pwr_info_5g->BW20_Diff[rfpath][tx_idx];
			hal_data->BW40_5G_Diff[rfpath][tx_idx] =
				pwr_info_5g->BW40_Diff[rfpath][tx_idx];
			hal_data->BW80_5G_Diff[rfpath][tx_idx] =
				pwr_info_5g->BW80_Diff[rfpath][tx_idx];
		}
bypass_5g:
		;
#endif /* CONFIG_IEEE80211_BAND_5GHZ */
...
void dump_hal_txpwr_info_2g(void *sel, _adapter *adapter, u8 rfpath_num,
			    u8 max_tx_cnt)
{
	HAL_DATA_TYPE *hal_data = GET_HAL_DATA(adapter);
...
void dump_hal_txpwr_info_5g(void *sel, _adapter *adapter, u8 rfpath_num,
			    u8 max_tx_cnt)
{
#ifdef CONFIG_IEEE80211_BAND_5GHZ
	HAL_DATA_TYPE *hal_data = GET_HAL_DATA(adapter);
...
static inline BOOLEAN phy_is_txpwr_by_rate_undefined_of_band_path(
	_adapter *adapter, u8 band, u8 path)
{
	struct hal_spec_t *hal_spec = GET_HAL_SPEC(adapter);
	HAL_DATA_TYPE *hal_data = GET_HAL_DATA(adapter);
	u8 rate_idx = 0;
...
static inline void phy_txpwr_by_rate_duplicate_band_path(_adapter *adapter,
		u8 band, u8 s_path, u8 t_path)
{
	struct hal_spec_t *hal_spec = GET_HAL_SPEC(adapter);
	HAL_DATA_TYPE *hal_data = GET_HAL_DATA(adapter);
	u8 rate_idx = 0;
	...
	for (rate_idx = 0; rate_idx < TX_PWR_BY_RATE_NUM_RATE; rate_idx++)
		hal_data->TxPwrByRateOffset[band][t_path][rate_idx] =
			hal_data->TxPwrByRateOffset[band][s_path][rate_idx];
}
...
VOID phy_StoreTxPowerByRateBase(
	...
	for (band = BAND_ON_2_4G; band <= BAND_ON_5G; band++) {
		...
		for (path = RF_PATH_A; path < RF_PATH_MAX; path++) {
			...
			for (rs = 0; rs < RATE_SECTION_NUM; rs++) {
				...
				if (IS_VHT_RATE_SECTION(rs)
				    && !IS_HARDWARE_TYPE_JAGUAR_AND_JAGUAR2(pAdapter))
					continue;
...
void PHY_StoreTxPowerByRateNew(
	IN	PADAPTER	pAdapter,
	IN	u32			Band,
	IN	u32			RfPath,
	IN	u32			RegAddr,
...
)
{
	...
	PHY_GetRateValuesOfTxPowerByRate(pAdapter, RegAddr, BitMask, Data, rates,
					 PwrByRateVal, &rateNum);
...
VOID phy_ConvertTxPowerByRateInDbmToRelativeValues(
	IN	PADAPTER	pAdapter
)
{
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(pAdapter);
...
)
{
	...
	PHY_SetTxPowerIndexByRateArray(pAdapter, RFPath,
				       pHalData->current_channel_bw, Channel,
				       rates_by_sections[RateSection].rates,
				       rates_by_sections[RateSection].rate_num);

exit:
	return;
}

BOOLEAN phy_GetChnlIndex(
	IN	u8	Channel,
	OUT u8	*ChannelIdx
)
{
	...
	*bIn24G = phy_GetChnlIndex(Channel, &chnlIdx);
	...
	if (*bIn24G) {
		...
		if (BandWidth == CHANNEL_WIDTH_20) {
			...
			if ((MGN_MCS8 <= Rate && Rate <= MGN_MCS31) || (MGN_VHT2SS_MCS0 <= Rate
					&& Rate <= MGN_VHT4SS_MCS9))
				txPower += pHalData->BW20_24G_Diff[RFPath][RF_2TX];
			if ((MGN_MCS16 <= Rate && Rate <= MGN_MCS31) || (MGN_VHT3SS_MCS0 <= Rate
					&& Rate <= MGN_VHT4SS_MCS9))
				txPower += pHalData->BW20_24G_Diff[RFPath][RF_3TX];
			if ((MGN_MCS24 <= Rate && Rate <= MGN_MCS31) || (MGN_VHT4SS_MCS0 <= Rate
					&& Rate <= MGN_VHT4SS_MCS9))
		...
		if (BandWidth == CHANNEL_WIDTH_80) {
			...
			if ((MGN_MCS23 <= Rate && Rate <= MGN_MCS31) || (MGN_VHT4SS_MCS0 <= Rate
					&& Rate <= MGN_VHT4SS_MCS9))
...
)
{
	...
	/* if ( pMgntInfo->RegNByteAccess == 0 ) */
	{
		...
		phy_set_tx_power_index_by_rate_section(Adapter, path, channel,
						       HT_MCS0_MCS7);
...
)
{
	...
	for (i = 0; i < RateArraySize; ++i) {
		...
		powerIndex = rtw_hal_get_tx_power_index(pAdapter, RFPath, Rates[i],
							BandWidth, Channel, &tic);
		RTW_INFO("TXPWR: [%c][%s]ch:%u, %s %uT, pwr_idx:%u = %u + (%d=%d:%d) + (%d) + (%d)\n"
			 , rf_path_char(RFPath), ch_width_str(BandWidth), Channel,
			 MGN_RATE_STR(Rates[i]), tic.ntx_idx + 1
			 , powerIndex, tic.base,
			 (tic.by_rate > tic.limit ? tic.limit : tic.by_rate), tic.by_rate,
			 tic.limit, tic.tpt, tic.ebias);
#else
		powerIndex = phy_get_tx_power_index(pAdapter, RFPath, Rates[i], BandWidth,
						    Channel);
#endif
...
static s8 phy_GetChannelIndexOfTxPowerLimit(
	IN	u8			Band,
	IN	u8			Channel
)
{
			   ...
			   )
{
	...
	lmt = phy_get_txpwr_lmt_abs(adapter, regd_name, band, bw, tlrs, ntx_idx,
				    cch, lock);
		       ...
		       , u8 rfpath, u8 rate, u8 ntx_idx, u8 cch)
{
	...
	if (IS_CCK_RATE(rate)) {
		...
		rs = HT_1SS + (IS_HT1SS_RATE(rate) ? 0 : IS_HT2SS_RATE(
				       rate) ? 1 : IS_HT3SS_RATE(rate) ? 2 : IS_HT4SS_RATE(rate) ? 3 : 0);
	} else if (IS_VHT_RATE(rate)) {
		tlrs = TXPWR_LMT_RS_VHT;
		rs = VHT_1SS + (IS_VHT1SS_RATE(rate) ? 0 : IS_VHT2SS_RATE(
					rate) ? 1 : IS_VHT3SS_RATE(rate) ? 2 : IS_VHT4SS_RATE(rate) ? 3 : 0);
	} else {
	...
	if (no_sc == _TRUE) {
		...
		*/
		if (tlrs == TXPWR_LMT_RS_CCK || tlrs == TXPWR_LMT_RS_OFDM)
			...
			if (bw_bmp == 0)
				bw_bmp = ch_width_to_bw_cap(bw > CHANNEL_WIDTH_160 ? CHANNEL_WIDTH_160 :
							    bw);
		} else
			rtw_warn_on(1);
	}
	...
	for (tmp_bw = CHANNEL_WIDTH_20; tmp_bw <= bw; tmp_bw++) {
		...
		lmt = phy_get_txpwr_lmt_abs(adapter, regd_name, band, tmp_bw, tlrs,
					    ntx_idx, tmp_cch, 0);
	...
	while ((rtw_end_of_queue_search(head, cur)) == _FALSE) {
		...
		for (tlrs = TXPWR_LMT_RS_CCK; tlrs <= TXPWR_LMT_RS_OFDM; tlrs++) {
			for (ntx_idx = RF_1TX; ntx_idx < MAX_TX_COUNT; ntx_idx++) {
				for (channel = 0; channel < CENTER_CH_2G_NUM; ++channel) {
					if (ent->lmt_2g[CHANNEL_WIDTH_20][tlrs][channel][ntx_idx] !=
					    MAX_POWER_INDEX) {
		...
		for (channel = 0; channel < CENTER_CH_2G_NUM; ++channel) {
			for (ntx_idx = RF_2TX; ntx_idx < MAX_TX_COUNT; ntx_idx++) {
				if (rfctl->txpwr_lmt_2g_cck_ofdm_state & (TXPWR_LMT_HAS_OFDM_1T <<
						ntx_idx))
					continue;
		...
		for (ntx_idx = RF_1TX; ntx_idx < MAX_TX_COUNT; ntx_idx++) {
			for (channel = 0; channel < CENTER_CH_5G_ALL_NUM; ++channel) {
				if (ent->lmt_5g[CHANNEL_WIDTH_20][TXPWR_LMT_RS_OFDM - 1][channel][ntx_idx]
				    != MAX_POWER_INDEX) {
		...
		for (channel = 0; channel < CENTER_CH_5G_ALL_NUM; ++channel) {
			for (ntx_idx = RF_2TX; ntx_idx < MAX_TX_COUNT; ntx_idx++) {
				if (rfctl->txpwr_lmt_5g_cck_ofdm_state & (TXPWR_LMT_HAS_OFDM_1T <<
						ntx_idx))
					continue;
	...
	for (band = BAND_ON_2_4G; band <= BAND_ON_5G; band++) {
		...
		for (bw = CHANNEL_WIDTH_40; bw <= CHANNEL_WIDTH_80; bw++) {
			...
			for (tlrs = TXPWR_LMT_RS_HT; tlrs < TXPWR_LMT_RS_NUM; tlrs++) {
				...
				if (band == BAND_ON_5G && tlrs == TXPWR_LMT_RS_CCK)
					continue;
				if (bw > CHANNEL_WIDTH_20 && (tlrs == TXPWR_LMT_RS_CCK
							      || tlrs == TXPWR_LMT_RS_OFDM))
					continue;
				...
				for (ntx_idx = RF_1TX; ntx_idx < MAX_TX_COUNT; ntx_idx++) {
					...
					if (tlrs == TXPWR_LMT_RS_CCK && ntx_idx > RF_1TX) {
						if (band == BAND_ON_2_4G
						    && !(rfctl->txpwr_lmt_2g_cck_ofdm_state & (TXPWR_LMT_HAS_CCK_1T <<
								    ntx_idx)))
							continue;
					}
					...
					if (tlrs == TXPWR_LMT_RS_OFDM && ntx_idx > RF_1TX) {
						if (band == BAND_ON_2_4G
						    && !(rfctl->txpwr_lmt_2g_cck_ofdm_state & (TXPWR_LMT_HAS_OFDM_1T <<
								    ntx_idx)))
							continue;
#ifdef CONFIG_IEEE80211_BAND_5GHZ
						if (band == BAND_ON_5G
						    && !(rfctl->txpwr_lmt_5g_cck_ofdm_state & (TXPWR_LMT_HAS_OFDM_1T <<
								    ntx_idx)))
							continue;
#endif
					}
...
#ifdef CONFIG_IEEE80211_BAND_5GHZ
					if (band == BAND_ON_5G && (bw == CHANNEL_WIDTH_20
								   || bw == CHANNEL_WIDTH_40)) {
					...
					for (n = 0; n < ch_num; n++) {
						...
						do {
							for (bw_pos = bw; bw_pos >= CHANNEL_WIDTH_40; bw_pos--)
								cch_by_bw[bw_pos - 1] = rtw_get_scch_by_cch_offset(cch_by_bw[bw_pos],
											bw_pos, offset_by_bw & BIT(bw_pos) ? HAL_PRIME_CHNL_OFFSET_UPPER :
							...
							while ((rtw_end_of_queue_search(head, cur)) == _FALSE) {
								...
								for (bw_pos = bw; bw_pos < CHANNEL_WIDTH_160; bw_pos--)
									lmt[bw_pos] = phy_get_txpwr_lmt_abs(adapter, ent->regd_name, band, bw_pos,
													    tlrs, ntx_idx, cch_by_bw[bw_pos], 0);
								...
								for (bw_pos = bw; bw_pos < CHANNEL_WIDTH_160; bw_pos--) {
									if (lmt[bw_pos] == MAX_POWER_INDEX)
										...
										_RTW_PRINT_SEL(RTW_DBGDUMP, "%2u%s ", lmt[bw_pos] / 2,
											       lmt[bw_pos] % 2 ? ".5" : "");
								}
								_RTW_PRINT_SEL(RTW_DBGDUMP, "\n");
							}
							for (bw_pos = bw; bw_pos < CHANNEL_WIDTH_160; bw_pos--)
								lmt[bw_pos] = phy_get_txpwr_lmt_abs(adapter, regd_str(TXPWR_LMT_WW), band,
												    bw_pos, tlrs, ntx_idx, cch_by_bw[bw_pos], 0);
...
BOOLEAN GetS1ByteIntegerFromStringInDecimal(
	IN		char	*str,
	IN OUT	s8		*val
)
{
...
)
{
	...
	if (GetU1ByteIntegerFromStringInDecimal((char *)Channel,
						&channel) == _FALSE
	    || GetS1ByteIntegerFromStringInDecimal((char *)PowerLimit,
			    &powerLimit) == _FALSE
	   ) {
	...
	powerLimit = powerLimit < -MAX_POWER_INDEX ? -MAX_POWER_INDEX + 1 :
		     powerLimit;
	...
	if (eqNByte(Band, (u8 *)("2.4G"), 4)) {
		...
		rtw_txpwr_lmt_add(adapter_to_rfctl(Adapter), Regulation, band, bandwidth,
				  tlrs, ntx_idx, channelIndex, powerLimit);
	}
#ifdef CONFIG_IEEE80211_BAND_5GHZ
...
{
	return rtw_hal_get_tx_power_index(pAdapter, RFPath, Rate, BandWidth,
					  Channel, NULL);
}
				  ...
				  u8 rs)
{
	...
	for (i = 0; i < rates_by_sections[rs].rate_num; i++) {
		power_idx = rtw_hal_get_tx_power_index(adapter, rfpath,
						       rates_by_sections[rs].rates[i], bw, cch, &tic);

		RTW_PRINT_SEL(sel, "%4c %9s %uT %3u %4u %3d (%3d %3d) %3d %5d\n"
			      , rf_path_char(rfpath), MGN_RATE_STR(rates_by_sections[rs].rates[i]),
			      tic.ntx_idx + 1
			      , power_idx, tic.base, (tic.by_rate > tic.limit ? tic.limit : tic.by_rate),
			      tic.by_rate, tic.limit, tic.tpt, tic.ebias);
	}
}
...
int phy_load_tx_power_by_rate(_adapter *adapter, u8 chk_file)
{
	...
	if (HAL_STATUS_SUCCESS == odm_config_bb_with_header_file(
		    &hal_data->odmpriv, CONFIG_BB_PHY_REG_PG)) {
...
int phy_load_tx_power_limit(_adapter *adapter, u8 chk_file)
{
	...
	if (!hal_data->txpwr_by_rate_loaded
...
#ifdef CONFIG_LOAD_PHY_PARA_FROM_FILE
	if (chk_file
	    && PHY_ConfigRFWithPowerLimitTableParaFile(adapter,
			    PHY_FILE_TXPWR_LMT) == _SUCCESS
	   ) {
...
#ifdef CONFIG_EMBEDDED_FWIMG
	if (odm_config_rf_with_header_file(&hal_data->odmpriv, CONFIG_RF_TXPWR_LMT,
					   RF_PATH_A) == HAL_STATUS_SUCCESS) {
...
void phy_load_tx_power_ext_info(_adapter *adapter, u8 chk_file)
{
	...
	regsty->target_tx_pwr_valid = rtw_regsty_chk_target_tx_power_valid(
					      adapter);
	...
	for (band = BAND_ON_2_4G; band <= BAND_ON_5G; band++) {
		...
		for (path = 0; path < RF_PATH_MAX; path++) {
			...
			RTW_PRINT_SEL(sel, "[%s][%c]%s\n", band_str(band), rf_path_char(path)
				      , (regsty->target_tx_pwr_valid == _FALSE
		...
		for (path = 0; path < RF_PATH_MAX; path++) {
			...
			for (rs = 0; rs < RATE_SECTION_NUM; rs++) {
				...
				for (n = rate_num - 1; n >= 0; n--) {
					by_rate_offset = PHY_GetTxPowerByRate(adapter, band, path,
...
int rtw_get_phy_file_path(_adapter *adapter, const char *file_name)
{
	...
	if (file_name) {
		len += snprintf(rtw_phy_para_file_path, PATH_LENGTH_MAX, "%s",
				rtw_phy_file_path);
#if defined(CONFIG_MULTIDRV) || defined(REALTEK_CONFIG_PATH_WITH_IC_NAME_FOLDER)
		len += snprintf(rtw_phy_para_file_path + len, PATH_LENGTH_MAX - len, "%s/",
				hal_spec->ic_name);
#endif
		len += snprintf(rtw_phy_para_file_path + len, PATH_LENGTH_MAX - len, "%s",
				file_name);
...
)
{
	...
	if ((pHalData->mac_reg_len == 0) && (pHalData->mac_reg == NULL)) {
		...
		if (rtw_is_file_readable(rtw_phy_para_file_path) == _TRUE) {
			rlen = rtw_retrieve_from_file(rtw_phy_para_file_path,
		...
		if ((pHalData->mac_reg_len != 0) && (pHalData->mac_reg != NULL)) {
			_rtw_memcpy(pHalData->para_file_buf, pHalData->mac_reg,
...
)
{
	...
	ptmp = buffer;
	i = 0;
	for (BufOfLines = GetLineFromBuffer(ptmp); BufOfLines != NULL;
	     BufOfLines = GetLineFromBuffer(ptmp)) {
			...
			if (pHalData->odmpriv.phy_reg_pg_version == 0) {
				...
				if (GetHexValueFromString(szLine, &u4bRegOffset, &u4bMove)) {
					...
					if (pHalData->odmpriv.phy_reg_pg_value_type == PHY_REG_PG_RELATIVE_VALUE) {
						...
						if (GetHexValueFromString(szLine, &u4bRegValue, &u4bMove)) {
							phy_store_tx_power_by_rate(Adapter, 0, 0, 1, u4bRegOffset, u4bRegMask,
										   u4bRegValue);
							/* RTW_INFO("[ADDR] %03X=%08X Mask=%08x\n", u4bRegOffset, u4bRegValue, u4bRegMask); */
						} else
							return _FAIL;
					} else if (pHalData->odmpriv.phy_reg_pg_value_type ==
				...
				if (!eqNByte("#[END]#", szLine, 7)) {
					...
					if (szLine[0] == '#') {
						...
						if (pHalData->odmpriv.phy_reg_pg_value_type == PHY_REG_PG_RELATIVE_VALUE) {
							/* Get 3rd hex value as register value. */
							if (GetHexValueFromString(szLine, &u4bRegValue, &u4bMove)) {
								phy_store_tx_power_by_rate(Adapter, band, rf_path, tx_num, u4bRegOffset,
											   u4bRegMask, u4bRegValue);
...
int phy_ConfigBBWithPgParaFile(
	IN	PADAPTER	Adapter,
	IN	const char	*pFileName)
{
	...
	if (pHalData->bb_phy_reg_pg == NULL) {
		...
		if ((pHalData->bb_phy_reg_pg_len != 0)
		    && (pHalData->bb_phy_reg_pg != NULL)) {
			_rtw_memcpy(pHalData->para_file_buf, pHalData->bb_phy_reg_pg,
				    pHalData->bb_phy_reg_pg_len);
			rtStatus = _SUCCESS;
		} else
			RTW_INFO("%s(): Critical Error !!!\n", __FUNCTION__);
	}
...
)
{
	...
	if ((pHalData->bb_phy_reg_mp_len == 0)
		...
		if ((pHalData->bb_phy_reg_mp_len != 0)
		    && (pHalData->bb_phy_reg_mp != NULL)) {
			_rtw_memcpy(pHalData->para_file_buf, pHalData->bb_phy_reg_mp,
				    pHalData->bb_phy_reg_mp_len);
			rtStatus = _SUCCESS;
		} else
			RTW_INFO("%s(): Critical Error !!!\n", __FUNCTION__);
	}
		...
		for (szLine = GetLineFromBuffer(ptmp); szLine != NULL;
			...
			if (!IsCommentString(szLine)) {
				...
				if (GetHexValueFromString(szLine, &u4bRegOffset, &u4bMove)) {
					...
					szLine += u4bMove;
					if (GetHexValueFromString(szLine, &u4bRegValue, &u4bMove)) {
						phy_set_rf_reg(Adapter, eRFPath, u4bRegOffset, bRFRegOffsetMask,
							       u4bRegValue);
...
VOID initDeltaSwingIndexTables(
	PADAPTER	Adapter,
	char		*Band,
	char		*Path,
	char		*Sign,
...
int PHY_ConfigRFWithTxPwrTrackParaFile(
	IN	PADAPTER		Adapter,
	IN	char			*pFileName
)
{
	...
	if ((pHalData->rf_tx_pwr_track_len == 0)
		...
		if ((pHalData->rf_tx_pwr_track_len != 0)
		    && (pHalData->rf_tx_pwr_track != NULL)) {
			_rtw_memcpy(pHalData->para_file_buf, pHalData->rf_tx_pwr_track,
	...
	for (i = 0; i < DELTA_SWINGIDX_SIZE; ++i) {
		RTW_INFO("pRFCalibrateInfo->delta_swing_table_idx_2ga_p[%d] = %d\n", i,
			 pRFCalibrateInfo->delta_swing_table_idx_2ga_p[i]);
		RTW_INFO("pRFCalibrateInfo->delta_swing_table_idx_2ga_n[%d] = %d\n", i,
			 pRFCalibrateInfo->delta_swing_table_idx_2ga_n[i]);
		RTW_INFO("pRFCalibrateInfo->delta_swing_table_idx_2gb_p[%d] = %d\n", i,
			 pRFCalibrateInfo->delta_swing_table_idx_2gb_p[i]);
		RTW_INFO("pRFCalibrateInfo->delta_swing_table_idx_2gb_n[%d] = %d\n", i,
			 pRFCalibrateInfo->delta_swing_table_idx_2gb_n[i]);
		...
		for (j = 0; j < 3; ++j) {
			RTW_INFO("pRFCalibrateInfo->delta_swing_table_idx_5ga_p[%d][%d] = %d\n", j,
				 i, pRFCalibrateInfo->delta_swing_table_idx_5ga_p[j][i]);
			RTW_INFO("pRFCalibrateInfo->delta_swing_table_idx_5ga_n[%d][%d] = %d\n", j,
				 i, pRFCalibrateInfo->delta_swing_table_idx_5ga_n[j][i]);
			RTW_INFO("pRFCalibrateInfo->delta_swing_table_idx_5gb_p[%d][%d] = %d\n", j,
				 i, pRFCalibrateInfo->delta_swing_table_idx_5gb_p[j][i]);
			RTW_INFO("pRFCalibrateInfo->delta_swing_table_idx_5gb_n[%d][%d] = %d\n", j,
				 i, pRFCalibrateInfo->delta_swing_table_idx_5gb_n[j][i]);
		}
	}
#endif
	return rtStatus;
...
#define REG_PREFIX "Regulation="
	...
	if (parse_reg) {
		...
		rtw_regd_exc_add_with_nlen(adapter_to_rfctl(adapter), country, domain,
					   szLine + i_val_s, i - i_val_s);
	}
		...
		if (loadingStage == LD_STAGE_TAB_DEFINE) {
			...
			for (forCnt = 0; forCnt < colNum; ++forCnt) {
				...
				phy_set_tx_power_limit(pDM_Odm, (u8 *)regulation[forCnt], (u8 *)band,
						       (u8 *)bandwidth, (u8 *)rateSection, (u8 *)ntx, (u8 *)channel,
						       (u8 *)powerLimit);
...
)
{
	...
	if (pHalData->rf_tx_pwr_lmt == NULL) {
		...
		if ((pHalData->rf_tx_pwr_lmt_len != 0)
		    && (pHalData->rf_tx_pwr_lmt != NULL)) {
			_rtw_memcpy(pHalData->para_file_buf, pHalData->rf_tx_pwr_lmt,
				    pHalData->rf_tx_pwr_lmt_len);
			rtStatus = _SUCCESS;
		} else
			RTW_INFO("%s(): Critical Error !!!\n", __FUNCTION__);
	}
