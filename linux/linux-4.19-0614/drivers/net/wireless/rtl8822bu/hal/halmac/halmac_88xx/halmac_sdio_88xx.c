...
static u8 r_indir_cmd52_88xx(struct halmac_adapter *adapter, u32 offset);

/*only for r_indir_sdio_88xx !!, Soar 20171222*/
static u32 r_indir_cmd53_88xx(struct halmac_adapter *adapter, u32 offset);

/*only for r_indir_sdio_88xx !!, Soar 20171222*/
static u32 r8_indir_sdio_88xx(struct halmac_adapter *adapter, u32 adr);

/*only for r_indir_sdio_88xx !!, Soar 20171222*/
static u32 r16_indir_sdio_88xx(struct halmac_adapter *adapter, u32 adr);

/*only for r_indir_sdio_88xx !!, Soar 20171222*/
static u32 r32_indir_sdio_88xx(struct halmac_adapter *adapter, u32 adr);

/*only for w_indir_sdio_88xx !!, Soar 20171222*/
static enum halmac_ret_status w_indir_cmd52_88xx(struct halmac_adapter
		*adapter, u32 adr, u32 val,
		enum halmac_io_size size);

/*only for w_indir_sdio_88xx !!, Soar 20171222*/
static enum halmac_ret_status w_indir_cmd53_88xx(struct halmac_adapter
		*adapter, u32 adr, u32 val,
		enum halmac_io_size size);

/*only for w_indir_sdio_88xx !!, Soar 20171222*/
static enum halmac_ret_status w8_indir_sdio_88xx(struct halmac_adapter
		*adapter, u32 adr, u32 val);

/*only for w_indir_sdio_88xx !!, Soar 20171222*/
static enum halmac_ret_status w16_indir_sdio_88xx(struct halmac_adapter
		*adapter, u32 adr, u32 val);

/*only for w_indir_sdio_88xx !!, Soar 20171222*/
static enum halmac_ret_status w32_indir_sdio_88xx(struct halmac_adapter
		*adapter, u32 adr, u32 val);
 ...
 */
enum halmac_ret_status init_sdio_cfg_88xx(struct halmac_adapter *adapter)
{
	u32 value32;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status deinit_sdio_cfg_88xx(struct halmac_adapter
		*adapter)
{
	if (adapter->intf != HALMAC_INTERFACE_SDIO)
		return HALMAC_RET_WRONG_INTF;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_sdio_rx_agg_88xx(struct halmac_adapter *adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status sdio_reg_rn_88xx(struct halmac_adapter *adapter,
					u32 offset, u32 size,
					u8 *value)
{
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_txagg_sdio_align_88xx(struct halmac_adapter
		*adapter, u8 enable,
		u16 align_size)
{
	u8 i;
 ...
 * More details of status code can be found in prototype document
 */
u32 sdio_indirect_reg_r32_88xx(struct halmac_adapter *adapter, u32 offset)
{
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status set_sdio_bulkout_num_88xx(struct halmac_adapter
		*adapter, u8 num)
{
	return HALMAC_RET_NOT_SUPPORT;
}
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status get_sdio_bulkout_id_88xx(struct halmac_adapter
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status sdio_cmd53_4byte_88xx(struct halmac_adapter
		*adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status sdio_hw_info_88xx(struct halmac_adapter *adapter,
...
void cfg_sdio_tx_page_threshold_88xx(struct halmac_adapter *adapter,
...
enum halmac_ret_status cnv_to_sdio_bus_offset_88xx(struct halmac_adapter
		*adapter, u32 *offset)
{
...
enum halmac_ret_status leave_sdio_suspend_88xx(struct halmac_adapter
		*adapter)
{
	u8 value8;
	u32 cnt;
...
u32 r_indir_sdio_88xx(struct halmac_adapter *adapter, u32 adr,
		      enum halmac_io_size size)
{
	u32 reg_data = REG_SDIO_INDIRECT_REG_DATA;
	enum halmac_ret_status status = HALMAC_RET_SUCCESS;
...
enum halmac_ret_status w_indir_sdio_88xx(struct halmac_adapter *adapter,
		u32 adr, u32 val,
		enum halmac_io_size size)
{
	enum halmac_ret_status status = HALMAC_RET_SUCCESS;
