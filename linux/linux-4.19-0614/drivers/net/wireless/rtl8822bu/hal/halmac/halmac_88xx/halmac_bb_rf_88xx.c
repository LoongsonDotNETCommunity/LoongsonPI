 ...
 */
enum halmac_ret_status start_iqk_88xx(struct halmac_adapter *adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status ctrl_pwr_tracking_88xx(struct halmac_adapter
		*adapter,
...
enum halmac_ret_status get_iqk_status_88xx(struct halmac_adapter *adapter,
		enum halmac_cmd_process_status *proc_status)
{
	*proc_status = adapter->halmac_state.iqk_state.proc_status;
...
enum halmac_ret_status get_pwr_trk_status_88xx(struct halmac_adapter
		*adapter,
		enum halmac_cmd_process_status *proc_status)
{
	*proc_status = adapter->halmac_state.pwr_trk_state.proc_status;
...
enum halmac_ret_status get_psd_status_88xx(struct halmac_adapter *adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status psd_88xx(struct halmac_adapter *adapter,
...
enum halmac_ret_status get_h2c_ack_iqk_88xx(struct halmac_adapter *adapter,
		u8 *buf, u32 size)
{
	u8 seq_num;
	u8 fw_rc;
...
enum halmac_ret_status get_h2c_ack_pwr_trk_88xx(struct halmac_adapter
...
enum halmac_ret_status get_psd_data_88xx(struct halmac_adapter *adapter,
		u8 *buf, u32 size)
{
	u8 seg_id;
	u8 seg_size;
