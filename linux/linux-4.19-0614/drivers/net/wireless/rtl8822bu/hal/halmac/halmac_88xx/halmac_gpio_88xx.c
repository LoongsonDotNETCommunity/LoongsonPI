 ...
 */
enum halmac_ret_status pinmux_wl_led_mode_88xx(struct halmac_adapter
		*adapter,
 ...
 * More details of status code can be found in prototype document
 */
void pinmux_wl_led_sw_ctrl_88xx(struct halmac_adapter *adapter, u8 on)
{
	u8 value8;
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
 ...
 * More details of status code can be found in prototype document
 */
void pinmux_sdio_int_polarity_88xx(struct halmac_adapter *adapter,
				   u8 low_active)
{
	u8 value8;
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status pinmux_gpio_mode_88xx(struct halmac_adapter
		*adapter, u8 gpio_id, u8 output)
{
	u16 value16;
	u8 in_out;
	u32 offset;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status pinmux_gpio_output_88xx(struct halmac_adapter
		*adapter, u8 gpio_id, u8 high)
{
	u8 value8;
	u8 hi_low;
	u32 offset;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status pinmux_pin_status_88xx(struct halmac_adapter
		*adapter, u8 pin_id, u8 *high)
{
	u8 value8;
	u32 offset;
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
...
enum halmac_ret_status pinmux_parser_88xx(struct halmac_adapter *adapter,
...
enum halmac_ret_status pinmux_switch_88xx(struct halmac_adapter *adapter,
		const struct halmac_gpio_pimux_list *list, u32 size,
...
enum halmac_ret_status pinmux_record_88xx(struct halmac_adapter *adapter,
