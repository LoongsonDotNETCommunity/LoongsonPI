...
static void init_state_machine_88xx(struct halmac_adapter *adapter);

static enum halmac_ret_status verify_io_88xx(struct halmac_adapter
		*adapter);

static enum halmac_ret_status verify_send_rsvd_page_88xx(
	struct halmac_adapter *adapter);

void init_adapter_param_88xx(struct halmac_adapter *adapter)
{
...
enum halmac_ret_status mount_api_88xx(struct halmac_adapter *adapter)
{
...
void init_ofld_feature_state_machine_88xx(struct halmac_adapter *adapter)
{
	struct halmac_state *state = &adapter->halmac_state;
 ...
 */
enum halmac_ret_status register_api_88xx(struct halmac_adapter *adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status pre_init_system_cfg_88xx(struct halmac_adapter
		*adapter)
{
	u32 value32;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status init_system_cfg_88xx(struct halmac_adapter
		*adapter)
{
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
	u32 tmp = 0;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status init_edca_cfg_88xx(struct halmac_adapter *adapter)
{
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status init_wmac_cfg_88xx(struct halmac_adapter *adapter)
{
	u8 value8;
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status init_mac_cfg_88xx(struct halmac_adapter *adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status reset_ofld_feature_88xx(struct halmac_adapter
		*adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status verify_platform_api_88xx(struct halmac_adapter
		*adapter)
{
...
void tx_desc_chksum_88xx(struct halmac_adapter *adapter, u8 enable)
{
	u16 value16;
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
...
enum halmac_ret_status pg_num_parser_88xx(struct halmac_adapter *adapter,
		enum halmac_trx_mode mode,
...
enum halmac_ret_status rqpn_parser_88xx(struct halmac_adapter *adapter,
					enum halmac_trx_mode mode,
