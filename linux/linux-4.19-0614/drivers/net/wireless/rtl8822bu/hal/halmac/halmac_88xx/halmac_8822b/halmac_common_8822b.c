...
static void cfg_ldo25_8822b(struct halmac_adapter *adapter, u8 enable);
 ...
 */
enum halmac_ret_status get_hw_value_8822b(struct halmac_adapter *adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status set_hw_value_8822b(struct halmac_adapter *adapter,
		enum halmac_hw_id hw_id,
		void *value)
{
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status fill_txdesc_check_sum_8822b(struct halmac_adapter
		*adapter, u8 *txdesc)
{
	u16 chksum = 0;
	u16 *data = (u16 *)NULL;
