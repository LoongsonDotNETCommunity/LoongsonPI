...
static
void halbtc8822b2ant_coex_switch_threshold(IN struct btc_coexist
		*btcoexist,
		IN u8 isolation_measuared)
{
	...
	coex_sta->wifi_coex_thres		= interference_wl_tx +
			BT_8822B_2ANT_WIFI_SIR_THRES1;
	coex_sta->wifi_coex_thres2		= interference_wl_tx +
			BT_8822B_2ANT_WIFI_SIR_THRES2;

	coex_sta->bt_coex_thres		= interference_bt_tx +
					  BT_8822B_2ANT_BT_SIR_THRES1;
	coex_sta->bt_coex_thres2		= interference_bt_tx +
			BT_8822B_2ANT_BT_SIR_THRES2;
#endif
...
static
void halbtc8822b2ant_update_wifi_channel_info(IN struct btc_coexist
		*btcoexist,
		IN u8 type)
{
...
static
void halbtc8822b2ant_monitor_bt_enable_disable(IN struct btc_coexist
		*btcoexist)
{
...
static
u32 halbtc8822b2ant_ltecoex_indirect_read_reg(IN struct btc_coexist
		*btcoexist,
		IN u16 reg_addr)
{
	u32 delay_count = 0;
...
static
void halbtc8822b2ant_ltecoex_pathcontrol_owner(IN struct btc_coexist
		*btcoexist,
...
static
void halbtc8822b2ant_ltecoex_set_coex_table(IN struct btc_coexist
		*btcoexist,
...
static
void halbtc8822b2ant_set_wltoggle_coex_table(IN struct btc_coexist
		*btcoexist,
...
static
void halbtc8822b2ant_set_fw_ignore_wlan_act(IN struct btc_coexist
		*btcoexist,
		IN boolean enable)
{
	u8			h2c_parameter[1] = {0};
				  ...
				  IN u8 phase)
{
	...
	coex_sta->is_2g_freerun = ((phase == BT_8822B_2ANT_PHASE_2G_FREERUN) ?
				   TRUE : FALSE);
...
void halbtc8822b2ant_action_wifi_freerun(IN struct btc_coexist *btcoexist)
{
	...
	halbtc8822b2ant_post_state_to_bt(btcoexist,
					 BT_8822B_2ANT_SCOREBOARD_BTCQDDR, TRUE);
...
/* HID+A2DP+PAN(EDR) */
static
void halbtc8822b2ant_action_hid_a2dp_pan_edr(IN struct btc_coexist
		*btcoexist)
{
	static u8	prewifi_rssi_state = BTC_RSSI_STATE_LOW;
	static u8	pre_bt_rssi_state = BTC_RSSI_STATE_LOW;
...
static
void halbtc8822b2ant_action_wifi_native_lps(IN struct btc_coexist
		*btcoexist)
{
	halbtc8822b2ant_adjust_wl_tx_power(btcoexist, NORMAL_EXEC, 0xd8);
	halbtc8822b2ant_adjust_bt_tx_power(btcoexist, NORMAL_EXEC, 0);
...
static
void halbtc8822b2ant_action_wifi_link_process(IN struct btc_coexist
		*btcoexist)
{
	struct  btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
...
static
void halbtc8822b2ant_action_wifi_not_connected(IN struct btc_coexist
		*btcoexist)
{
	halbtc8822b2ant_adjust_wl_tx_power(btcoexist, NORMAL_EXEC, 0xd8);
	halbtc8822b2ant_adjust_bt_tx_power(btcoexist, NORMAL_EXEC, 0);
...
static
void halbtc8822b2ant_action_wifi_multi_port(IN struct btc_coexist
		*btcoexist,
...
static
void halbtc8822b2ant_action_wifi_connected(IN struct btc_coexist
		*btcoexist)
{
...
static
void halbtc8822b2ant_run_coexist_mechanism(IN struct btc_coexist
		*btcoexist)
{
...
void ex_halbtc8822b2ant_display_simple_coex_info(IN struct btc_coexist
		*btcoexist)
{
	struct  btc_board_info		*board_info = &btcoexist->board_info;
	struct  btc_bt_link_info	*bt_link_info = &btcoexist->bt_link_info;
...
void ex_halbtc8822b2ant_media_status_notify(IN struct btc_coexist
		*btcoexist,
		IN u8 type)
{
...
void ex_halbtc8822b2ant_specific_packet_notify(IN struct btc_coexist
		*btcoexist,
		IN u8 type)
{
...
void ex_halbtc8822b2ant_wl_fwdbginfo_notify(IN struct btc_coexist
		*btcoexist,
		IN u8 *tmp_buf, IN u8 length)
{
	u8 i = 0;
...
void ex_halbtc8822b2ant_rx_rate_change_notify(IN struct btc_coexist
		*btcoexist,
...
void ex_halbtc8822b2ant_display_ant_detection(IN struct btc_coexist
		*btcoexist)
{
}
