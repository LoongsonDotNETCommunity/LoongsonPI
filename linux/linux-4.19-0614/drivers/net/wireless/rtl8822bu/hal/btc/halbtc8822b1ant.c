...
static
boolean halbtc8822b1ant_is_wifibt_status_changed(IN struct btc_coexist
		*btcoexist)
{
...
static
void halbtc8822b1ant_update_wifi_channel_info(IN struct btc_coexist
		*btcoexist,
		IN u8 type)
{
...
static
void halbtc8822b1ant_monitor_bt_enable_disable(IN struct btc_coexist
		*btcoexist)
{
...
u32 halbtc8822b1ant_ltecoex_indirect_read_reg(IN struct btc_coexist
		*btcoexist,
		IN u16 reg_addr)
{
...
void halbtc8822b1ant_ltecoex_pathcontrol_owner(IN struct btc_coexist
		*btcoexist,
...
void halbtc8822b1ant_ltecoex_set_coex_table(IN struct btc_coexist
		*btcoexist,
...
void halbtc8822b1ant_ltcoex_set_break_table(IN struct btc_coexist
		*btcoexist,
...
void halbtc8822b1ant_set_wltoggle_coex_table(IN struct btc_coexist
		*btcoexist,
...
void halbtc8822b1ant_set_fw_ignore_wlan_act(IN struct btc_coexist
		*btcoexist,
		IN boolean enable)
{
...
void halbtc8822b1ant_action_wifi_native_lps(IN struct btc_coexist
		*btcoexist)
{
	halbtc8822b1ant_adjust_wl_tx_power(btcoexist, NORMAL_EXEC, 0xd8);
	halbtc8822b1ant_adjust_bt_tx_power(btcoexist, NORMAL_EXEC, 0);
...
void halbtc8822b1ant_action_wifi_multi_port(IN struct btc_coexist
		*btcoexist,
...
void halbtc8822b1ant_action_wifi_not_connected(IN struct btc_coexist
		*btcoexist)
{
	BTC_SPRINTF(trace_buf, BT_TMP_BUF_SIZE,
...
void halbtc8822b1ant_action_wifi_connected(IN struct btc_coexist
		*btcoexist)
{
	struct  btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
...
void halbtc8822b1ant_run_sw_coexist_mechanism(IN struct btc_coexist
		*btcoexist)
{
...
static
void halbtc8822b1ant_run_coexist_mechanism(IN struct btc_coexist
		*btcoexist)
{
...
void ex_halbtc8822b1ant_media_status_notify(IN struct btc_coexist
		*btcoexist,
		IN u8 type)
{
	u32			wifi_bw;
...
void ex_halbtc8822b1ant_specific_packet_notify(IN struct btc_coexist
		*btcoexist,
		IN u8 type)
{
	u8			h2c_para[4] = {0};
...
{}
void ex_halbtc8822b1ant_display_ant_detection(IN struct btc_coexist
		*btcoexist)
{}
...
void ex_halbtc8822b1ant_display_simple_coex_info(IN struct btc_coexist
		*btcoexist)
{
	struct  btc_board_info		*board_info = &btcoexist->board_info;
	struct  btc_bt_link_info	*bt_link_info = &btcoexist->bt_link_info;
...
void ex_halbtc8822b1ant_scan_notify_without_bt(IN struct btc_coexist
		*btcoexist,
		IN u8 type)
{
	boolean wifi_under_5g = FALSE;
...
void ex_halbtc8822b1ant_wl_fwdbginfo_notify(IN struct btc_coexist
		*btcoexist,
		IN u8 *tmp_buf, IN u8 length)
{
	u8 i = 0;
...
void ex_halbtc8822b1ant_rx_rate_change_notify(IN struct btc_coexist
		*btcoexist,
...
void ex_halbtc8822b1ant_switch_band_without_bt(IN struct btc_coexist
		*btcoexist,
