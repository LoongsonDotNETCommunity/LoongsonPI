	...
	if (isCCKrate) {
		...
		//if(pPktinfo->bPacketMatchBSSID)
		{
			...
			if ((pDM_Odm->SupportPlatform == ODM_WIN) &&
				...
				SQ = odm_SQ_process_patch_RT_CID_819x_Acer(pDM_Odm, isCCKrate, PWDB_ALL, 0,
						0);
			...
			//if(pPktinfo->bPacketMatchBSSID)
			{
				...
				if ((pDM_Odm->SupportPlatform == ODM_WIN) &&
					...
					if (i == ODM_RF_PATH_A)
					   ...
					   (pDM_Odm->PatchID == RT_CID_819x_Acer)) {
					pPhyInfo->SignalQuality = odm_SQ_process_patch_RT_CID_819x_Acer(pDM_Odm,
								  isCCKrate, PWDB_ALL, 0, RSSI);
				}
#endif
			}
		}
