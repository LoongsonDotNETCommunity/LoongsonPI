...
//============================================================
u1Byte halbtc8821aCsr2ant_BtRssiState(
	u1Byte			levelNum,
	u1Byte			rssiThresh,
	u1Byte			rssiThresh1
)
...
u1Byte halbtc8821aCsr2ant_WifiRssiState(
...
VOID halbtc8821aCsr2ant_MonitorBtEnableDisable(
	IN 	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8821aCsr2ant_MonitorBtCtr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8821aCsr2ant_UpdateRaMask(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821aCsr2ant_AutoRateFallbackRetry(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
...
VOID halbtc8821aCsr2ant_RetryLimit(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
...
VOID halbtc8821aCsr2ant_AmpduMaxTime(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
...
VOID halbtc8821aCsr2Ant_AmpduMaxNum(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
...
VOID halbtc8821aCsr2ant_LimitedTx(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
...
VOID halbtc8821aCsr2ant_LimitedRx(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
...
VOID halbtc8821aCsr2ant_QueryBtInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
u1Byte halbtc8821aCsr2ant_ActionAlgorithm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
BOOLEAN halbtc8821aCsr2ant_NeedToDecBtPwr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BOOLEAN		bRet = FALSE;
	...
	if (!pBtCoexist->fBtcGet(pBtCoexist, BTC_GET_BL_HS_OPERATION, &bBtHsOn))
		return FALSE;
	if (!pBtCoexist->fBtcGet(pBtCoexist, BTC_GET_BL_WIFI_CONNECTED,
				 &bWifiConnected))
		return FALSE;
...
VOID halbtc8821aCsr2ant_SetFwDacSwingLevel(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821aCsr2ant_SetFwDecBtPwr(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821aCsr2ant_DecBtPwr(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bDecBtPwr
)
...
VOID halbtc8821aCsr2ant_SetBtAutoReport(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821aCsr2ant_BtAutoReport(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bEnableAutoReport
)
...
VOID halbtc8821aCsr2ant_FwDacSwingLvl(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
...
)
{
	...
	halbtc8821aCsr2ant_SetFwDacSwingLevel(pBtCoexist,
					      pCoexDm->curFwDacSwingLvl);

	pCoexDm->preFwDacSwingLvl = pCoexDm->curFwDacSwingLvl;
}

VOID halbtc8821aCsr2ant_SetSwRfRxLpfCorner(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821aCsr2ant_RfShrink(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bRxRfShrinkOn
)
{
	...
	halbtc8821aCsr2ant_SetSwRfRxLpfCorner(pBtCoexist,
					      pCoexDm->bCurRfRxLpfShrink);

	pCoexDm->bPreRfRxLpfShrink = pCoexDm->bCurRfRxLpfShrink;
}

VOID halbtc8821aCsr2ant_SetSwPenaltyTxRateAdaptive(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821aCsr2ant_LowPenaltyRa(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bLowPenaltyRa
)
{
	...
	halbtc8821aCsr2ant_SetSwPenaltyTxRateAdaptive(pBtCoexist,
			pCoexDm->bCurLowPenaltyRa);

	pCoexDm->bPreLowPenaltyRa = pCoexDm->bCurLowPenaltyRa;
}

VOID halbtc8821aCsr2ant_SetDacSwingReg(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u4Byte			level
)
{
...
VOID halbtc8821aCsr2ant_SetSwFullTimeDacSwing(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821aCsr2ant_DacSwing(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
...
)
{
	...
	delay_ms(30);
	halbtc8821aCsr2ant_SetSwFullTimeDacSwing(pBtCoexist, bDacSwingOn,
			dacSwingLvl);
...
VOID halbtc8821aCsr2ant_SetAdcBackOff(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821aCsr2ant_AdcBackOff(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bAdcBackOff
)
...
VOID halbtc8821aCsr2ant_SetAgcTable(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821aCsr2ant_AgcTable(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bAgcTableEn
)
...
VOID halbtc8821aCsr2ant_SetCoexTable(
	IN	PBTC_COEXIST	pBtCoexist,
	IN	u4Byte		val0x6c0,
	IN	u4Byte		val0x6c4,
	IN	u4Byte		val0x6c8,
...
VOID halbtc8821aCsr2ant_CoexTable(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	u4Byte			val0x6c0,
	IN	u4Byte			val0x6c4,
...
)
{
	...
	halbtc8821aCsr2ant_SetCoexTable(pBtCoexist, val0x6c0, val0x6c4, val0x6c8,
					val0x6cc);
...
VOID halbtc8821aCsr2ant_SetFwIgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bEnable
)
{
...
VOID halbtc8821aCsr2ant_IgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bEnable
)
...
VOID halbtc8821aCsr2ant_SetFwPstdma(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			byte1,
	IN	u1Byte			byte2,
	IN	u1Byte			byte3,
...
VOID halbtc8821aCsr2ant_SwMechanism2(
	IN	PBTC_COEXIST	pBtCoexist,
...
)
{
	...
	halbtc8821aCsr2ant_DacSwing(pBtCoexist, NORMAL_EXEC, bSWDACSwing,
				    dacSwingLvl);
}

VOID halbtc8821aCsr2ant_SetAntPath(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821aCsr2ant_PsTdma(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bTurnOn,
	IN	u1Byte			type
...
VOID halbtc8821aCsr2ant_CoexAllOff(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	// fw all off
	...
	// hw all off
	halbtc8821aCsr2ant_CoexTable(pBtCoexist, NORMAL_EXEC, 0x55555555,
				     0x55555555, 0xffff, 0x3);
}

VOID halbtc8821aCsr2ant_CoexUnder5G(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8821aCsr2ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	// force to reset coex mechanism
	halbtc8821aCsr2ant_CoexTable(pBtCoexist, FORCE_EXEC, 0x55555555,
				     0x55555555, 0xffff, 0x3);
...
VOID halbtc8821aCsr2ant_BtInquiryPage(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	...
	halbtc8821aCsr2ant_CoexTable(pBtCoexist, NORMAL_EXEC, 0x55ff55ff,
				     0x5afa5afa, 0xffff, 0x3);
	halbtc8821aCsr2ant_PsTdma(pBtCoexist, NORMAL_EXEC, TRUE, 3);
}
BOOLEAN halbtc8821aCsr2ant_IsCommonAction(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8821aCsr2ant_TdmaDurationAdjust(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bScoHid,
	IN	BOOLEAN			bTxPause,
...
)
{
	...
	if (pCoexDm->curPsTdma != pCoexDm->psTdmaDuAdjType) {
		...
		if (!bScan && !bLink && !bRoam) {
			halbtc8821aCsr2ant_PsTdma(pBtCoexist, NORMAL_EXEC, TRUE,
...
VOID halbtc8821aCsr2ant_ActionSco(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8821aCsr2ant_ActionHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte	wifiRssiState, btRssiState;
...
VOID halbtc8821aCsr2ant_ActionA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	//u1Byte		wifiRssiState, btRssiState;
	...
	if (pCoexSta->bSlave == FALSE) {
		halbtc8821aCsr2ant_CoexTable(pBtCoexist, NORMAL_EXEC, 0xfdfdfdfd,
					     0xdfdadfda, 0xffffff, 0x3);
...
VOID halbtc8821aCsr2ant_ActionA2dpPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8821aCsr2ant_ActionPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, btRssiState;
...
//PAN(HS) only
VOID halbtc8821aCsr2ant_ActionPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, btRssiState;
...
//PAN(EDR)+A2DP
VOID halbtc8821aCsr2ant_ActionPanEdrA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, btRssiState, btInfoExt;
...
VOID halbtc8821aCsr2ant_ActionPanEdrHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, btRssiState;
...
// HID+A2DP+PAN(EDR)
VOID halbtc8821aCsr2ant_ActionHidA2dpPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, btRssiState, btInfoExt;
...
VOID halbtc8821aCsr2ant_ActionHidA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, btRssiState, btInfoExt;
...
VOID halbtc8821aCsr2ant_RunCoexistMechanism(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	//PBTC_STACK_INFO		pStackInfo=&pBtCoexist->stackInfo;
...
)
{
	...
	//if(bBackUp)
	{
		...
		pCoexDm->btRf0x1eBackup = pBtCoexist->fBtcGetRfReg(pBtCoexist, BTC_RF_A,
					  0x1e, 0xfffff);
	...
	//Antenna config
	halbtc8821aCsr2ant_SetAntPath(pBtCoexist, BTC_ANT_WIFI_AT_MAIN, TRUE,
				      FALSE);
...
)
{
	...
	CL_SPRINTF(cliBuf, BT_TMP_BUF_SIZE, "\r\n %-35s = %d_%d/ 0x%x/ 0x%x(%d)",
		   ...
		   GLCoexVerDate8821aCsr2Ant, GLCoexVer8821aCsr2Ant, fwVer, btPatchVer,
		   btPatchVer);
	CL_PRINTF(cliBuf);
	...
	CL_SPRINTF(cliBuf, BT_TMP_BUF_SIZE, "\r\n %-35s = [%s/ %d/ %d] ",
		   ...
		   ((pCoexSta->bC2hBtInquiryPage) ? ("inquiry/page scan") : ((
					   BT_8821A_CSR_2ANT_BT_STATUS_IDLE == pCoexDm->btStatus) ? "idle" : ((
							   BT_8821A_CSR_2ANT_BT_STATUS_CONNECTED_IDLE == pCoexDm->btStatus) ?
							   "connected-idle" : "busy"))),
