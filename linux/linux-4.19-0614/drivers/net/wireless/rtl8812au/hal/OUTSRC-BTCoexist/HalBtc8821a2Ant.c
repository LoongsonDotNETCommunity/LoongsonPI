...
//============================================================
u1Byte halbtc8821a2ant_BtRssiState(
	u1Byte			levelNum,
	u1Byte			rssiThresh,
	u1Byte			rssiThresh1
)
...
u1Byte halbtc8821a2ant_WifiRssiState(
...
VOID halbtc8821a2ant_MonitorBtEnableDisable(
	IN 	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8821a2ant_LimitedRx(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821a2ant_MonitorBtCtr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8821a2ant_MonitorWiFiCtr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	//u4Byte 	u4Tmp;
...
VOID halbtc8821a2ant_QueryBtInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
BOOLEAN halbtc8821a2ant_IsWifiStatusChanged(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	...
	if (bWifiConnected) {
		...
		wifiRssiState = halbtc8821a2ant_WifiRssiState(pBtCoexist, 3, 2,
				BT_8821A_2ANT_WIFI_RSSI_COEXSWITCH_THRES, 0);

		if ((BTC_RSSI_STATE_HIGH == wifiRssiState)
		    || (BTC_RSSI_STATE_LOW == wifiRssiState)) {
			return TRUE;
		}
...
VOID halbtc8821a2ant_UpdateBtLinkInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	...
	if (!pStackInfo->bHidExist)
		pStackInfo->bHidExist =
			pCoexSta->bHidExist;  //sync  BTInfo with BT firmware and stack
...
u1Byte halbtc8821a2ant_ActionAlgorithm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BT_LINK_INFO	pBtLinkInfo = &pBtCoexist->btLinkInfo;
...
VOID halbtc8821a2ant_SetFwDacSwingLevel(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821a2ant_SetFwDecBtPwr(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821a2ant_SetBtAutoReport(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821a2ant_BtAutoReport(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bEnableAutoReport
)
...
VOID halbtc8821a2ant_FwDacSwingLvl(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
...
VOID halbtc8821a2ant_SetSwRfRxLpfCorner(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821a2ant_SetSwPenaltyTxRateAdaptive(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821a2ant_LowPenaltyRa(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bLowPenaltyRa
)
{
	...
	halbtc8821a2ant_SetSwPenaltyTxRateAdaptive(pBtCoexist,
			pCoexDm->bCurLowPenaltyRa);

	pCoexDm->bPreLowPenaltyRa = pCoexDm->bCurLowPenaltyRa;
}

VOID halbtc8821a2ant_SetDacSwingReg(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u4Byte			level
)
{
...
VOID halbtc8821a2ant_SetSwFullTimeDacSwing(
	IN	PBTC_COEXIST		pBtCoexist,
...
)
{
	RT_TRACE(COMP_COEX, DBG_TRACE,
		 ("[BTCoex], %s turn DacSwing=%s, dacSwingLvl=0x%x\n",
		  (bForceExec ? "force to" : ""), ((bDacSwingOn) ? "ON" : "OFF"),
		  dacSwingLvl));
	...
	delay_ms(30);
	halbtc8821a2ant_SetSwFullTimeDacSwing(pBtCoexist, bDacSwingOn,
					      dacSwingLvl);
...
VOID halbtc8821a2ant_SetAdcBackOff(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821a2ant_AdcBackOff(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bAdcBackOff
)
...
VOID halbtc8821a2ant_SetAgcTable(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8821a2ant_SetCoexTable(
	IN	PBTC_COEXIST	pBtCoexist,
	IN	u4Byte		val0x6c0,
	IN	u4Byte		val0x6c4,
	IN	u4Byte		val0x6c8,
...
VOID halbtc8821a2ant_CoexTable(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	u4Byte			val0x6c0,
	IN	u4Byte			val0x6c4,
...
)
{
	...
	halbtc8821a2ant_SetCoexTable(pBtCoexist, val0x6c0, val0x6c4, val0x6c8,
				     val0x6cc);
...
VOID halbtc8821a2ant_CoexTableWithType(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
{
	...
	switch (type) {
	case 0:
		halbtc8821a2ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x55555555,
					  0xffffff, 0x3);
		break;
	case 1:
		halbtc8821a2ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x5afa5afa,
					  0xffffff, 0x3);
		break;
	case 2:
		halbtc8821a2ant_CoexTable(pBtCoexist, bForceExec, 0x5ada5ada, 0x5ada5ada,
					  0xffffff, 0x3);
		break;
	case 3:
		halbtc8821a2ant_CoexTable(pBtCoexist, bForceExec, 0xaaaaaaaa, 0xaaaaaaaa,
					  0xffffff, 0x3);
		break;
	case 4:
		halbtc8821a2ant_CoexTable(pBtCoexist, bForceExec, 0xffffffff, 0xffffffff,
					  0xffffff, 0x3);
		break;
	case 5:
		halbtc8821a2ant_CoexTable(pBtCoexist, bForceExec, 0x5fff5fff, 0x5fff5fff,
					  0xffffff, 0x3);
		break;
	case 6:
		halbtc8821a2ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5a5a5a5a,
					  0xffffff, 0x3);
		break;
	case 7:
		halbtc8821a2ant_CoexTable(pBtCoexist, bForceExec, 0x55dd55dd, 0x5ada5ada,
					  0xffffff, 0x3);
		break;
	case 8:
		halbtc8821a2ant_CoexTable(pBtCoexist, bForceExec, 0x55dd55dd, 0x5ada5ada,
	...
	case 12:
		...
		break;
	case 13:
		halbtc8821a2ant_CoexTable(pBtCoexist, bForceExec, 0x5fff5fff, 0xaaaaaaaa,
					  0xffffff, 0x3);
		break;
	case 14:
		halbtc8821a2ant_CoexTable(pBtCoexist, bForceExec, 0x5fff5fff, 0x5ada5ada,
					  0xffffff, 0x3);
		break;
	case 15:
		halbtc8821a2ant_CoexTable(pBtCoexist, bForceExec, 0x55dd55dd, 0xaaaaaaaa,
					  0xffffff, 0x3);
		break;
	case 16:
		halbtc8821a2ant_CoexTable(pBtCoexist, bForceExec, 0x5fdf5fdf, 0x5fdb5fdb,
					  0xffffff, 0x3);
		break;
	case 17:
		halbtc8821a2ant_CoexTable(pBtCoexist, bForceExec, 0xfafafafa, 0xfafafafa,
					  0xffffff, 0x3);
		break;
	default:
		break;
...
VOID halbtc8821a2ant_SetFwIgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bEnable
)
{
...
VOID halbtc8821a2ant_SetLpsRpwm(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			lpsVal,
	IN	u1Byte			rpwmVal
)
...
VOID halbtc8821a2ant_IgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bEnable
)
...
VOID halbtc8821a2ant_SetFwPstdma(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			byte1,
	IN	u1Byte			byte2,
	IN	u1Byte			byte3,
...
VOID halbtc8821a2ant_SwMechanism1(
	IN	PBTC_COEXIST	pBtCoexist,
...
VOID halbtc8821a2ant_SwMechanism2(
	IN	PBTC_COEXIST	pBtCoexist,
...
)
{
	...
	halbtc8821a2ant_DacSwing(pBtCoexist, NORMAL_EXEC, bSWDACSwing,
				 dacSwingLvl);
}

VOID halbtc8821a2ant_SetAntPath(
	IN	PBTC_COEXIST		pBtCoexist,
...
)
{
	...
	wifiRssiState1 = halbtc8821a2ant_WifiRssiState(pBtCoexist, 1, 2,
			 BT_8821A_2ANT_WIFI_RSSI_COEXSWITCH_THRES, 0);
	btRssiState = halbtc8821a2ant_BtRssiState(2,
...
VOID halbtc8821a2ant_PowerSaveState(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				psType,
	IN	u1Byte				lpsVal,
	IN	u1Byte				rpwmVal
...
VOID halbtc8821a2ant_CoexAllOff(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	// fw all off
...
VOID halbtc8821a2ant_CoexUnder5G(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8821a2ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8821a2ant_ActionBtInquiry(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8821a2ant_ActionWiFiLinkProcess(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
BOOLEAN halbtc8821a2ant_ActionWifiIdleProcess(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
...
BOOLEAN halbtc8821a2ant_IsCommonAction(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8821a2ant_TdmaDurationAdjust(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bScoHid,
	IN	BOOLEAN			bTxPause,
...
)
{
	...
	if (pCoexDm->curPsTdma != pCoexDm->psTdmaDuAdjType) {
		...
		if (!bScan && !bLink && !bRoam) {
			halbtc8821a2ant_PsTdma(pBtCoexist, NORMAL_EXEC, TRUE,
...
VOID halbtc8821a2ant_ActionSco(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BT_LINK_INFO	pBtLinkInfo = &pBtCoexist->btLinkInfo;
	...
	halbtc8821a2ant_PowerSaveState(pBtCoexist, BTC_PS_WIFI_NATIVE, 0x0, 0x0);
	halbtc8821a2ant_PsTdma(pBtCoexist, NORMAL_EXEC, FALSE,
			       0); //for voice quality
...
VOID halbtc8821a2ant_ActionHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte	wifiRssiState, btRssiState;
...
VOID halbtc8821a2ant_ActionA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
...
VOID halbtc8821a2ant_ActionA2dpPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
...
VOID halbtc8821a2ant_ActionPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
	...
	if ((btRssiState == BTC_RSSI_STATE_HIGH) ||
	    (btRssiState == BTC_RSSI_STATE_STAY_HIGH)) {
		halbtc8821a2ant_PsTdma(pBtCoexist, NORMAL_EXEC, TRUE,
				       3);	//1->3 for TENCENT spp profile delay time
	} else {
		halbtc8821a2ant_PsTdma(pBtCoexist, NORMAL_EXEC, TRUE, 5);
	}
...
//PAN(HS) only
VOID halbtc8821a2ant_ActionPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
...
//PAN(EDR)+A2DP
VOID halbtc8821a2ant_ActionPanEdrA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
...
VOID halbtc8821a2ant_ActionPanEdrHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
...
// HID+A2DP+PAN(EDR)
VOID halbtc8821a2ant_ActionHidA2dpPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1,  btRssiState;
...
VOID halbtc8821a2ant_ActionHidA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
	...
	wifiRssiState1 = halbtc8821a2ant_WifiRssiState(pBtCoexist, 1, 2,
			 BT_8821A_2ANT_WIFI_RSSI_COEXSWITCH_THRES, 0);
	btRssiState = halbtc8821a2ant_BtRssiState(3,
...
VOID halbtc8821a2ant_ActionBtWhckTest(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	halbtc8821a2ant_DecBtPwr(pBtCoexist, NORMAL_EXEC, 0);
...
VOID halbtc8821a2ant_ActionWifiMultiPort(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	halbtc8821a2ant_FwDacSwingLvl(pBtCoexist, NORMAL_EXEC, 6);
...
VOID halbtc8821a2ant_RunCoexistMechanism(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8821a2ant_WifiOffHwCfg(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8821a2ant_InitHwConfig(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bBackUp
)
{
	...
	pBtCoexist->fBtcWrite1Byte(pBtCoexist, 0x76e,
...
//============================================================
VOID EXhalbtc8821a2ant_PowerOnSetting(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID EXhalbtc8821a2ant_PreLoadFirmware(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BOARD_INFO 	pBoardInfo = &pBtCoexist->boardInfo;
...
VOID EXhalbtc8821a2ant_InitHwConfig(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID EXhalbtc8821a2ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID EXhalbtc8821a2ant_DisplayCoexInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BOARD_INFO		pBoardInfo = &pBtCoexist->boardInfo;
	...
	CL_SPRINTF(cliBuf, BT_TMP_BUF_SIZE, "\r\n %-35s = [%s/ %ddBm/ %d] ",
		   ...
		   ((pBtCoexist->btInfo.bBtDisabled) ? ("disabled") :	((
					   pCoexSta->bC2hBtInquiryPage) ? ("inquiry/page scan") : ((
							   BT_8821A_2ANT_BT_STATUS_NON_CONNECTED_IDLE == pCoexDm->btStatus) ?
							   "non-connected idle" :
	...
	CL_SPRINTF(cliBuf, BT_TMP_BUF_SIZE, "\r\n %-35s = %d/ %d/ %d ",
		   ...
		   pCoexDm->bCurRfRxLpfShrink, pCoexDm->bCurLowPenaltyRa,
		   pCoexDm->bLimitedDig);
	CL_PRINTF(cliBuf);
	CL_SPRINTF(cliBuf, BT_TMP_BUF_SIZE, "\r\n %-35s = %d/ %d/ %d(0x%x) ",
		   "SM2[AgcT/ AdcB/ SwDacSwing(lvl)]", \
		   pCoexDm->bCurAgcTableEn, pCoexDm->bCurAdcBackOff, pCoexDm->bCurDacSwingOn,
...
VOID EXhalbtc8821a2ant_IpsNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8821a2ant_LpsNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8821a2ant_ConnectNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8821a2ant_MediaStatusNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				type
)
{
...
VOID EXhalbtc8821a2ant_BtInfoNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	pu1Byte			tmpBuf,
	IN	u1Byte			length
)
	...
	if (BT_INFO_SRC_8821A_2ANT_WIFI_FW != rspSource) {
		...
		if (!pBtCoexist->bManualControl && !bWifiUnder5G) {
			...
			if ((pCoexSta->btInfoExt & BIT3)) {
				RT_TRACE(COMP_COEX, DBG_LOUD,
					 ("[BTCoex], BT ext info bit3=1, bWifiConnected=%d\n", bWifiConnected));
				if (bWifiConnected) {
					RT_TRACE(COMP_COEX, DBG_LOUD,
				...
				RT_TRACE(COMP_COEX, DBG_LOUD,
					 ("[BTCoex], BT ext info bit3=0, bWifiConnected=%d\n", bWifiConnected));
...
VOID EXhalbtc8821a2ant_HaltNotify(
	IN	PBTC_COEXIST			pBtCoexist
)
{
...
VOID EXhalbtc8821a2ant_PnpNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				pnpState
)
{
...
VOID EXhalbtc8821a2ant_Periodical(
	IN	PBTC_COEXIST			pBtCoexist
)
{
