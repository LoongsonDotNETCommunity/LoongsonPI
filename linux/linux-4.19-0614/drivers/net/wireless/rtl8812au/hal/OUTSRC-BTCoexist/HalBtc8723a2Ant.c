...
//============================================================
BOOLEAN halbtc8723a2ant_IsWifiIdle(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BOOLEAN		bWifiConnected = FALSE, bScan = FALSE, bLink = FALSE,
			bRoam = FALSE;
...
BOOLEAN halbtc8723a2ant_IsWifiConnectedIdle(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BOOLEAN		bWifiConnected = FALSE, bScan = FALSE, bLink = FALSE,
			bRoam = FALSE, bWifiBusy = FALSE;
...
u1Byte halbtc8723a2ant_BtRssiState(
	u1Byte			levelNum,
	u1Byte			rssiThresh,
	u1Byte			rssiThresh1
)
...
u1Byte halbtc8723a2ant_WifiRssiState(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			index,
	IN	u1Byte			levelNum,
...
VOID halbtc8723a2ant_IndicateWifiChnlBwInfo(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				type
)
{
...
VOID halbtc8723a2ant_QueryBtInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
u1Byte halbtc8723a2ant_ActionAlgorithm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
BOOLEAN halbtc8723a2ant_NeedToDecBtPwr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BOOLEAN		bRet = FALSE;
...
VOID halbtc8723a2ant_SetFwDacSwingLevel(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8723a2ant_SetFwDecBtPwr(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8723a2ant_FwDacSwingLvl(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
...
VOID halbtc8723a2ant_SetSwRfRxLpfCorner(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8723a2ant_SetSwPenaltyTxRateAdaptive(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8723a2ant_LowPenaltyRa(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bLowPenaltyRa
)
{
	...
	halbtc8723a2ant_SetSwPenaltyTxRateAdaptive(pBtCoexist,
			pCoexDm->bCurLowPenaltyRa);

	pCoexDm->bPreLowPenaltyRa = pCoexDm->bCurLowPenaltyRa;
}

VOID halbtc8723a2ant_SetSwFullTimeDacSwing(
	IN	PBTC_COEXIST		pBtCoexist,
...
)
{
	...
	delay_ms(30);
	halbtc8723a2ant_SetSwFullTimeDacSwing(pBtCoexist, bDacSwingOn,
					      dacSwingLvl);
...
VOID halbtc8723a2ant_SetAdcBackOff(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8723a2ant_AdcBackOff(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bAdcBackOff
)
...
VOID halbtc8723a2ant_SetAgcTable(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8723a2ant_SetCoexTable(
	IN	PBTC_COEXIST	pBtCoexist,
	IN	u4Byte		val0x6c0,
	IN	u4Byte		val0x6c8,
	IN	u1Byte		val0x6cc
...
VOID halbtc8723a2ant_CoexTable(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	u4Byte			val0x6c0,
	IN	u4Byte			val0x6c8,
...
VOID halbtc8723a2ant_SetFwIgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bEnable
)
{
...
VOID halbtc8723a2ant_IgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bEnable
)
...
VOID halbtc8723a2ant_SetFwPstdma(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			byte1,
	IN	u1Byte			byte2,
	IN	u1Byte			byte3,
...
)
{
	...
	if (btTxRxCnt > 3000) {
		...
		pCoexDm->curPsTdma = 8;
		BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE_FW,
			  ("[BTCoex], turn ON PS TDMA, type=%d for BT tx/rx counters=%d(>3000)\n",
...
VOID halbtc8723a2ant_CoexAllOff(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	// fw all off
	...
	// hw all off
	halbtc8723a2ant_CoexTable(pBtCoexist, NORMAL_EXEC, 0x55555555, 0xffff,
				  0x3);
}

VOID halbtc8723a2ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8723a2ant_BtInquiryPage(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8723a2ant_BtEnableAction(
	IN 	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8723a2ant_MonitorBtCtr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8723a2ant_MonitorBtEnableDisable(
	IN 	PBTC_COEXIST		pBtCoexist
)
{
...
BOOLEAN halbtc8723a2ant_IsCommonAction(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_STACK_INFO		pStackInfo = &pBtCoexist->stackInfo;
...
VOID halbtc8723a2ant_TdmaDurationAdjust(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bScoHid,
	IN	BOOLEAN			bTxPause,
...
)
{
	...
	if (pCoexDm->curPsTdma != pCoexDm->psTdmaDuAdjType) {
		...
		if (!bScan && !bLink && !bRoam) {
			halbtc8723a2ant_PsTdma(pBtCoexist, NORMAL_EXEC, TRUE,
...
VOID halbtc8723a2ant_ActionSco(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8723a2ant_ActionHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte	wifiRssiState, wifiRssiState1;
...
VOID halbtc8723a2ant_ActionA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8723a2ant_ActionPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btInfoExt;
...
//PAN(HS) only
VOID halbtc8723a2ant_ActionPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
//PAN(EDR)+A2DP
VOID halbtc8723a2ant_ActionPanEdrA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btInfoExt;
...
VOID halbtc8723a2ant_ActionPanEdrHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1;
...
// HID+A2DP+PAN(EDR)
VOID halbtc8723a2ant_ActionHidA2dpPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btInfoExt;
...
VOID halbtc8723a2ant_ActionHidA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btInfoExt;
...
VOID halbtc8723a2ant_RunCoexistMechanism(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_STACK_INFO		pStackInfo = &pBtCoexist->stackInfo;
	...
	if (pStackInfo->bProfileNotified) {
		...
		if (pCoexSta->bHoldPeriodCnt
		    && (BT_8723A_2ANT_COEX_ALGO_PANHS != algorithm)) {
			BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE,
...
//============================================================
VOID wa_halbtc8723a2ant_MonitorC2h(
	IN	PBTC_COEXIST			pBtCoexist
)
{
	u1Byte	tmp1b = 0x0;
...
VOID EXhalbtc8723a2ant_InitHwConfig(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID EXhalbtc8723a2ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
...
VOID EXhalbtc8723a2ant_DisplayCoexInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	...
	CL_SPRINTF(cliBuf, BT_TMP_BUF_SIZE, "\r\n %-35s = [%s/ %d/ %d] ",
		   ...
		   ((pCoexSta->bC2hBtInquiryPage) ? ("inquiry/page scan") : ((
					   BT_8723A_2ANT_BT_STATUS_IDLE == pCoexDm->btStatus) ? "idle" : ((
							   BT_8723A_2ANT_BT_STATUS_CONNECTED_IDLE == pCoexDm->btStatus) ?
							   "connected-idle" : "busy"))),
...
VOID EXhalbtc8723a2ant_IpsNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8723a2ant_LpsNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8723a2ant_ScanNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8723a2ant_ConnectNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8723a2ant_SpecialPacketNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				type
)
{
...
VOID EXhalbtc8723a2ant_BtInfoNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	pu1Byte			tmpBuf,
	IN	u1Byte			length
)
...
VOID EXhalbtc8723a2ant_StackOperationNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				type
)
{
...
VOID EXhalbtc8723a2ant_HaltNotify(
	IN	PBTC_COEXIST			pBtCoexist
)
{
...
VOID EXhalbtc8723a2ant_Periodical(
	IN	PBTC_COEXIST			pBtCoexist
)
{
	BTC_PRINT(BTC_MSG_INTERFACE, INTF_NOTIFY,
