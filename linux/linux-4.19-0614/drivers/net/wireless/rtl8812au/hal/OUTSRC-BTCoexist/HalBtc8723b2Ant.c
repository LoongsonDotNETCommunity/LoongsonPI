...
//============================================================
u1Byte halbtc8723b2ant_BtRssiState(
	u1Byte			levelNum,
	u1Byte			rssiThresh,
	u1Byte			rssiThresh1
)
...
u1Byte halbtc8723b2ant_WifiRssiState(
...
VOID halbtc8723b2ant_MonitorBtEnableDisable(
	IN 	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8723b2ant_LimitedRx(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8723b2ant_MonitorBtCtr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8723b2ant_MonitorWiFiCtr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	//u4Byte 	u4Tmp;
...
VOID halbtc8723b2ant_QueryBtInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
BOOLEAN halbtc8723b2ant_IsWifiStatusChanged(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	...
	if (bWifiConnected) {
		...
		wifiRssiState = halbtc8723b2ant_WifiRssiState(pBtCoexist, 3, 2,
				BT_8723B_2ANT_WIFI_RSSI_COEXSWITCH_THRES, 0);
...
VOID halbtc8723b2ant_UpdateBtLinkInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
u1Byte halbtc8723b2ant_ActionAlgorithm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BT_LINK_INFO	pBtLinkInfo = &pBtCoexist->btLinkInfo;
...
VOID halbtc8723b2ant_SetFwDecBtPwr(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8723b2ant_SetBtAutoReport(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8723b2ant_BtAutoReport(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bEnableAutoReport
)
...
VOID halbtc8723b2ant_SetSwRfRxLpfCorner(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8723b2ant_LowPenaltyRa(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bLowPenaltyRa
)
...
VOID halbtc8723b2ant_SetSwFullTimeDacSwing(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8723b2ant_SetAdcBackOff(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8723b2ant_AdcBackOff(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bAdcBackOff
)
...
VOID halbtc8723b2ant_SetAgcTable(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8723b2ant_SetCoexTable(
	IN	PBTC_COEXIST	pBtCoexist,
	IN	u4Byte		val0x6c0,
	IN	u4Byte		val0x6c4,
	IN	u4Byte		val0x6c8,
...
VOID halbtc8723b2ant_CoexTable(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	u4Byte			val0x6c0,
	IN	u4Byte			val0x6c4,
...
VOID halbtc8723b2ant_CoexTableWithType(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
{
	...
	case 1:
		...
		break;
	case 2:
		halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x5ada5ada, 0x5ada5ada,
					  0xffffff, 0x3);
		break;
	case 3:
	...
	case 6:
		...
		break;
	case 7:
		halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x55dd55dd, 0x5ada5ada,
					  0xffffff, 0x3);
		break;
	case 8:
		halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x55dd55dd, 0x5ada5ada,
	...
	case 12:
		...
		break;
	case 13:
		halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x5fff5fff, 0xaaaaaaaa,
					  0xffffff, 0x3);
		break;
	case 14:
		halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x5fff5fff, 0x5ada5ada,
					  0xffffff, 0x3);
		break;
	case 15:
		halbtc8723b2ant_CoexTable(pBtCoexist, bForceExec, 0x55dd55dd, 0xaaaaaaaa,
					  0xffffff, 0x3);
		break;
	default:
		break;
...
VOID halbtc8723b2ant_SetFwIgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bEnable
)
{
...
VOID halbtc8723b2ant_SetLpsRpwm(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			lpsVal,
	IN	u1Byte			rpwmVal
)
...
VOID halbtc8723b2ant_IgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bEnable
)
...
VOID halbtc8723b2ant_SetFwPstdma(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			byte1,
	IN	u1Byte			byte2,
	IN	u1Byte			byte3,
...
VOID halbtc8723b2ant_SwMechanism1(
	IN	PBTC_COEXIST	pBtCoexist,
...
VOID halbtc8723b2ant_SwMechanism2(
	IN	PBTC_COEXIST	pBtCoexist,
...
VOID halbtc8723b2ant_SetAntPath(
	IN	PBTC_COEXIST		pBtCoexist,
...
)
{
	...
	if (bUseExtSwitch) {
		...
		case BTC_ANT_WIFI_AT_MAIN:
			pBtCoexist->fBtcWrite1ByteBitMask(pBtCoexist, 0x92c, 0x3,
...
)
{
	...
	wifiRssiState1 = halbtc8723b2ant_WifiRssiState(pBtCoexist, 1, 2,
			 BT_8723B_2ANT_WIFI_RSSI_COEXSWITCH_THRES, 0);
	btRssiState = halbtc8723b2ant_BtRssiState(2,
			BT_8723B_2ANT_BT_RSSI_COEXSWITCH_THRES, 0);
...
VOID halbtc8723b2ant_PsTdmaCheckForPowerSaveState(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8723b2ant_PowerSaveState(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				psType,
	IN	u1Byte				lpsVal,
	IN	u1Byte				rpwmVal
...
VOID halbtc8723b2ant_CoexAllOff(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	// fw all off
...
VOID halbtc8723b2ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8723b2ant_ActionBtInquiry(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8723b2ant_ActionWiFiLinkProcess(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u4Byte 	u4Tmp;
...
BOOLEAN halbtc8723b2ant_ActionWifiIdleProcess(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
	...
	wifiRssiState1 = halbtc8723b2ant_WifiRssiState(pBtCoexist, 1, 2,
			 BT_8723B_2ANT_WIFI_RSSI_COEXSWITCH_THRES - 20, 0);
	btRssiState = halbtc8723b2ant_BtRssiState(2,
			BT_8723B_2ANT_BT_RSSI_COEXSWITCH_THRES, 0);
...
BOOLEAN halbtc8723b2ant_IsCommonAction(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8723b2ant_TdmaDurationAdjust(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bScoHid,
	IN	BOOLEAN			bTxPause,
...
VOID halbtc8723b2ant_ActionSco(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8723b2ant_ActionHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte	wifiRssiState, btRssiState;
...
VOID halbtc8723b2ant_ActionA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
...
VOID halbtc8723b2ant_ActionA2dpPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
...
VOID halbtc8723b2ant_ActionPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
...
//PAN(HS) only
VOID halbtc8723b2ant_ActionPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
...
//PAN(EDR)+A2DP
VOID halbtc8723b2ant_ActionPanEdrA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
...
VOID halbtc8723b2ant_ActionPanEdrHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
...
VOID halbtc8723b2ant_ActionHidA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1, btRssiState;
	...
	wifiRssiState1 = halbtc8723b2ant_WifiRssiState(pBtCoexist, 1, 2,
			 BT_8723B_2ANT_WIFI_RSSI_COEXSWITCH_THRES, 0);
	btRssiState = halbtc8723b2ant_BtRssiState(3,
			BT_8723B_2ANT_BT_RSSI_COEXSWITCH_THRES, 37);
...
VOID halbtc8723b2ant_ActionBtWhckTest(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	halbtc8723b2ant_DecBtPwr(pBtCoexist, NORMAL_EXEC, 0);
...
VOID halbtc8723b2ant_ActionWifiMultiPort(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	halbtc8723b2ant_FwDacSwingLvl(pBtCoexist, NORMAL_EXEC, 6);
...
VOID halbtc8723b2ant_RunCoexistMechanism(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8723b2ant_WifiOffHwCfg(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8723b2ant_InitHwConfig(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bBackUp
)
{
...
VOID EXhalbtc8723b2ant_PreLoadFirmware(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BOARD_INFO 	pBoardInfo = &pBtCoexist->boardInfo;
...
VOID EXhalbtc8723b2ant_InitHwConfig(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID EXhalbtc8723b2ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
...
VOID EXhalbtc8723b2ant_DisplayCoexInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BOARD_INFO		pBoardInfo = &pBtCoexist->boardInfo;
	...
	CL_SPRINTF(cliBuf, BT_TMP_BUF_SIZE, "\r\n %-35s = [%s/ %ddBm/ %d] ",
		   ...
		   ((pBtCoexist->btInfo.bBtDisabled) ? ("disabled") :	((
					   pCoexSta->bC2hBtInquiryPage) ? ("inquiry/page scan") : ((
							   BT_8723B_2ANT_BT_STATUS_NON_CONNECTED_IDLE == pCoexDm->btStatus) ?
							   "non-connected idle" :
...
VOID EXhalbtc8723b2ant_IpsNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8723b2ant_ScanNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8723b2ant_ConnectNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8723b2ant_MediaStatusNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				type
)
{
...
VOID EXhalbtc8723b2ant_SpecialPacketNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				type
)
{
...
VOID EXhalbtc8723b2ant_HaltNotify(
	IN	PBTC_COEXIST			pBtCoexist
)
{
...
VOID EXhalbtc8723b2ant_PnpNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				pnpState
)
{
	...
	if (pCoexSta->disVerInfoCnt <= 5) {
		...
		BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
			  ("[BTCoex], CoexVer/ FwVer/ PatchVer = %d_%x/ 0x%x/ 0x%x(%d)\n", \
			   GLCoexVerDate8723b2Ant, GLCoexVer8723b2Ant, fwVer, btPatchVer,
			   btPatchVer));
		BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
			  ("[BTCoex], ****************************************************************\n"));
