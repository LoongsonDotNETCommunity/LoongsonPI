...
//============================================================
u1Byte halbtc8192d2ant_WifiRssiState(
...
u1Byte halbtc8192d2ant_ActionAlgorithm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192d2ant_SetFwBalance(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192d2ant_SetFwDiminishWifi(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN 		bDacOn,
...
)
{
	...
	BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE_FW_EXEC,
		  ("[BTCoex], bDacOn=%s, bInterruptOn=%s, bNavOn=%s, write 0x12=0x%x\n",
...
VOID halbtc8192d2ant_DiminishWifi(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bDacOn,
	IN	BOOLEAN			bInterruptOn,
...
)
{
	...
	halbtc8192d2ant_SetFwDiminishWifi(pBtCoexist, bDacOn, bInterruptOn,
...
VOID halbtc8192d2ant_SetSwRfRxLpfCorner(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192d2ant_SetSwPenaltyTxRateAdaptive(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192d2ant_LowPenaltyRa(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bLowPenaltyRa
)
{
	...
	halbtc8192d2ant_SetSwPenaltyTxRateAdaptive(pBtCoexist,
			pCoexDm->bCurLowPenaltyRa);

	pCoexDm->bPreLowPenaltyRa = pCoexDm->bCurLowPenaltyRa;
}

VOID halbtc8192d2ant_SetSwFullTimeDacSwing(
	IN	PBTC_COEXIST		pBtCoexist,
...
)
{
	...
	delay_ms(30);
	halbtc8192d2ant_SetSwFullTimeDacSwing(pBtCoexist, bDacSwingOn,
					      dacSwingLvl);
...
VOID halbtc8192d2ant_SetAdcBackOff(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192d2ant_AdcBackOff(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bAdcBackOff
)
...
VOID halbtc8192d2ant_SetAgcTable(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192d2ant_SetCoexTable(
	IN	PBTC_COEXIST	pBtCoexist,
	IN	u4Byte		val0x6c4,
	IN	u4Byte		val0x6c8,
	IN	u4Byte		val0x6cc
...
VOID halbtc8192d2ant_CoexTable(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	u4Byte			val0x6c4,
	IN	u4Byte			val0x6c8,
...
VOID halbtc8192d2ant_CoexAllOff(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	// fw mechanism
	halbtc8192d2ant_Balance(pBtCoexist, NORMAL_EXEC, FALSE, 0, 0);
	halbtc8192d2ant_DiminishWifi(pBtCoexist, NORMAL_EXEC, FALSE, FALSE, 0,
				     FALSE);
...
VOID halbtc8192d2ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}

VOID halbtc8192d2ant_MonitorBtEnableDisable(
	IN 	PBTC_COEXIST		pBtCoexist,
	IN	u4Byte			btActive
)
{
...
VOID halbtc8192d2ant_MonitorBtState(
	IN	PBTC_COEXIST			pBtCoexist
)
{
...
VOID halbtc8192d2ant_ActionA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	...
	if (pCoexSta->bA2dpBusy && bWifiBusy) {
		...
		if (BTC_WIFI_TRAFFIC_TX == wifiTrafficDir) {
			...
			halbtc8192d2ant_DiminishWifi(pBtCoexist, NORMAL_EXEC, TRUE, FALSE, 0x20,
						     FALSE);
		} else if (BTC_WIFI_TRAFFIC_RX == wifiTrafficDir) {
		...
		// fw mechanism first
		halbtc8192d2ant_Balance(pBtCoexist, NORMAL_EXEC, FALSE, 0, 0);
		halbtc8192d2ant_DiminishWifi(pBtCoexist, NORMAL_EXEC, TRUE, TRUE, 0x18,
					     FALSE);
...
VOID halbtc8192d2ant_ActionPan(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192d2ant_ActionHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	...
	if (pCoexSta->bBtBusy && bWifiBusy) {
		if ((wifiRssiState == BTC_RSSI_STATE_HIGH) ||
			...
			if (BTC_WIFI_TRAFFIC_TX == wifiTrafficDir) {
				...
				halbtc8192d2ant_DiminishWifi(pBtCoexist, NORMAL_EXEC, TRUE, FALSE, 0x30,
							     FALSE);
			}
			// sw mechanism
			halbtc8192d2ant_AgcTable(pBtCoexist, NORMAL_EXEC, FALSE);
...
VOID halbtc8192d2ant_ActionSco(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192d2ant_ActionHidA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, wifiRssiState1;
...
VOID halbtc8192d2ant_ActionHidPanBc4(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BOOLEAN		bBtHsOn = FALSE, bWifiBusy = FALSE;
	...
	if (bBtHsOn) {
		halbtc8192d2ant_Balance(pBtCoexist, NORMAL_EXEC, FALSE, 0, 0);
		halbtc8192d2ant_DiminishWifi(pBtCoexist, NORMAL_EXEC, FALSE, FALSE, 0x0,
					     FALSE);

		halbtc8192d2ant_CoexTable(pBtCoexist, NORMAL_EXEC, 0x55555555, 0x000000f0,
					  0x40000010);
...
VOID halbtc8192d2ant_ActionHidPanBc8(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BOOLEAN		bBtHsOn = FALSE, bWifiBusy = FALSE;
...
VOID halbtc8192d2ant_ActionHidPan(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	if (BTC_CHIP_CSR_BC4 == pBtCoexist->boardInfo.btChipType) {
...
VOID halbtc8192d2ant_ActionPanA2dpBc4(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BOOLEAN		bBtHsOn = FALSE, bWifiBusy = FALSE;
...
VOID halbtc8192d2ant_ActionPanA2dpBc8(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BOOLEAN		bBtHsOn = FALSE, bWifiBusy = FALSE;
...
VOID halbtc8192d2ant_ActionPanA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	if (BTC_CHIP_CSR_BC4 == pBtCoexist->boardInfo.btChipType) {
...
BOOLEAN halbtc8192d2ant_IsBtCoexistEnter(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte			macPhyMode;
	...
	if (BTC_SMSP != macPhyMode) {
		BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE,
			  ("[BTCoex], Only support single mac single phy!!\n"));
		bRet = FALSE;
	}

	if (bWifiUnder5G) {
		BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE,
			  ("[BTCoex], wifi is under 5G or A band\n"));
		halbtc8192d2ant_CoexAllOff(pBtCoexist);
		bRet = FALSE;
	}
...
VOID EXhalbtc8192d2ant_InitHwConfig(
	IN	PBTC_COEXIST		pBtCoexist,
...
)
{
	...
	if ((BTC_CHIP_CSR_BC4 == pBtCoexist->boardInfo.btChipType) ||
		...
		halbtc8192d2ant_CoexTable(pBtCoexist, FORCE_EXEC, 0xaaaa9aaa, 0xffbd0040,
					  0x40000010);
...
VOID EXhalbtc8192d2ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
...
VOID EXhalbtc8192d2ant_DisplayCoexInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID EXhalbtc8192d2ant_IpsNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8192d2ant_LpsNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8192d2ant_MediaStatusNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				type
)
{
...
VOID EXhalbtc8192d2ant_SpecialPacketNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				type
)
{
...
VOID EXhalbtc8192d2ant_BtInfoNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	pu1Byte			tmpBuf,
	IN	u1Byte			length
)
...
VOID EXhalbtc8192d2ant_HaltNotify(
	IN	PBTC_COEXIST			pBtCoexist
)
{
...
VOID EXhalbtc8192d2ant_Periodical(
	IN	PBTC_COEXIST			pBtCoexist
)
{
	u1Byte	algorithm;
