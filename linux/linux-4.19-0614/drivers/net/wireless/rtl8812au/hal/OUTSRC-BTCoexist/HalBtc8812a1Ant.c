...
//============================================================
u1Byte halbtc8812a1ant_BtRssiState(
	u1Byte			levelNum,
	u1Byte			rssiThresh,
	u1Byte			rssiThresh1
)
...
u1Byte halbtc8812a1ant_WifiRssiState(
...
VOID halbtc8812a1ant_UpdateRaMask(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8812a1ant_MonitorBtCtr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8812a1ant_QueryBtInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte	dataLen = 3;
	...
	if (!pBtCoexist->btInfo.bBtDisabled) {
		if (!pCoexSta->btInfoQueryCnt ||
		    (pCoexSta->btInfoC2hCnt[BT_INFO_SRC_8812A_1ANT_BT_RSP] -
...
VOID halbtc8812a1ant_UpdateBtLinkInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
u1Byte halbtc8812a1ant_ActionAlgorithm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BT_LINK_INFO	pBtLinkInfo = &pBtCoexist->btLinkInfo;
...
VOID halbtc8812a1ant_SetBtAutoReport(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8812a1ant_BtAutoReport(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bEnableAutoReport
)
...
VOID halbtc8812a1ant_SetSwPenaltyTxRateAdaptive(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8812a1ant_LowPenaltyRa(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bLowPenaltyRa
)
{
	...
	halbtc8812a1ant_SetSwPenaltyTxRateAdaptive(pBtCoexist,
			pCoexDm->bCurLowPenaltyRa);

	pCoexDm->bPreLowPenaltyRa = pCoexDm->bCurLowPenaltyRa;
}

VOID halbtc8812a1ant_SetCoexTable(
	IN	PBTC_COEXIST	pBtCoexist,
	IN	u4Byte		val0x6c0,
	IN	u4Byte		val0x6c4,
	IN	u4Byte		val0x6c8,
...
VOID halbtc8812a1ant_CoexTable(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	u4Byte			val0x6c0,
	IN	u4Byte			val0x6c4,
...
)
{
	...
	halbtc8812a1ant_SetCoexTable(pBtCoexist, val0x6c0, val0x6c4, val0x6c8,
				     val0x6cc);
...
VOID halbtc8812a1ant_CoexTableWithType(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
{
	switch (type) {
	case 0:
		halbtc8812a1ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x55555555,
					  0xffff, 0x3);
		break;
	case 1:
		halbtc8812a1ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x5a5a5a5a,
					  0xffff, 0x3);
		break;
	case 2:
		halbtc8812a1ant_CoexTable(pBtCoexist, bForceExec, 0x5a5a5a5a, 0x5a5a5a5a,
					  0xffff, 0x3);
		break;
	case 3:
		halbtc8812a1ant_CoexTable(pBtCoexist, bForceExec, 0xaaaaaaaa, 0xaaaaaaaa,
					  0xffff, 0x3);
		break;
	case 4:
		halbtc8812a1ant_CoexTable(pBtCoexist, bForceExec, 0xffffffff, 0xffffffff,
					  0xffff, 0x3);
		break;
	case 5:
		halbtc8812a1ant_CoexTable(pBtCoexist, bForceExec, 0x5fff5fff, 0x5fff5fff,
					  0xffff, 0x3);
		break;
	case 6:
		halbtc8812a1ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5a5a5a5a,
					  0xffff, 0x3);
		break;
	case 7:
		halbtc8812a1ant_CoexTable(pBtCoexist, bForceExec, 0x5afa5afa, 0x5afa5afa,
					  0xffff, 0x3);
		break;
	default:
		break;
...
VOID halbtc8812a1ant_SetFwIgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bEnable
)
{
...
VOID halbtc8812a1ant_IgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bEnable
)
...
VOID halbtc8812a1ant_SetFwPstdma(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			byte1,
	IN	u1Byte			byte2,
	IN	u1Byte			byte3,
...
VOID halbtc8812a1ant_SetLpsRpwm(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			lpsVal,
	IN	u1Byte			rpwmVal
)
...
VOID halbtc8812a1ant_SetAntPath(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8812a1ant_CoexAllOff(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	// hw all off
...
BOOLEAN halbtc8812a1ant_IsCommonAction(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8812a1ant_TdmaDurationAdjustForAcl(
	IN	PBTC_COEXIST		pBtCoexist,
...
)
{
	...
	if (pCoexDm->bResetTdmaAdjust) {
		...
		if (pCoexDm->curPsTdma != 1 &&
			...
			halbtc8812a1ant_PsTdma(pBtCoexist, NORMAL_EXEC, TRUE,
...
VOID halbtc8812a1ant_PowerSaveState(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				psType,
	IN	u1Byte				lpsVal,
	IN	u1Byte				rpwmVal
...
VOID halbtc8812a1ant_CoexUnder5G(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8812a1ant_ActionWifiOnly(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	halbtc8812a1ant_CoexTableWithType(pBtCoexist, NORMAL_EXEC, 0);
...
VOID halbtc8812a1ant_MonitorBtEnableDisable(
	IN 	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8812a1ant_ActionSco(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}

VOID halbtc8812a1ant_ActionHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}
...
VOID halbtc8812a1ant_ActionA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}

VOID halbtc8812a1ant_ActionA2dpPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}

VOID halbtc8812a1ant_ActionPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}
...
//PAN(HS) only
VOID halbtc8812a1ant_ActionPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}
...
//PAN(EDR)+A2DP
VOID halbtc8812a1ant_ActionPanEdrA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}

VOID halbtc8812a1ant_ActionPanEdrHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}
...
// HID+A2DP+PAN(EDR)
VOID halbtc8812a1ant_ActionHidA2dpPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}

VOID halbtc8812a1ant_ActionHidA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}
...
)
{
	...
	BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE,
		  ("[BTCoex], Action for HS, bHsConnecting=%d!!!\n", bHsConnecting));
...
VOID halbtc8812a1ant_ActionBtInquiry(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BT_LINK_INFO pBtLinkInfo = &pBtCoexist->btLinkInfo;
...
VOID halbtc8812a1ant_ActionBtScoHidOnlyBusy(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				wifiStatus
)
{
...
VOID halbtc8812a1ant_ActionWifiConnectedBtAclBusy(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				wifiStatus
)
{
...
VOID halbtc8812a1ant_ActionWifiNotConnectedAssoAuthScan(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	halbtc8812a1ant_PowerSaveState(pBtCoexist, BTC_PS_WIFI_NATIVE, 0x0, 0x0);
...
VOID halbtc8812a1ant_ActionWifiConnectedScan(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	// power save state
...
VOID halbtc8812a1ant_ActionWifiConnectedSpecialPacket(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	// power save state
...
VOID halbtc8812a1ant_ActionWifiConnected(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8812a1ant_RunSwCoexistMechanism(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8812a1ant_RunCoexistMechanism(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
//============================================================
VOID EXhalbtc8812a1ant_PowerOnSetting(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}
...
VOID EXhalbtc8812a1ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
...
VOID EXhalbtc8812a1ant_DisplayCoexInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID EXhalbtc8812a1ant_IpsNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8812a1ant_ScanNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8812a1ant_MediaStatusNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				type
)
{
...
VOID EXhalbtc8812a1ant_SpecialPacketNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				type
)
{
...
)
{
	...
	if (pBtLinkInfo->bScoExist) {
		bRejApAggPkt = TRUE;
		halbtc8812a1ant_UpdateRaMask(pBtCoexist, NORMAL_EXEC, BTC_RATE_DISABLE,
					     0x00000003);	// disable cck 1M2M.
	} else {
		halbtc8812a1ant_UpdateRaMask(pBtCoexist, NORMAL_EXEC, BTC_RATE_ENABLE,
					     0x00000003);	// enable cck 1M2M.
	}
...
VOID EXhalbtc8812a1ant_HaltNotify(
	IN	PBTC_COEXIST			pBtCoexist
)
{
...
VOID EXhalbtc8812a1ant_PnpNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				pnpState
)
{
...
VOID EXhalbtc8812a1ant_Periodical(
	IN	PBTC_COEXIST			pBtCoexist
)
{
	...
	if (disVerInfoCnt <= 5) {
		...
		BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
			  ("[BTCoex], CoexVer/ FwVer/ PatchVer = %d_%x/ 0x%x/ 0x%x(%d)\n", \
			   GLCoexVerDate8812a1Ant, GLCoexVer8812a1Ant, fwVer, btPatchVer,
			   btPatchVer));
		BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
			  ("[BTCoex], ****************************************************************\n"));
	}
...
VOID EXhalbtc8812a1ant_DbgControl(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				opCode,
	IN	u1Byte				opLen,
	IN	pu1Byte				pData
