...
//	if(skb == NULL) goto _exit;
	...
	precv_frame->u.hdr.pkt =
		NULL; // set pointer to NULL before rtw_free_recvframe() if call netif_rx()
#endif
}

#ifdef CONFIG_AUTO_AP_MODE
static void rtw_os_ksocket_send(_adapter *padapter,
...
int rtw_recv_indicatepkt(_adapter *padapter, union recv_frame *precv_frame)
{
	...
	if (drvext_rx_handler(padapter, precv_frame->u.hdr.rx_data,
			      precv_frame->u.hdr.len) == _SUCCESS) {
...
_recv_indicatepkt_end:
	...
	precv_frame->u.hdr.pkt =
		NULL; // pointers to NULL before rtw_free_recvframe()
