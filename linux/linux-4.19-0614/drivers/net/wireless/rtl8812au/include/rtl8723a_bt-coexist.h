...
void BTHCI_StateMachine(PADAPTER padapter, u8 StateToEnter,
...
HCI_STATUS BTHCI_HandleHCICMD(PADAPTER padapter,
...
void BTDM_1AntSignalCompensation(PADAPTER padapter, u8 *rssi_wifi,
				 u8 *rssi_bt);
...
void BTDM_SetFw3a(PADAPTER padapter, u8 byte1, u8 byte2, u8 byte3,
		  u8 byte4, u8 byte5);
...
void BTDM_SingleAnt(PADAPTER padapter, u8 bSingleAntOn, u8 bInterruptOn,
		    u8 bMultiNAVOn);
...
void BTDM_DiminishWiFi(PADAPTER Adapter, u8 bDACOn, u8 bInterruptOn,
...
u8 BTDM_CheckCoexBcnRssiState(PADAPTER padapter, u8 levelNum,
			      u8 RssiThresh, u8 RssiThresh1);
u8 BTDM_CheckCoexRSSIState1(PADAPTER padapter, u8 levelNum, u8 RssiThresh,
			    u8 RssiThresh1);
u8 BTDM_CheckCoexRSSIState(PADAPTER padapter, u8 levelNum, u8 RssiThresh,
			   u8 RssiThresh1);
...
void BTDM_SignalCompensation(PADAPTER padapter, u8 *rssi_wifi,
			     u8 *rssi_bt);
