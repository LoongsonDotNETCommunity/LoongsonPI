...
void rtl8723b_set_FwMacIdConfig_cmd(_adapter *padapter, u8 mac_id, u8 raid,
				    u8 bw, u32 mask);
void rtl8723b_set_FwBtMpOper_cmd(PADAPTER padapter, u8 idx, u8 ver,
				 u8 reqnum, u8 param1);
...
void SetFwRelatedForWoWLAN8723b(_adapter *padapter,
...
s32 FillH2CCmd8723B(PADAPTER padapter, u8 ElementID, u32 CmdLen,
		    u8 *pCmdBuffer);
