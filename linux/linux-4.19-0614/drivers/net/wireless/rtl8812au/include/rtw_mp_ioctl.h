...
//oid_rtl_seg_81_87
NDIS_STATUS oid_rt_pro_write_bb_reg_hdl(struct oid_par_priv
					*poid_par_priv);
NDIS_STATUS oid_rt_pro_read_bb_reg_hdl(struct oid_par_priv *poid_par_priv);

NDIS_STATUS oid_rt_pro_write_rf_reg_hdl(struct oid_par_priv
					*poid_par_priv);
...
NDIS_STATUS oid_rt_pro8711_join_bss_hdl(struct oid_par_priv
					*poid_par_priv);
...
NDIS_STATUS oid_rt_pro8711_pkt_loss_hdl(struct oid_par_priv
					*poid_par_priv);
...
NDIS_STATUS oid_rt_pro_qry_pwrstate_hdl(struct oid_par_priv
					*poid_par_priv);
NDIS_STATUS oid_rt_pro_set_pwrstate_hdl(struct oid_par_priv
					*poid_par_priv);
...
NDIS_STATUS oid_rt_pro_encryption_ctrl_hdl(struct oid_par_priv
		*poid_par_priv);
NDIS_STATUS oid_rt_pro_add_sta_info_hdl(struct oid_par_priv
					*poid_par_priv);
...
NDIS_STATUS oid_rt_pro_trigger_gpio_hdl(struct oid_par_priv
					*poid_par_priv);
