...
struct hal_ops {
	...
	void	(*set_bwmode_handler)(_adapter *padapter, CHANNEL_WIDTH Bandwidth,
				      u8 Offset);
	...
	u8(*GetHalDefVarHandler)(_adapter *padapter, HAL_DEF_VARIABLE eVariable,
				 PVOID pValue);
	...
	void	(*AntDivCompareHandler)(_adapter *padapter, WLAN_BSSID_EX *dst,
					WLAN_BSSID_EX *src);
#endif
	...
	void	(*write_rfreg)(_adapter *padapter, u8 eRFPath, u32 RegAddr,
