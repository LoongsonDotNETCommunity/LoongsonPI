...
#ifndef SUPPORTED_LINK_MODE_GEPHY
#define SUPPORTED_LINK_MODE_GEPHY	BIT(7)
#endif
#ifndef SUPPORTED_LINK_MODE_1000BASEX
#define SUPPORTED_LINK_MODE_1000BASEX	BIT(10)
#endif
#ifndef SUPPORTED_LINK_MODE_MII
#define SUPPORTED_LINK_MODE_MII	BIT(9)
#endif
...
static inline unsigned int _kc_ptp_classify_raw(const struct sk_buff *skb)
{
    return sk_run_filter(skb, ptp_filter);
}

#define ptp_classify_raw    _kc_ptp_classify_raw

static inline int ptp_classify_init(void)
{
    return ptp_filter_init(ptp_filter, ARRAY_SIZE(ptp_filter));
}
#endif  /* < 3.15.0 */
...
static int _kc_flow_block_cb_setup_simple(struct flow_block_offload *f,
...
static u64 _kc_pci_get_dsn(struct pci_dev *dev);
