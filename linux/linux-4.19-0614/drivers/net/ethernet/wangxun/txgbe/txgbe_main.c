...
#define DRV_VERSION     __stringify(1.2.2kylinft)
#elif defined(TXGBE_SUPPORT_KYLIN_LX)
#define DRV_VERSION     __stringify(1.2.2kylinlx)
#else
#define DRV_VERSION     __stringify(1.2.2)
#endif
