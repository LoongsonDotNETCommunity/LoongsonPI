...
s32 rnpm_init_fdir_signature_n10(struct rnpm_hw *hw, u32 fdirctrl)
{
	...
	rnpm_fdir_enable_n10(hw, fdirctrl);
#endif
		...
		u8 queue)
{
	...
	fdirhashcmd |= rnpm_atr_compute_sig_hash_n10(input, common);
				    ...
				    union rnpm_atr_input *input_mask)
{
	...
	fdirtcpm = rnpm_get_fdirtcpm_n10(input_mask);
