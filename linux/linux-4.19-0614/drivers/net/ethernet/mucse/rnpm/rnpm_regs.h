...
#define ETH_IGNORE_ALL_ERR \
	(ETH_ERR_SCTP | ETH_ERR_L4 | ETH_ERR_L3 | \
	ETH_ERR_PKT_LEN_ERR | ETH_ERR_HDR_LEN_ERR)
...
#define RNPM_ETH_EMAC_GAT_PROGFULL_THRESH \
	(RNPM_ETH_BASE + 0x8090)
#define RNPM_ETH_EMAC_GAT_PROGEMPTY_THRESH \
	(RNPM_ETH_BASE + 0x8094)
...
#define RNPM_RXTRANS_CODE_ERR_PKTS(port)	(RNPM_ETH_BASE + 0x890c + 0x40 * (port))
#define RNPM_RXTRANS_CRC_ERR_PKTS(port)	(RNPM_ETH_BASE + 0x8910 + 0x40 * (port))
#define RNPM_RXTRANS_SLEN_ERR_PKTS(port)	(RNPM_ETH_BASE + 0x8914 + 0x40 * (port))
#define RNPM_RXTRANS_GLEN_ERR_PKTS(port)	(RNPM_ETH_BASE + 0x8918 + 0x40 * (port))
#define RNPM_RXTRANS_IPH_ERR_PKTS(port)	(RNPM_ETH_BASE + 0x891c + 0x40 * (port))
#define RNPM_RXTRANS_CSUM_ERR_PKTS(port)	(RNPM_ETH_BASE + 0x8920 + 0x40 * (port))
...
#define RNPM_TOP_ETH_PWR_DOWN_PORT(n) \
	(RNPM_COMM_REG0 + 0x8028 + 0xc * (n))
...
#define RNPM_MAC_MC_HASH_TABLE(i, idx)	(RNPM_XLMAC + 0x0010 + 0x04 * idx + i * MAC_OFFSET)
...
#define RNPM_MAC_UNICAST_LOW(i, port) (RNPM_XLMAC + 0x304 + i * 0x08 + port * MAC_OFFSET)
#define RNPM_MAC_UNICAST_HIGH(i, port) (RNPM_XLMAC + 0x300 + i * 0x08 + port * MAC_OFFSET)
/* 1588 */
...
#define RNPM_SWITCH_RPUUP_DATA_PROG_FULL_THRESH \
	(RNPM_SWITCH_BASE + 0x1108)
#define RNPM_SWITCH_RPUDN_DATA_PROG_FULL_THRESH \
	(RNPM_SWITCH_BASE + 0x110c)
...
#define RNPM_SWITCH_EN_SOFT_RESET \
	(RNPM_SWITCH_BASE + 0xf000)
