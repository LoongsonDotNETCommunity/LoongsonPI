...
static const struct acpi_device_id loongson_i2c_gpio_acpi_match[] = {
	{"LOON0005"},
	{}
};
MODULE_DEVICE_TABLE(acpi, loongson_i2c_gpio_acpi_match);

static struct platform_driver i2c_gpio_driver = {
	.driver		= {
		.name	= "i2c-gpio",
		.of_match_table	= of_match_ptr(i2c_gpio_dt_ids),
		.acpi_match_table = ACPI_PTR(loongson_i2c_gpio_acpi_match),
	},
