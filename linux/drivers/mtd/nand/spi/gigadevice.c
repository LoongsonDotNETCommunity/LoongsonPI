...
static int gd5fxgq4xc_ooblayout_128_ecc(struct mtd_info *mtd, int section,
					struct mtd_oob_region *oobregion)
{
	if (section)
		return -ERANGE;
...
static int gd5fxgq4xc_ooblayout_128_free(struct mtd_info *mtd, int section,
					 struct mtd_oob_region *oobregion)
{
	if (section)
		return -ERANGE;
...
static const struct mtd_ooblayout_ops gd5fxgq4xc_oob_128_ops = {
	.ecc = gd5fxgq4xc_ooblayout_128_ecc,
	.free = gd5fxgq4xc_ooblayout_128_free,
};
...
static const struct spinand_info gigadevice_spinand_table[] = {
	...
	SPINAND_INFO("GD5F4GQ6UExxG", 0x55,
		     ...
		     SPINAND_INFO_OP_VARIANTS(&read_cache_variants,
					      ...
					      &update_cache_variants),
		     SPINAND_HAS_QE_BIT,
		     SPINAND_ECCINFO(&gd5fxgq4xc_oob_128_ops,
				     gd5fxgq4uexxg_ecc_get_status)),
#endif
