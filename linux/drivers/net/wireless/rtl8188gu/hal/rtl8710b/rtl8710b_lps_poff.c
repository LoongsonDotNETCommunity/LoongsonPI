...
*****************************************************************************/
static void rtl8710b_lps_poff_h2c_param(PADAPTER padapter, u8 tx_bndy,
					u16 len,
					bool isDynamic)
{
...
static u8 rtl8710b_lps_poff_set_dynamic_file(u8 *pFile, u32 type,
		u32 wdata)
{
...
static void rtl8710b_lps_poff_dynamic_file(PADAPTER padapter, u8 index,
		u8 isGK)
{
...
*****************************************************************************/
static bool rtl8710b_prepare_for_enter_poff(PADAPTER padapter,
		bool bEnterLPS)
{
	struct pwrctrl_priv *pwrpriv = adapter_to_pwrctl(padapter);
	struct dvobj_priv *dvobj = adapter_to_dvobj(padapter);
