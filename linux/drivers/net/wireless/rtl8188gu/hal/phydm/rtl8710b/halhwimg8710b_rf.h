...
void odm_read_and_config_mp_8710b_radioa(/* tc: Test Chip, mp: mp Chip*/
...
void odm_read_and_config_mp_8710b_txpowertrack_pcie(/* tc: Test Chip, mp: mp Chip*/
	struct	PHY_DM_STRUCT *p_dm
);
...
void odm_read_and_config_mp_8710b_txpowertrack_sdio(/* tc: Test Chip, mp: mp Chip*/
	struct	PHY_DM_STRUCT *p_dm
);
...
void odm_read_and_config_mp_8710b_txpowertrack_usb(/* tc: Test Chip, mp: mp Chip*/
	struct	PHY_DM_STRUCT *p_dm
);
...
void odm_read_and_config_mp_8710b_txpwr_lmt(/* tc: Test Chip, mp: mp Chip*/
	struct	PHY_DM_STRUCT *p_dm
);
...
void odm_read_and_config_mp_8710b_txxtaltrack(/* tc: Test Chip, mp: mp Chip*/
	struct	PHY_DM_STRUCT *p_dm
);
