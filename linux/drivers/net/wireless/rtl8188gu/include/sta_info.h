...
typedef bool (*st_match_rule)(_adapter *adapter, u8 *local_naddr,
...
void rtw_st_ctl_register(struct st_ctl_t *st_ctl, u8 st_reg_id,
...
bool rtw_st_ctl_chk_reg_rule(struct st_ctl_t *st_ctl, _adapter *adapter,
...
extern struct sta_info *rtw_get_stainfo(struct sta_priv *pstapriv,
					u8 *hwaddr);
...
#if CONFIG_RTW_PRE_LINK_STA
struct sta_info *rtw_pre_link_sta_add(struct sta_priv *stapriv,
				      u8 *hwaddr);
