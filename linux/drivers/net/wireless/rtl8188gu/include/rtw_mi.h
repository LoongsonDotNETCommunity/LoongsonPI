...
int rtw_mi_get_ch_setting_union(_adapter *adapter, u8 *ch, u8 *bw,
				u8 *offset);
int rtw_mi_get_ch_setting_union_no_self(_adapter *adapter, u8 *ch, u8 *bw,
					u8 *offset);
...
u8 rtw_mi_buddy_p2p_chk_state(_adapter *padapter,
...
void rtw_mi_update_ap_bmc_camid(_adapter *padapter, u8 camid_a,
				u8 camid_b);
