...
extern WLAN_PWR_CFG
rtl8710B_power_on_flow[RTL8710B_TRANS_CARDEMU_TO_ACT_STEPS +
							   RTL8710B_TRANS_END_STEPS];
extern WLAN_PWR_CFG
rtl8710B_radio_off_flow[RTL8710B_TRANS_ACT_TO_CARDEMU_STEPS +
							    RTL8710B_TRANS_END_STEPS];
extern WLAN_PWR_CFG
rtl8710B_card_disable_flow[RTL8710B_TRANS_ACT_TO_CARDEMU_STEPS +
							       RTL8710B_TRANS_CARDEMU_TO_PDN_STEPS + RTL8710B_TRANS_END_STEPS];
extern WLAN_PWR_CFG
rtl8710B_card_enable_flow[RTL8710B_TRANS_ACT_TO_CARDEMU_STEPS +
							      RTL8710B_TRANS_CARDEMU_TO_PDN_STEPS + RTL8710B_TRANS_END_STEPS];
extern WLAN_PWR_CFG
rtl8710B_suspend_flow[RTL8710B_TRANS_ACT_TO_CARDEMU_STEPS +
							  RTL8710B_TRANS_CARDEMU_TO_SUS_STEPS + RTL8710B_TRANS_END_STEPS];
extern WLAN_PWR_CFG
rtl8710B_resume_flow[RTL8710B_TRANS_SUS_TO_CARDEMU_STEPS +
							 RTL8710B_TRANS_CARDEMU_TO_ACT_STEPS + RTL8710B_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8710B_hwpdn_flow[RTL8710B_TRANS_ACT_TO_CARDEMU_STEPS
					+ RTL8710B_TRANS_CARDEMU_TO_PDN_STEPS + RTL8710B_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8710B_enter_lps_flow[RTL8710B_TRANS_ACT_TO_LPS_STEPS
		+ RTL8710B_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8710B_leave_lps_flow[RTL8710B_TRANS_LPS_TO_ACT_STEPS
		+ RTL8710B_TRANS_END_STEPS];
