...
void _rtw_reg_notifier(struct wiphy *wiphy,
		       struct regulatory_request *request)
{
...
int rtw_reg_notifier(struct wiphy *wiphy,
		     struct regulatory_request *request)
#else
void rtw_reg_notifier(struct wiphy *wiphy,
		      struct regulatory_request *request)
#endif
{
...
static inline struct country_code_to_enum_rd *_rtw_regd_find_country(
	u16 countrycode)
{
	int i;
