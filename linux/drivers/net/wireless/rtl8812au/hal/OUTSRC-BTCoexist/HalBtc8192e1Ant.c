...
//============================================================
u1Byte halbtc8192e1ant_BtRssiState(
	u1Byte			levelNum,
	u1Byte			rssiThresh,
	u1Byte			rssiThresh1
)
...
u1Byte halbtc8192e1ant_WifiRssiState(
...
VOID halbtc8192e1ant_UpdateRaMask(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192e1ant_MonitorBtCtr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192e1ant_QueryBtInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
BOOLEAN halbtc8192e1ant_IsWifiStatusChanged(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192e1ant_UpdateBtLinkInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
u1Byte halbtc8192e1ant_ActionAlgorithm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BT_LINK_INFO	pBtLinkInfo = &pBtCoexist->btLinkInfo;
...
VOID halbtc8192e1ant_SetFwDacSwingLevel(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192e1ant_SetFwDecBtPwr(
	IN	PBTC_COEXIST		pBtCoexist,
...
)
{
	...
	if (!bForceExec) {
		BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE_FW_DETAIL,
			  ("[BTCoex], BtDecPwrLvl=%d, curBtDecPwrLvl=%d\n",
...
VOID halbtc8192e1ant_BtAutoReport(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bEnableAutoReport
)
...
VOID halbtc8192e1ant_FwDacSwingLvl(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
...
VOID halbtc8192e1ant_SetSwPenaltyTxRateAdaptive(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192e1ant_LowPenaltyRa(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bLowPenaltyRa
)
{
	...
	halbtc8192e1ant_SetSwPenaltyTxRateAdaptive(pBtCoexist,
...
VOID halbtc8192e1ant_SetSwFullTimeDacSwing(
	IN	PBTC_COEXIST		pBtCoexist,
...
)
{
	...
	delay_ms(30);
	halbtc8192e1ant_SetSwFullTimeDacSwing(pBtCoexist, bDacSwingOn,
					      dacSwingLvl);
...
VOID halbtc8192e1ant_SetCoexTable(
	IN	PBTC_COEXIST	pBtCoexist,
	IN	u4Byte		val0x6c0,
	IN	u4Byte		val0x6c4,
	IN	u4Byte		val0x6c8,
...
VOID halbtc8192e1ant_CoexTable(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	u4Byte			val0x6c0,
	IN	u4Byte			val0x6c4,
...
)
{
	...
	halbtc8192e1ant_SetCoexTable(pBtCoexist, val0x6c0, val0x6c4, val0x6c8,
				     val0x6cc);
...
VOID halbtc8192e1ant_CoexTableWithType(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
{
	switch (type) {
	case 0:
		halbtc8192e1ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x55555555,
					  0xffffff, 0x3);
		break;
	case 1:
		halbtc8192e1ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x5a5a5a5a,
					  0xffffff, 0x3);
		break;
	case 2:
		halbtc8192e1ant_CoexTable(pBtCoexist, bForceExec, 0x5a5a5a5a, 0x5a5a5a5a,
					  0xffffff, 0x3);
		break;
	case 3:
		halbtc8192e1ant_CoexTable(pBtCoexist, bForceExec, 0xaaaaaaaa, 0xaaaaaaaa,
					  0xffffff, 0x3);
		break;
	case 4:
		halbtc8192e1ant_CoexTable(pBtCoexist, bForceExec, 0xffffffff, 0xffffffff,
					  0xffffff, 0x3);
		break;
	case 5:
		halbtc8192e1ant_CoexTable(pBtCoexist, bForceExec, 0x5fff5fff, 0x5fff5fff,
					  0xffffff, 0x3);
		break;
	case 6:
		halbtc8192e1ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5a5a5a5a,
					  0xffffff, 0x3);
		break;
	case 7:
		halbtc8192e1ant_CoexTable(pBtCoexist, bForceExec, 0xddffddff, 0xddffddff,
					  0xffffff, 0x3);
		break;
	case 8:
		halbtc8192e1ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5afa5afa,
					  0xffffff, 0x3);
		break;
	case 9:
		halbtc8192e1ant_CoexTable(pBtCoexist, bForceExec, 0x5f5f5f5f, 0x5f5f5f5f,
					  0xffffff, 0x3);
		break;
	default:
		break;
...
VOID halbtc8192e1ant_SetFwIgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bEnable
)
{
...
VOID halbtc8192e1ant_IgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bEnable
)
...
VOID halbtc8192e1ant_SetFwPstdma(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			byte1,
	IN	u1Byte			byte2,
	IN	u1Byte			byte3,
...
VOID halbtc8192e1ant_SetLpsRpwm(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			lpsVal,
	IN	u1Byte			rpwmVal
)
...
VOID halbtc8192e1ant_SetAntPath(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192e1ant_SetSwitchSsType(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				ssType
)
{
	...
	if (ssType == 1) {
		halbtc8192e1ant_UpdateRaMask(pBtCoexist, FORCE_EXEC, BTC_RATE_DISABLE,
		...
		halbtc8192e1ant_UpdateRaMask(pBtCoexist, FORCE_EXEC, BTC_RATE_ENABLE,
					     0xfff00000);	// enable 2ss
	...
	pBtCoexist->fBtcSet(pBtCoexist, BTC_SET_ACT_SEND_MIMO_PS,
			    &mimoPs);	// set rx 1ss or 2ss
}

VOID halbtc8192e1ant_SwitchSsType(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				newSsType
)
...
VOID halbtc8192e1ant_CoexAllOff(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
BOOLEAN halbtc8192e1ant_IsCommonAction(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192e1ant_TdmaDurationAdjustForAcl(
	IN	PBTC_COEXIST		pBtCoexist,
...
)
{
	...
	if (!pCoexDm->bAutoTdmaAdjust) {
		...
		if (pCoexDm->curPsTdma != 1 &&
			...
			halbtc8192e1ant_PsTdma(pBtCoexist, NORMAL_EXEC, TRUE,
					       pCoexDm->psTdmaDuAdjType);
		}
	}
}

u1Byte halbtc8192e1ant_PsTdmaTypeByWifiRssi(
	IN	s4Byte	wifiRssi,
...
VOID halbtc8192e1ant_PsTdmaCheckForPowerSaveState(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192e1ant_PowerSaveState(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				psType,
	IN	u1Byte				lpsVal,
	IN	u1Byte				rpwmVal
...
VOID halbtc8192e1ant_ActionWifiOnly(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	halbtc8192e1ant_CoexTableWithType(pBtCoexist, NORMAL_EXEC, 0);
...
VOID halbtc8192e1ant_MonitorBtEnableDisable(
	IN 	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192e1ant_ActionSco(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}

VOID halbtc8192e1ant_ActionHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}
...
VOID halbtc8192e1ant_ActionA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}

VOID halbtc8192e1ant_ActionA2dpPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}

VOID halbtc8192e1ant_ActionPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}
...
//PAN(HS) only
VOID halbtc8192e1ant_ActionPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}
...
//PAN(EDR)+A2DP
VOID halbtc8192e1ant_ActionPanEdrA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}

VOID halbtc8192e1ant_ActionPanEdrHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}
...
// HID+A2DP+PAN(EDR)
VOID halbtc8192e1ant_ActionHidA2dpPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}

VOID halbtc8192e1ant_ActionHidA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}
...
//
//=============================================
VOID halbtc8192e1ant_ActionBtInquiry(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BT_LINK_INFO	pBtLinkInfo = &pBtCoexist->btLinkInfo;
...
VOID halbtc8192e1ant_ActionBtScoHidOnlyBusy(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				wifiStatus
)
{
...
VOID halbtc8192e1ant_ActionWifiConnectedBtAclBusy(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				wifiStatus
)
{
...
VOID halbtc8192e1ant_ActionWifiNotConnected(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	// power save state
...
VOID halbtc8192e1ant_ActionWifiNotConnectedAssoAuthScan(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	halbtc8192e1ant_PowerSaveState(pBtCoexist, BTC_PS_WIFI_NATIVE, 0x0, 0x0);
...
VOID halbtc8192e1ant_ActionWifiConnectedScan(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	// power save state
...
VOID halbtc8192e1ant_ActionWifiConnectedSpecialPacket(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	// power save state
...
VOID halbtc8192e1ant_ActionWifiConnected(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192e1ant_RunSwCoexistMechanism(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192e1ant_RunCoexistMechanism(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BT_LINK_INFO	pBtLinkInfo = &pBtCoexist->btLinkInfo;
...
VOID halbtc8192e1ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
//============================================================
VOID EXhalbtc8192e1ant_PowerOnSetting(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}

VOID EXhalbtc8192e1ant_InitHwConfig(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID EXhalbtc8192e1ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
...
VOID EXhalbtc8192e1ant_DisplayCoexInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID EXhalbtc8192e1ant_IpsNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8192e1ant_ScanNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8192e1ant_ConnectNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8192e1ant_MediaStatusNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				type
)
{
...
VOID EXhalbtc8192e1ant_BtInfoNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	pu1Byte			tmpBuf,
	IN	u1Byte			length
)
{
	...
	if (pBtLinkInfo->bScoExist || pBtLinkInfo->bHidExist) {
		halbtc8192e1ant_UpdateRaMask(pBtCoexist, NORMAL_EXEC, BTC_RATE_DISABLE,
					     0x00000003);	// disable tx cck 1M/2M
	} else {
		halbtc8192e1ant_UpdateRaMask(pBtCoexist, NORMAL_EXEC, BTC_RATE_ENABLE,
					     0x00000003);	// enable tx cck 1M/2M
	}
...
VOID EXhalbtc8192e1ant_HaltNotify(
	IN	PBTC_COEXIST			pBtCoexist
)
{
...
VOID EXhalbtc8192e1ant_PnpNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				pnpState
)
{
	...
	if (disVerInfoCnt <= 5) {
		...
		BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
			  ("[BTCoex], CoexVer/ FwVer/ PatchVer = %d_%x/ 0x%x/ 0x%x(%d)\n", \
			   GLCoexVerDate8192e1Ant, GLCoexVer8192e1Ant, fwVer, btPatchVer,
			   btPatchVer));
		BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
			  ("[BTCoex], ****************************************************************\n"));
	}
...
VOID EXhalbtc8192e1ant_DbgControl(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				opCode,
	IN	u1Byte				opLen,
	IN	pu1Byte				pData
