...
//============================================================
u1Byte halbtc8812a2ant_BtRssiState(
	u1Byte			levelNum,
	u1Byte			rssiThresh,
	u1Byte			rssiThresh1
)
...
u1Byte halbtc8812a2ant_WifiRssiState(
...
VOID halbtc8812a2ant_MonitorBtEnableDisable(
	IN 	PBTC_COEXIST		pBtCoexist
)
{
...
u4Byte halbtc8812a2ant_DecideRaMask(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8812a2ant_UpdateRaMask(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8812a2ant_AutoRateFallbackRetry(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
...
VOID halbtc8812a2ant_RetryLimit(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
...
VOID halbtc8812a2ant_AmpduMaxTime(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
...
VOID halbtc8812a2ant_LimitedTx(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
...
VOID halbtc8812a2ant_LimitedRx(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
...
VOID halbtc8812a2ant_MonitorBtCtr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8812a2ant_QueryBtInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte	dataLen = 3;
	...
	if (!pBtCoexist->btInfo.bBtDisabled) {
		if (!pCoexSta->btInfoQueryCnt ||
		    (pCoexSta->btInfoC2hCnt[BT_INFO_SRC_8812A_2ANT_BT_RSP] -
		     pCoexSta->btInfoQueryCnt) > 2) {
			buf[0] = dataLen;
...
BOOLEAN halbtc8812a2ant_IsWifiStatusChanged(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8812a2ant_UpdateBtLinkInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	//PBTC_STACK_INFO 	pStackInfo=&pBtCoexist->stackInfo;
...
u1Byte halbtc8812a2ant_ActionAlgorithm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BT_LINK_INFO	pBtLinkInfo = &pBtCoexist->btLinkInfo;
...
VOID halbtc8812a2ant_SetFwDacSwingLevel(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8812a2ant_SetFwDecBtPwr(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8812a2ant_FwDacSwingLvl(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
...
VOID halbtc8812a2ant_SetSwRfRxLpfCorner(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8812a2ant_SetSwPenaltyTxRateAdaptive(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8812a2ant_LowPenaltyRa(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bLowPenaltyRa
)
{
	...
	halbtc8812a2ant_SetSwPenaltyTxRateAdaptive(pBtCoexist,
			pCoexDm->bCurLowPenaltyRa);

	pCoexDm->bPreLowPenaltyRa = pCoexDm->bCurLowPenaltyRa;
}

VOID halbtc8812a2ant_SetDacSwingReg(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u4Byte			level
)
{
...
VOID halbtc8812a2ant_SetSwFullTimeDacSwing(
	IN	PBTC_COEXIST		pBtCoexist,
...
)
{
	...
	delay_ms(30);
	halbtc8812a2ant_SetSwFullTimeDacSwing(pBtCoexist, bDacSwingOn,
					      dacSwingLvl);
...
VOID halbtc8812a2ant_SetAdcBackOff(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8812a2ant_AdcBackOff(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bAdcBackOff
)
...
VOID halbtc8812a2ant_SetAgcTable(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8812a2ant_SetCoexTable(
	IN	PBTC_COEXIST	pBtCoexist,
	IN	u4Byte		val0x6c0,
	IN	u4Byte		val0x6c4,
	IN	u4Byte		val0x6c8,
...
VOID halbtc8812a2ant_CoexTable(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	u4Byte			val0x6c0,
	IN	u4Byte			val0x6c4,
...
)
{
	...
	if (!bForceExec) {
		BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE_SW_DETAIL,
			  ("[BTCoex], preVal0x6c0=0x%x, preVal0x6c4=0x%x, preVal0x6c8=0x%x, preVal0x6cc=0x%x !!\n",
			   pCoexDm->preVal0x6c0, pCoexDm->preVal0x6c4, pCoexDm->preVal0x6c8,
			   pCoexDm->preVal0x6cc));
		BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE_SW_DETAIL,
			  ("[BTCoex], curVal0x6c0=0x%x, curVal0x6c4=0x%x, curVal0x6c8=0x%x, curVal0x6cc=0x%x !!\n",
			   pCoexDm->curVal0x6c0, pCoexDm->curVal0x6c4, pCoexDm->curVal0x6c8,
			   pCoexDm->curVal0x6cc));
	...
	halbtc8812a2ant_SetCoexTable(pBtCoexist, val0x6c0, val0x6c4, val0x6c8,
				     val0x6cc);
...
VOID halbtc8812a2ant_CoexTableWithType(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
{
	switch (type) {
	case 0:
		halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x5a5a5a5a,
					  0xffffff, 0x3);
		break;
	case 1:
		halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0x5a5a5a5a, 0x5a5a5a5a,
					  0xffffff, 0x3);
		break;
	case 2:
		halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x5ffb5ffb,
					  0xffffff, 0x3);
		break;
	case 3:
		halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0x5fdf5fdf, 0x5fdb5fdb,
					  0xffffff, 0x3);
		break;
	case 4:
		halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0xdfffdfff, 0x5fdb5fdb,
					  0xffffff, 0x3);
		break;
	case 5:
		halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0x5ddd5ddd, 0x5fdb5fdb,
					  0xffffff, 0x3);
		break;
...
VOID halbtc8812a2ant_SetFwIgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bEnable
)
{
...
VOID halbtc8812a2ant_IgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bEnable
)
...
VOID halbtc8812a2ant_SetFwPstdma(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			byte1,
	IN	u1Byte			byte2,
	IN	u1Byte			byte3,
...
)
{
	...
	BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE_FW_EXEC,
		  ("[BTCoex], FW write 0x60(6 bytes)=0x%x%08x\n",
		   H2C_Parameter[0],
...
VOID halbtc8812a2ant_SetLpsRpwm(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			lpsVal,
	IN	u1Byte			rpwmVal
)
...
)
{
	...
	if (!bForceExec) {
		BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE_FW_DETAIL,
			  ("[BTCoex], preLps/curLps=0x%x/0x%x, preRpwm/curRpwm=0x%x/0x%x!!\n",
...
VOID halbtc8812a2ant_SwMechanism1(
	IN	PBTC_COEXIST	pBtCoexist,
...
VOID halbtc8812a2ant_SwMechanism2(
	IN	PBTC_COEXIST	pBtCoexist,
...
)
{
	...
	halbtc8812a2ant_DacSwing(pBtCoexist, NORMAL_EXEC, bSWDACSwing,
				 dacSwingLvl);
}

VOID halbtc8812a2ant_SetAntPath(
	IN	PBTC_COEXIST		pBtCoexist,
...
)
{
	...
	if (bTurnOn) {
		...
		case 1: //ANT2BT, 0x778=3
			...
			delay_ms(5);
			halbtc8812a2ant_SetAntPath(pBtCoexist, BTC_ANT_WIFI_AT_CPL_AUX, FALSE,
						   FALSE);
			break;
		default:
...
VOID halbtc8812a2ant_CoexAllOff(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	// fw all off
...
VOID halbtc8812a2ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8812a2ant_PsTdmaCheckForPowerSaveState(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8812a2ant_PowerSaveState(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				psType,
...
VOID halbtc8812a2ant_ActionBtInquiry(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	halbtc8812a2ant_PowerSaveState(pBtCoexist, BTC_PS_WIFI_NATIVE, TRUE, 0x0,
				       0x0);
...
BOOLEAN halbtc8812a2ant_IsCommonAction(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	...
	if (!bWifiConnected) {
		halbtc8812a2ant_PowerSaveState(pBtCoexist, BTC_PS_WIFI_NATIVE, FALSE, 0x0,
					       0x0);
...
VOID halbtc8812a2ant_TdmaDurationAdjust(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bScoHid,
	IN	BOOLEAN			bTxPause,
...
)
{
	...
	if (pCoexDm->curPsTdma != pCoexDm->psTdmaDuAdjType) {
		...
		if (!bScan && !bLink && !bRoam) {
			halbtc8812a2ant_PsTdma(pBtCoexist, NORMAL_EXEC, TRUE,
...
//==================
VOID halbtc8812a2ant_TdmaDurationAdjustForWifiRssiLow(
	IN	PBTC_COEXIST		pBtCoexist//,
...
)
{
	...
	BTC_PRINT(BTC_MSG_ALGORITHM, ALGO_TRACE_FW,
		  ("[BTCoex], halbtc8812a2ant_TdmaDurationAdjustForWifiRssiLow()\n"));
#if 0
...
VOID halbtc8812a2ant_GetBtRssiThreshold(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	pu1Byte				pThres0,
	IN	pu1Byte				pThres1
)
...
VOID halbtc8812a2ant_ActionSco(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState = BTC_RSSI_STATE_HIGH,
...
VOID halbtc8812a2ant_ActionScoHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState = BTC_RSSI_STATE_HIGH,
...
VOID halbtc8812a2ant_ActionHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState = BTC_RSSI_STATE_HIGH,
...
VOID halbtc8812a2ant_ActionA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState = BTC_RSSI_STATE_HIGH,
	...
	// power save state
	if ((bApEnable == TRUE) || (BTC_RSSI_HIGH(wifiRssiState)
				    && (!BTC_RSSI_LOW(btRssiState))))
		halbtc8812a2ant_PowerSaveState(pBtCoexist, BTC_PS_WIFI_NATIVE, TRUE, 0x0,
					       0x0);
	else
...
VOID halbtc8812a2ant_ActionA2dpPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState = BTC_RSSI_STATE_HIGH,
...
VOID halbtc8812a2ant_ActionPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState = BTC_RSSI_STATE_HIGH,
...
//PAN(HS) only
VOID halbtc8812a2ant_ActionPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState = BTC_RSSI_STATE_HIGH,
...
//PAN(EDR)+A2DP
VOID halbtc8812a2ant_ActionPanEdrA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState = BTC_RSSI_STATE_HIGH,
...
VOID halbtc8812a2ant_ActionPanEdrHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState = BTC_RSSI_STATE_HIGH,
...
// HID+A2DP+PAN(EDR)
VOID halbtc8812a2ant_ActionHidA2dpPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState = BTC_RSSI_STATE_HIGH,
...
VOID halbtc8812a2ant_ActionHidA2dpPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState = BTC_RSSI_STATE_HIGH,
...
VOID halbtc8812a2ant_ActionHidA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState = BTC_RSSI_STATE_HIGH,
...
VOID halbtc8812a2ant_CoexUnder5G(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
//====================================================
VOID halbtc8812a2ant_RunCoexistMechanism(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8812a2ant_InitHwConfig(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bBackUp
)
{
	...
	halbtc8812a2ant_SetAntPath(pBtCoexist, BTC_ANT_WIFI_AT_CPL_AUX, TRUE,
				   FALSE);
...
//============================================================
VOID EXhalbtc8812a2ant_PowerOnSetting(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}

VOID EXhalbtc8812a2ant_InitHwConfig(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID EXhalbtc8812a2ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
...
VOID EXhalbtc8812a2ant_DisplayCoexInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	...
	CL_SPRINTF(cliBuf, BT_TMP_BUF_SIZE, "\r\n %-35s = [%s/ %d/ %d] ",
		   ...
		   ((pBtCoexist->btInfo.bBtDisabled) ? ("disabled") :	((
					   pCoexSta->bC2hBtInquiryPage) ? ("inquiry/page scan") : ((
							   BT_8812A_2ANT_BT_STATUS_NON_CONNECTED_IDLE == pCoexDm->btStatus) ?
							   "non-connected idle" :
							   ((BT_8812A_2ANT_BT_STATUS_CONNECTED_IDLE == pCoexDm->btStatus) ?
									   "connected-idle" : "busy")))),
	...
	CL_SPRINTF(cliBuf, BT_TMP_BUF_SIZE,
		   "\r\n %-35s = %02x %02x %02x %02x %02x %02x case-%d (auto:%d/%d)",
		   "PS TDMA", \
		   pCoexDm->psTdmaPara[0], pCoexDm->psTdmaPara[1],
		   pCoexDm->psTdmaPara[2], pCoexDm->psTdmaPara[3],
		   pCoexDm->psTdmaPara[4], pCoexDm->psTdmaPara[5], psTdmaCase,
		   pCoexDm->bAutoTdmaAdjust, pCoexDm->bAutoTdmaAdjustLowRssi);
	CL_PRINTF(cliBuf);
...
VOID EXhalbtc8812a2ant_IpsNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8812a2ant_LpsNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8812a2ant_ConnectNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8812a2ant_MediaStatusNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				type
)
{
...
VOID EXhalbtc8812a2ant_SpecialPacketNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				type
)
{
...
VOID EXhalbtc8812a2ant_HaltNotify(
	IN	PBTC_COEXIST			pBtCoexist
)
{
	//u1Byte u1Tmp=0;
...
VOID EXhalbtc8812a2ant_Periodical(
	IN	PBTC_COEXIST			pBtCoexist
)
{
	...
	if (disVerInfoCnt <= 5) {
		...
		BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
			  ("[BTCoex], CoexVer/ FwVer/ PatchVer = %d_%x/ 0x%x/ 0x%x(%d)\n", \
			   GLCoexVerDate8812a2Ant, GLCoexVer8812a2Ant, fwVer, btPatchVer,
			   btPatchVer));
		BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
			  ("[BTCoex], ****************************************************************\n"));
	}
...
VOID EXhalbtc8812a2ant_DbgControl(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				opCode,
	IN	u1Byte				opLen,
	IN	pu1Byte				pData
