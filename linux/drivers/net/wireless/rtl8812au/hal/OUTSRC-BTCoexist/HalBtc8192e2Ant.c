...
//============================================================
u1Byte halbtc8192e2ant_BtRssiState(
	u1Byte			levelNum,
	u1Byte			rssiThresh,
	u1Byte			rssiThresh1
)
...
u1Byte halbtc8192e2ant_WifiRssiState(
...
VOID halbtc8192e2ant_MonitorBtEnableDisable(
	IN 	PBTC_COEXIST		pBtCoexist
)
{
...
u4Byte halbtc8192e2ant_DecideRaMask(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				ssType,
...
VOID halbtc8192e2ant_UpdateRaMask(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192e2ant_AutoRateFallbackRetry(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
...
VOID halbtc8192e2ant_AmpduMaxTime(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
...
VOID halbtc8192e2ant_LimitedTx(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
...
VOID halbtc8192e2ant_LimitedRx(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
...
VOID halbtc8192e2ant_MonitorBtCtr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192e2ant_QueryBtInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
BOOLEAN halbtc8192e2ant_IsWifiStatusChanged(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192e2ant_UpdateBtLinkInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
u1Byte halbtc8192e2ant_ActionAlgorithm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BT_LINK_INFO	pBtLinkInfo = &pBtCoexist->btLinkInfo;
...
VOID halbtc8192e2ant_SetFwDacSwingLevel(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192e2ant_SetFwDecBtPwr(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192e2ant_SetBtAutoReport(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192e2ant_BtAutoReport(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bEnableAutoReport
)
...
VOID halbtc8192e2ant_FwDacSwingLvl(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
...
VOID halbtc8192e2ant_SetSwRfRxLpfCorner(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192e2ant_SetSwPenaltyTxRateAdaptive(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192e2ant_LowPenaltyRa(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bLowPenaltyRa
)
{
	...
	halbtc8192e2ant_SetSwPenaltyTxRateAdaptive(pBtCoexist,
			pCoexDm->bCurLowPenaltyRa);

	pCoexDm->bPreLowPenaltyRa = pCoexDm->bCurLowPenaltyRa;
}

VOID halbtc8192e2ant_SetDacSwingReg(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u4Byte			level
)
{
...
VOID halbtc8192e2ant_SetSwFullTimeDacSwing(
	IN	PBTC_COEXIST		pBtCoexist,
...
)
{
	...
	delay_ms(30);
	halbtc8192e2ant_SetSwFullTimeDacSwing(pBtCoexist, bDacSwingOn,
					      dacSwingLvl);
...
VOID halbtc8192e2ant_SetAdcBackOff(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192e2ant_AdcBackOff(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bAdcBackOff
)
...
VOID halbtc8192e2ant_SetAgcTable(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192e2ant_SetCoexTable(
	IN	PBTC_COEXIST	pBtCoexist,
	IN	u4Byte		val0x6c0,
	IN	u4Byte		val0x6c4,
	IN	u4Byte		val0x6c8,
...
VOID halbtc8192e2ant_CoexTable(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	u4Byte			val0x6c0,
	IN	u4Byte			val0x6c4,
...
)
{
	...
	halbtc8192e2ant_SetCoexTable(pBtCoexist, val0x6c0, val0x6c4, val0x6c8,
				     val0x6cc);
...
VOID halbtc8192e2ant_CoexTableWithType(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				type
)
{
	switch (type) {
	case 0:
		halbtc8192e2ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x5a5a5a5a,
					  0xffffff, 0x3);
		break;
	case 1:
		halbtc8192e2ant_CoexTable(pBtCoexist, bForceExec, 0x5a5a5a5a, 0x5a5a5a5a,
					  0xffffff, 0x3);
		break;
	case 2:
		halbtc8192e2ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x5ffb5ffb,
					  0xffffff, 0x3);
		break;
	case 3:
		halbtc8192e2ant_CoexTable(pBtCoexist, bForceExec, 0x5fdf5fdf, 0x5fdb5fdb,
					  0xffffff, 0x3);
		break;
	case 4:
		halbtc8192e2ant_CoexTable(pBtCoexist, bForceExec, 0xdfffdfff, 0x5ffb5ffb,
					  0xffffff, 0x3);
		break;
...
VOID halbtc8192e2ant_SetFwIgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bEnable
)
{
...
VOID halbtc8192e2ant_IgnoreWlanAct(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bForceExec,
	IN	BOOLEAN			bEnable
)
...
VOID halbtc8192e2ant_SetFwPstdma(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			byte1,
	IN	u1Byte			byte2,
	IN	u1Byte			byte3,
...
VOID halbtc8192e2ant_SwMechanism1(
	IN	PBTC_COEXIST	pBtCoexist,
...
VOID halbtc8192e2ant_SwMechanism2(
	IN	PBTC_COEXIST	pBtCoexist,
...
)
{
	...
	halbtc8192e2ant_DacSwing(pBtCoexist, NORMAL_EXEC, bSWDACSwing,
				 dacSwingLvl);
}

VOID halbtc8192e2ant_SetAntPath(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID halbtc8192e2ant_SetSwitchSsType(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				ssType
)
{
	...
	disRaMask = halbtc8192e2ant_DecideRaMask(pBtCoexist, ssType,
			pCoexDm->curRaMaskType);
...
VOID halbtc8192e2ant_SwitchSsType(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bForceExec,
	IN	u1Byte				newSsType
)
...
VOID halbtc8192e2ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192e2ant_ActionBtInquiry(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
BOOLEAN halbtc8192e2ant_IsCommonAction(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	PBTC_BT_LINK_INFO	pBtLinkInfo = &pBtCoexist->btLinkInfo;
...
VOID halbtc8192e2ant_TdmaDurationAdjust(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN			bScoHid,
	IN	BOOLEAN			bTxPause,
...
)
{
	...
	if (pCoexDm->curPsTdma != pCoexDm->psTdmaDuAdjType) {
		...
		if (!bScan && !bLink && !bRoam) {
			halbtc8192e2ant_PsTdma(pBtCoexist, NORMAL_EXEC, TRUE,
...
VOID halbtc8192e2ant_ActionSco(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192e2ant_ActionScoPan(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte	wifiRssiState, btRssiState = BTC_RSSI_STATE_STAY_LOW;
...
VOID halbtc8192e2ant_ActionHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192e2ant_ActionA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, btRssiState = BTC_RSSI_STATE_HIGH;
...
VOID halbtc8192e2ant_ActionA2dpPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, btRssiState = BTC_RSSI_STATE_HIGH;
...
VOID halbtc8192e2ant_ActionPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, btRssiState = BTC_RSSI_STATE_HIGH;
...
//PAN(HS) only
VOID halbtc8192e2ant_ActionPanHs(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, btRssiState = BTC_RSSI_STATE_HIGH;
...
//PAN(EDR)+A2DP
VOID halbtc8192e2ant_ActionPanEdrA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, btRssiState = BTC_RSSI_STATE_HIGH;
...
VOID halbtc8192e2ant_ActionPanEdrHid(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, btRssiState = BTC_RSSI_STATE_HIGH;
...
// HID+A2DP+PAN(EDR)
VOID halbtc8192e2ant_ActionHidA2dpPanEdr(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, btRssiState = BTC_RSSI_STATE_HIGH;
...
VOID halbtc8192e2ant_ActionHidA2dp(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	u1Byte		wifiRssiState, btRssiState = BTC_RSSI_STATE_HIGH;
...
VOID halbtc8192e2ant_RunCoexistMechanism(
	IN	PBTC_COEXIST		pBtCoexist
)
{
...
VOID halbtc8192e2ant_InitHwConfig(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	BOOLEAN				bBackUp
)
{
...
//============================================================
VOID EXhalbtc8192e2ant_PowerOnSetting(
	IN	PBTC_COEXIST		pBtCoexist
)
{
}

VOID EXhalbtc8192e2ant_InitHwConfig(
	IN	PBTC_COEXIST		pBtCoexist,
...
VOID EXhalbtc8192e2ant_InitCoexDm(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
...
VOID EXhalbtc8192e2ant_DisplayCoexInfo(
	IN	PBTC_COEXIST		pBtCoexist
)
{
	...
	CL_SPRINTF(cliBuf, BT_TMP_BUF_SIZE, "\r\n %-35s = [%s/ %d/ %d] ",
		   ...
		   ((pBtCoexist->btInfo.bBtDisabled) ? ("disabled") :	((
					   pCoexSta->bC2hBtInquiryPage) ? ("inquiry/page scan") : ((
							   BT_8192E_2ANT_BT_STATUS_NON_CONNECTED_IDLE == pCoexDm->btStatus) ?
							   "non-connected idle" :
							   ((BT_8192E_2ANT_BT_STATUS_CONNECTED_IDLE == pCoexDm->btStatus) ?
									   "connected-idle" : "busy")))),
	...
	CL_SPRINTF(cliBuf, BT_TMP_BUF_SIZE, "\r\n %-35s = %d / %d / %d / %d",
		   "SCO/HID/PAN/A2DP", \
		   pStackInfo->bScoExist, pStackInfo->bHidExist, pStackInfo->bPanExist,
...
VOID EXhalbtc8192e2ant_IpsNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8192e2ant_ScanNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8192e2ant_ConnectNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte			type
)
{
...
VOID EXhalbtc8192e2ant_SpecialPacketNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				type
)
{
...
VOID EXhalbtc8192e2ant_BtInfoNotify(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	pu1Byte			tmpBuf,
	IN	u1Byte			length
)
...
VOID EXhalbtc8192e2ant_HaltNotify(
	IN	PBTC_COEXIST			pBtCoexist
)
{
...
VOID EXhalbtc8192e2ant_Periodical(
	IN	PBTC_COEXIST			pBtCoexist
)
{
	...
	if (disVerInfoCnt <= 5) {
		...
		BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
			  ("[BTCoex], CoexVer/ FwVer/ PatchVer = %d_%x/ 0x%x/ 0x%x(%d)\n", \
			   GLCoexVerDate8192e2Ant, GLCoexVer8192e2Ant, fwVer, btPatchVer,
			   btPatchVer));
		BTC_PRINT(BTC_MSG_INTERFACE, INTF_INIT,
			  ("[BTCoex], ****************************************************************\n"));
	}
