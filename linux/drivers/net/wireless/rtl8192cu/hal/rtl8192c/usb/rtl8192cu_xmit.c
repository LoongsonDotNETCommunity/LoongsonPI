...
void fill_txdesc_sectype(struct pkt_attrib *pattrib,
...
s32 rtl8192cu_xmitframe_complete(_adapter *padapter,
...
s32	 rtl8192cu_hal_xmitframe_enqueue(_adapter *padapter,
		struct xmit_frame *pxmitframe)
{
	struct xmit_priv 	*pxmitpriv = &padapter->xmitpriv;
	s32 err;
