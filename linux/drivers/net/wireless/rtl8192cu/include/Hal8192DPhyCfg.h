...
//
VOID PHY_ScanOperationBackup8192D(IN	PADAPTER	Adapter,
				  IN	u8		Operation);
...
//
void rtl8192d_PHY_SetBeaconHwReg(IN	PADAPTER		Adapter,
				 IN	u16			BeaconInterval);


extern	VOID PHY_SwitchEphyParameter(
	IN	PADAPTER			Adapter
);

extern	VOID PHY_EnableHostClkReq(
	IN	PADAPTER			Adapter
);

BOOLEAN SetAntennaConfig92C(
	IN	PADAPTER	Adapter,
	IN	u8		DefaultAnt
);

VOID PHY_StopTRXBeforeChangeBand8192D(
	PADAPTER		Adapter
);

VOID PHY_UpdateBBRFConfiguration8192D(
	IN PADAPTER Adapter,
...
VOID rtl8192d_PHY_InitRxSetting(
	IN	PADAPTER Adapter
);

VOID rtl8192d_PHY_ResetIQKResult(
	IN	PADAPTER Adapter
);


VOID rtl8192d_PHY_SetRFPathSwitch(IN	PADAPTER	pAdapter, IN	BOOLEAN		bMain);

VOID HalChangeCCKStatus8192D(
	IN	PADAPTER	Adapter,
