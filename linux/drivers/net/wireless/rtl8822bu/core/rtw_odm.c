...
#define DBG_RX_PHYSTATUS_CHINFO 0
	...
	if (phydm->support_ic_type & PHYSTS_2ND_TYPE_IC) {
		...
		*/
		...
		if ((*phys & 0xf) == 0) {
			struct phy_status_rpt_jaguar2_type0 *phys_t0 = (struct
					phy_status_rpt_jaguar2_type0 *)phys;
			...
			struct phy_status_rpt_jaguar2_type1 *phys_t1 = (struct
					phy_status_rpt_jaguar2_type1 *)phys;
...
type1_end:
			...
			struct phy_status_rpt_jaguar2_type2 *phys_t2 = (struct
					phy_status_rpt_jaguar2_type2 *)phys;
