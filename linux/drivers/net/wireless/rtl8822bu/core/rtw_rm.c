...
static u8 *build_wlan_hdr(_adapter *padapter,
...
static int rm_parse_ch_load_s_elem(struct rm_obj *prm, u8 *pbody,
				   int req_len)
{
	u8 *popt_id;
	int i, p = 0; /* position */
...
static int rm_parse_bcn_req_s_elem(struct rm_obj *prm, u8 *pbody,
				   int req_len)
{
	u8 *popt_id;
	int i, p = 0; /* position */
...
unsigned int rm_on_action(_adapter *padapter,
