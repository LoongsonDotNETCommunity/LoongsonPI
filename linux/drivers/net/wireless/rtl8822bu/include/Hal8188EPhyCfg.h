...
/* RF config */
int	rtl8188e_PHY_ConfigRFWithParaFile(IN PADAPTER Adapter,
		IN u8 *pFileName, enum rf_path eRFPath);
...
VOID PHY_SetRFEReg_8188E(
	IN PADAPTER		Adapter
);
/*
 * BB/MAC/RF other monitor API
 *   */
VOID phy_set_rf_path_switch_8188e(IN	struct dm_struct	*phydm,
				  IN	bool		bMain);
