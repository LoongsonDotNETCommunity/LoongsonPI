...
void fill_txdesc_force_bmc_camid(struct pkt_attrib *pattrib,
...
s32	rtl8188es_hal_xmitframe_enqueue(_adapter *padapter,
...
s32	rtl8188eu_hal_xmitframe_enqueue(_adapter *padapter,
					struct xmit_frame *pxmitframe);
s32 rtl8188eu_xmit_buf_handler(PADAPTER padapter);
void rtl8188eu_xmit_tasklet(void *priv);
s32 rtl8188eu_xmitframe_complete(_adapter *padapter,
...
s32	rtl8188ee_hal_xmitframe_enqueue(_adapter *padapter,
					struct xmit_frame *pxmitframe);
...
void UpdateEarlyModeInfo8188E(struct xmit_priv *pxmitpriv,
