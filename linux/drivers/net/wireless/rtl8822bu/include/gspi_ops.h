...
extern unsigned int spi_write8_endian(ADAPTER *Adapter, unsigned int addr,
				      unsigned int buf, u32 big);
...
extern void UpdateInterruptMask8188EGspi(PADAPTER padapter, u32 AddMSR,
		u32 RemoveMSR);
