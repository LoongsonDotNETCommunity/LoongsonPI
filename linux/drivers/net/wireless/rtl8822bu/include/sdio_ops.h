...
#if 0
extern void sdio_func1cmd52_read(struct intf_hdl *pintfhdl, u32 addr,
				 u32 cnt, u8 *rmem);
extern void sdio_func1cmd52_write(struct intf_hdl *pintfhdl, u32 addr,
				  u32 cnt, u8 *wmem);
#endif
...
extern s32 _sdio_local_read(PADAPTER padapter, u32 addr, u32 cnt,
			    u8 *pbuf);
extern s32 sdio_local_read(PADAPTER padapter, u32 addr, u32 cnt, u8 *pbuf);
extern s32 _sdio_local_write(PADAPTER padapter, u32 addr, u32 cnt,
			     u8 *pbuf);
extern s32 sdio_local_write(PADAPTER padapter, u32 addr, u32 cnt,
			    u8 *pbuf);
...
extern void UpdateInterruptMask8188ESdio(PADAPTER padapter, u32 AddMSR,
		u32 RemoveMSR);
...
extern void UpdateInterruptMask8192ESdio(PADAPTER padapter, u32 AddMSR,
		u32 RemoveMSR);
 ...
 */
static inline size_t rtw_sdio_cmd53_align_size(struct dvobj_priv *d,
		size_t len)
{
	u32 blk_sz;
