...
s32	rtl8192eu_hal_xmitframe_enqueue(_adapter *padapter,
...
s32 rtl8192eu_xmitframe_complete(_adapter *padapter,
...
s32	rtl8192ee_hal_xmitframe_enqueue(_adapter *padapter,
					struct xmit_frame *pxmitframe);
...
s32	rtl8192es_hal_xmitframe_enqueue(_adapter *padapter,
					struct xmit_frame *pxmitframe);
...
void UpdateEarlyModeInfo8192E(struct xmit_priv *pxmitpriv,
...
void fill_txdesc_phy(PADAPTER padapter, struct pkt_attrib *pattrib,
		     u8 *ptxdesc);
