...
__inline static int _enter_critical_mutex_lock(_mutex *pmutex,
		_irqL *pirqL)
{
	int ret = 0;
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 37))
...
static inline void _init_workitem(_workitem *pwork, void *pfunc,
				  void *cntx)
{
...
static inline int rtw_merge_string(char *dst, int dst_len,
