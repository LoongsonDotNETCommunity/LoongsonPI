...
void rtl8822bu_update_interrupt_mask(PADAPTER padapter, u8 bHIMR0,
				     u32 AddMSR, u32 RemoveMSR)
{
...
static u8 usb_set_queue_pipe_mapping(PADAPTER padapter, u8 NumInPipe,
				     u8 NumOutPipe)
{
	HAL_DATA_TYPE *pHalData = GET_HAL_DATA(padapter);
	u8 result = _FALSE;
