...
{
	struct wifi_only_cfg *pwifionlycfg = (struct wifi_only_cfg *)
					     pwifionlyContext;
...
void halwifionly_bitmaskwrite1byte(PVOID pwifionlyContext, u32 regAddr,
				   u8 bitMask, u8 data)
{
...
void halwifionly_phy_set_rf_reg(PVOID pwifionlyContext,
				enum rf_path eRFPath, u32 RegAddr, u32 BitMask, u32 Data)
{
	struct wifi_only_cfg *pwifionlycfg = (struct wifi_only_cfg *)
					     pwifionlyContext;
	PADAPTER		Adapter = pwifionlycfg->Adapter;
...
void halwifionly_phy_set_bb_reg(PVOID pwifionlyContext, u32 RegAddr,
