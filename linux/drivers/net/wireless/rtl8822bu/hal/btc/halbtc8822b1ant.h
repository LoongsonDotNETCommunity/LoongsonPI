...
void ex_halbtc8822b1ant_pre_load_firmware(IN struct btc_coexist
		*btcoexist);
...
void ex_halbtc8822b1ant_pnp_notify(IN struct btc_coexist *btcoexist,
				   IN u8 pnp_state);
void ex_halbtc8822b1ant_ScoreBoardStatusNotify(IN struct btc_coexist
		*btcoexist,
		IN u8 *tmp_buf, IN u8 length);
...
void ex_halbtc8822b1ant_display_coex_info(IN struct btc_coexist
		*btcoexist);
