...
void odm_config_rf_radio_b_8822b(
	struct dm_struct				*dm,
	u32					addr,
	u32					data
)
...
void odm_update_agc_big_jump_lmt_8822b(
	struct dm_struct				*dm,
	u32					addr,
	u32					data
)
...
void odm_config_bb_phy_reg_pg_8822b(
	struct dm_struct				*dm,
	u32					band,
	u32					rf_path,
	u32					tx_num,
...
)
{
	if (addr == 0xfe || addr == 0xffe) {
		...
		phy_store_tx_power_by_rate(dm->adapter, band, rf_path, tx_num, addr,
					   bitmask, data);
#elif (DM_ODM_SUPPORT_TYPE & ODM_WIN)
		PHY_StoreTxPowerByRate((PADAPTER)dm->adapter, band, rf_path, tx_num, addr,
				       bitmask, data);
#endif
