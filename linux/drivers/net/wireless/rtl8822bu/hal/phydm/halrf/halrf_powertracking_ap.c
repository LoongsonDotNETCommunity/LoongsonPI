...
)
{
...
#if (RTL8197F_SUPPORT == 1)
	if (GET_CHIP_VER(priv) == VERSION_8197F) {
		cali_info->default_ofdm_index = (default_swing_index >=
	...
	PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,
		  "cali_info->default_ofdm_index=%d cali_info->default_cck_index=%d\n",
...
)
{
	...
	if (dm->support_ic_type & (ODM_RTL8188E | ODM_RTL8192E | ODM_RTL8812 |
