 ...
 */
enum halmac_ret_status init_pcie_cfg_88xx(struct halmac_adapter *adapter)
{
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status deinit_pcie_cfg_88xx(struct halmac_adapter
		*adapter)
{
	if (adapter->intf != HALMAC_INTERFACE_PCIE)
		return HALMAC_RET_WRONG_INTF;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_pcie_rx_agg_88xx(struct halmac_adapter *adapter,
 ...
 * More details of status code can be found in prototype document
 */
u8 reg_r8_pcie_88xx(struct halmac_adapter *adapter, u32 offset)
{
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status reg_w8_pcie_88xx(struct halmac_adapter *adapter,
					u32 offset, u8 value)
{
 ...
 * More details of status code can be found in prototype document
 */
u16 reg_r16_pcie_88xx(struct halmac_adapter *adapter, u32 offset)
{
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status reg_w16_pcie_88xx(struct halmac_adapter *adapter,
 ...
 * More details of status code can be found in prototype document
 */
u32 reg_r32_pcie_88xx(struct halmac_adapter *adapter, u32 offset)
{
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status reg_w32_pcie_88xx(struct halmac_adapter *adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_txagg_pcie_align_88xx(struct halmac_adapter
		*adapter, u8 enable,
		u16 align_size)
{
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status tx_allowed_pcie_88xx(struct halmac_adapter *adapter,
		u8 *buf, u32 size)
{
	return HALMAC_RET_NOT_SUPPORT;
}
 ...
 * More details of status code can be found in prototype document
 */
u32 pcie_indirect_reg_r32_88xx(struct halmac_adapter *adapter, u32 offset)
{
	return 0xFFFFFFFF;
}
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status pcie_reg_rn_88xx(struct halmac_adapter *adapter,
					u32 offset, u32 size,
					u8 *value)
{
	return HALMAC_RET_NOT_SUPPORT;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status set_pcie_bulkout_num_88xx(struct halmac_adapter
		*adapter, u8 num)
{
	return HALMAC_RET_NOT_SUPPORT;
}
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status get_pcie_tx_addr_88xx(struct halmac_adapter
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status get_pcie_bulkout_id_88xx(struct halmac_adapter
		*adapter, u8 *buf, u32 size,
		u8 *id)
{
	return HALMAC_RET_NOT_SUPPORT;
...
enum halmac_ret_status mdio_write_88xx(struct halmac_adapter *adapter,
				       u8 addr, u16 data, u8 speed)
{
	u8 tmp_u1b = 0;
	u32 cnt = 0;
...
u16 mdio_read_88xx(struct halmac_adapter *adapter, u8 addr, u8 speed)
{
	u16 ret = 0;
	u8 tmp_u1b = 0;
	u32 cnt = 0;
...
enum halmac_ret_status dbi_w32_88xx(struct halmac_adapter *adapter,
				    u16 addr, u32 data)
{
	u8 tmp_u1b = 0;
	u32 cnt = 0;
...
u32 dbi_r32_88xx(struct halmac_adapter *adapter, u16 addr)
{
...
enum halmac_ret_status dbi_w8_88xx(struct halmac_adapter *adapter,
				   u16 addr, u8 data)
{
	u8 tmp_u1b = 0;
	u32 cnt = 0;
...
u8 dbi_r8_88xx(struct halmac_adapter *adapter, u16 addr)
{
	u16 read_addr = addr & 0x0ffc;
	u8 tmp_u1b = 0;
	u32 cnt = 0;
...
enum halmac_ret_status trxdma_check_idle_88xx(struct halmac_adapter
		*adapter)
{
	u32 cnt = 0;
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
...
void en_ref_autok_88xx(struct halmac_adapter *adapter, u8 en)
{
	if (en == 1)
