 ...
 */
enum halmac_ret_status cfg_mac_addr_88xx(struct halmac_adapter *adapter,
		u8 port,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_bssid_88xx(struct halmac_adapter *adapter,
				      u8 port,
				      union halmac_wlan_addr *addr)
{
	u16 bssid_addr_h;
 ...
 * Return : enum halmac_ret_status
 */
enum halmac_ret_status cfg_transmitter_addr_88xx(struct halmac_adapter
		*adapter, u8 port,
		union halmac_wlan_addr *addr)
{
	u16 mac_addr_h;
 ...
 * Return : enum halmac_ret_status
 */
enum halmac_ret_status cfg_net_type_88xx(struct halmac_adapter *adapter,
		u8 port,
 ...
 * Return : enum halmac_ret_status
 */
enum halmac_ret_status cfg_tsf_rst_88xx(struct halmac_adapter *adapter,
					u8 port)
{
	u8 tsf_rst = 0;
	u8 value8;
 ...
 * Return : enum halmac_ret_status
 */
enum halmac_ret_status cfg_bcn_space_88xx(struct halmac_adapter *adapter,
		u8 port, u32 bcn_space)
{
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
 ...
 * Return : enum halmac_ret_status
 */
enum halmac_ret_status rw_bcn_ctrl_88xx(struct halmac_adapter *adapter,
					u8 port, u8 write_en,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_multicast_addr_88xx(struct halmac_adapter
		*adapter,
		union halmac_wlan_addr *addr)
{
	u16 addr_h;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_operation_mode_88xx(struct halmac_adapter
		*adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_ch_bw_88xx(struct halmac_adapter *adapter,
				      u8 ch,
...
enum halmac_ret_status cfg_ch_88xx(struct halmac_adapter *adapter, u8 ch)
{
	u8 value8;
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
...
enum halmac_ret_status cfg_pri_ch_idx_88xx(struct halmac_adapter *adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_bw_88xx(struct halmac_adapter *adapter,
				   enum halmac_bw bw)
{
	u32 value32;
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
...
void enable_bb_rf_88xx(struct halmac_adapter *adapter, u8 enable)
{
	u8 value8;
	u32 value32;
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_la_mode_88xx(struct halmac_adapter *adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_rxfifo_expand_mode_88xx(struct halmac_adapter
		*adapter,
...
enum halmac_ret_status config_security_88xx(struct halmac_adapter *adapter,
...
u8 get_used_cam_entry_num_88xx(struct halmac_adapter *adapter,
...
enum halmac_ret_status write_cam_88xx(struct halmac_adapter *adapter,
				      u32 idx,
...
enum halmac_ret_status read_cam_entry_88xx(struct halmac_adapter *adapter,
		u32 idx,
...
enum halmac_ret_status clear_cam_entry_88xx(struct halmac_adapter *adapter,
		u32 idx)
{
	u32 i;
	u32 cmd = 0x80010000;
...
void rx_shift_88xx(struct halmac_adapter *adapter, u8 enable)
{
	u8 value8;
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_edca_para_88xx(struct halmac_adapter *adapter,
...
void rx_clk_gate_88xx(struct halmac_adapter *adapter, u8 enable)
{
	u8 value8;
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
...
enum halmac_ret_status rx_cut_amsdu_cfg_88xx(struct halmac_adapter
		*adapter,
...
enum halmac_ret_status fast_edca_cfg_88xx(struct halmac_adapter *adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status get_mac_addr_88xx(struct halmac_adapter *adapter,
		u8 port,
		union halmac_wlan_addr *addr)
{
	u16 mac_addr_h;
