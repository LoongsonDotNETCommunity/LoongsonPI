...
static enum halmac_ret_status get_pinmux_list_8822b(struct halmac_adapter
		*adapter,
		enum halmac_gpio_func gpio_func,
		const struct halmac_gpio_pimux_list **list,
		u32 *list_size, u32 *gpio_id);

static enum halmac_ret_status chk_pinmux_valid_8822b(
 ...
 */
enum halmac_ret_status pinmux_get_func_8822b(struct halmac_adapter
		*adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status pinmux_set_func_8822b(struct halmac_adapter
		*adapter,
		enum halmac_gpio_func gpio_func)
{
	u32 list_size;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status pinmux_free_func_8822b(struct halmac_adapter
		*adapter,
		enum halmac_gpio_func gpio_func)
{
