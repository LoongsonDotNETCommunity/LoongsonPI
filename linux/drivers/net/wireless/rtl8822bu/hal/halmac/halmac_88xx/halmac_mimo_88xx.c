...
static void cfg_mu_bfee_88xx(struct halmac_adapter *adapter,
			     struct halmac_cfg_mumimo_para *param);

static void cfg_mu_bfer_88xx(struct halmac_adapter *adapter,
			     struct halmac_cfg_mumimo_para *param);

static enum halmac_cmd_construct_state fw_snding_cmd_cnstr_state_88xx(
	struct halmac_adapter *adapter);

static enum halmac_ret_status cnv_fw_snding_state_88xx(
	struct halmac_adapter *adapter,
	enum halmac_cmd_construct_state dest_state);

static u8 snding_pkt_chk_88xx(struct halmac_adapter *adapter, u8 *pkt);
 ...
 */
enum halmac_ret_status cfg_txbf_88xx(struct halmac_adapter *adapter,
				     u8 userid, enum halmac_bw bw,
				     u8 txbf_en)
{
	u16 tmp42c = 0;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_mumimo_88xx(struct halmac_adapter *adapter,
				       struct halmac_cfg_mumimo_para *param)
{
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_sounding_88xx(struct halmac_adapter *adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status del_sounding_88xx(struct halmac_adapter *adapter,
		enum halmac_snd_role role)
{
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status su_bfee_entry_init_88xx(struct halmac_adapter
		*adapter, u8 userid, u16 paid)
{
	u16 tmp42c = 0;
	u16 tmp168x = 0;
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status su_bfer_entry_init_88xx(struct halmac_adapter
		*adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status mu_bfee_entry_init_88xx(struct halmac_adapter
		*adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status mu_bfer_entry_init_88xx(struct halmac_adapter
		*adapter,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status su_bfee_entry_del_88xx(struct halmac_adapter
		*adapter, u8 userid)
{
	u16 value16;
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status su_bfer_entry_del_88xx(struct halmac_adapter
		*adapter, u8 userid)
{
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status mu_bfee_entry_del_88xx(struct halmac_adapter
		*adapter, u8 userid)
{
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status mu_bfer_entry_del_88xx(struct halmac_adapter
		*adapter)
{
	struct halmac_api *api = (struct halmac_api *)adapter->halmac_api;
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status cfg_csi_rate_88xx(struct halmac_adapter *adapter,
		u8 rssi, u8 cur_rate,
 ...
 * More details of status code can be found in prototype document
 */
enum halmac_ret_status fw_snding_88xx(struct halmac_adapter *adapter,
...
enum halmac_ret_status get_h2c_ack_fw_snding_88xx(struct halmac_adapter
...
enum halmac_ret_status get_fw_snding_status_88xx(struct halmac_adapter
		*adapter,
		enum halmac_cmd_process_status *proc_status)
{
	*proc_status = adapter->halmac_state.fw_snding_state.proc_status;
