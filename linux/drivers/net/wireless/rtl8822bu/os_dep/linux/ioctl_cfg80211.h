...
#if defined(RTW_DEDICATED_P2P_DEVICE)
int rtw_cfg80211_redirect_pd_wdev(struct wiphy *wiphy, u8 *ra,
...
void rtw_cfg80211_rx_p2p_action_public(_adapter *padapter,
				       union recv_frame *rframe);
void rtw_cfg80211_rx_action_p2p(_adapter *padapter,
				union recv_frame *rframe);
...
void rtw_cfg80211_rx_mframe(_adapter *adapter, union recv_frame *rframe,
			    const char *msg);
void rtw_cfg80211_rx_probe_request(_adapter *padapter,
				   union recv_frame *rframe);
