...
#define RNP_N10_MAX_VF 8
#define RNP_N10_RSS_TBL_NUM 128
#define RNP_N10_RSS_TC_TBL_NUM 8
#define RNP_VU440_MAX_TX_QUEUES 8
#define RNP_VU440_MAX_RX_QUEUES 8

#ifdef NIC_VF_FXIED
#define RNP_N10_RAR_ENTRIES 127
#else
#define RNP_N10_RAR_ENTRIES 128
#endif
#define RNP_N10_MC_TBL_SIZE 128
#define RNP_N10_VFT_TBL_SIZE 128
#define RNP_N10_RX_PB_SIZE 512
#define RNP_VU440_MSIX_VECTORS 16
...
static void rnp_init_mac_link_ops_vu440(struct rnp_hw *hw)
{
}


/**
 *  rnp_init_phy_ops_vu440 - PHY/SFP specific init
 ...
 *
 **/
static s32 rnp_init_phy_ops_vu440(struct rnp_hw *hw)
{
...
static s32 rnp_setup_sfp_modules_vu440(struct rnp_hw *hw)
{
	return 0;
}

/**
 *  rnp_reinit_fdir_tables_vu440 - Reinitialize Flow Director tables.
 *  @hw: pointer to hardware structure
 **/
s32 rnp_reinit_fdir_tables_vu440(struct rnp_hw *hw)
{
	return 0;
}

/**
 *  rnp_fdir_enable_vu440 - Initialize Flow Director control registers
 *  @hw: pointer to hardware structure
 *  @fdirctrl: value to write to flow director control register
 **/
static void rnp_fdir_enable_vu440(struct rnp_hw *hw, u32 fdirctrl)
{
}

/**
 *  rnp_init_fdir_signature_vu440 - Initialize Flow Director signature filters
 *  @hw: pointer to hardware structure
 *  @fdirctrl: value to write to flow director control register, initially
 *             contains just the value of the Rx packet buffer allocation
 **/
s32 rnp_init_fdir_signature_vu440(struct rnp_hw *hw, u32 fdirctrl)
{
#if 0
	/*
	...
	rnp_fdir_enable_vu440(hw, fdirctrl);
#endif
...
/**
 *  rnp_init_fdir_perfect_vu440 - Initialize Flow Director perfect filters
 *  @hw: pointer to hardware structure
 *  @fdirctrl: value to write to flow director control register, initially
 *             contains just the value of the Rx packet buffer allocation
 **/
s32 rnp_init_fdir_perfect_vu440(struct rnp_hw *hw, u32 fdirctrl)
{
#if 0
	/*
	 * Continue setup of fdirctrl register bits:
...
/**
 *  rnp_atr_compute_sig_hash_vu440 - Compute the signature hash
 ...
 **/
static u32 rnp_atr_compute_sig_hash_vu440(union rnp_atr_hash_dword input,
...
/**
 *  rnp_atr_add_signature_filter_vu440 - Adds a signature hash filter
 *  @hw: pointer to hardware structure
 *  @input: unique input dword
 *  @common: compressed common input dword
 *  @queue: queue index to direct traffic to
 **/
s32 rnp_fdir_add_signature_filter_vu440(struct rnp_hw *hw,
					...
					u8 queue)
{
	...
	fdirhashcmd |= rnp_atr_compute_sig_hash_vu440(input, common);
...
/**
 *  rnp_atr_compute_perfect_hash_vu440 - Compute the perfect filter hash
 ...
 **/
void rnp_atr_compute_perfect_hash_vu440(union rnp_atr_input *input,
...
/**
 *  rnp_get_fdirtcpm_vu440 - generate a tcp port from atr_input_masks
 ...
 **/
static u32 rnp_get_fdirtcpm_vu440(union rnp_atr_input *input_mask)
{
#if 0
...
s32 rnp_fdir_set_input_mask_vu440(struct rnp_hw *hw,
				  union rnp_atr_input *input_mask)
{
#if 0
	...
	fdirtcpm = rnp_get_fdirtcpm_vu440(input_mask);
...
s32 rnp_fdir_write_perfect_filter_vu440(struct rnp_hw *hw,
...
s32 rnp_fdir_erase_perfect_filter_vu440(struct rnp_hw *hw,
					union rnp_atr_input *input, u16 soft_id)
{
	u32 fdirhash;
	u32 fdircmd = 0;
...
/**
 *  rnp_identify_phy_vu440 - Get physical layer module
 *  @hw: pointer to hardware structure
 *
 ...
 **/
static s32 rnp_identify_phy_vu440(struct rnp_hw *hw)
{
...
static s32 rnp_identify_sfp_module_vu440(struct rnp_hw *hw)
{
...
/**
 *  rnp_verify_fw_version_vu440 - verify fw version for vu440
 *  @hw: pointer to hardware structure
 *
 ...
 **/
static s32 rnp_verify_fw_version_vu440(struct rnp_hw *hw)
{
...
/**
 *  rnp_verify_lesm_fw_enabled_vu440 - Checks LESM FW module state.
 *  @hw: pointer to hardware structure
 *
 *  Returns true if the LESM FW module is present and enabled. Otherwise
 *  returns false. Smart Speed must be disabled if LESM FW module is enabled.
 **/
bool rnp_verify_lesm_fw_enabled_vu440(struct rnp_hw *hw)
{
...
/**
 *  rnp_read_eeprom_buffer_vu440 - Read EEPROM word(s) using
 ...
 **/
static s32 rnp_read_eeprom_buffer_vu440(struct rnp_hw *hw, u16 offset,
					u16 words, u16 *data)
{
...
/**
 *  rnp_read_eeprom_vu440 - Read EEPROM word using
 *  fastest available method
 *
 *  @hw: pointer to hardware structure
 ...
 **/
static s32 rnp_read_eeprom_vu440(struct rnp_hw *hw, u16 offset, u16 *data)
{
	struct rnp_eeprom_info *eeprom = &hw->eeprom;
	s32 ret_val = RNP_ERR_CONFIG;
...
/**
 * rnp_reset_pipeline_vu440 - perform pipeline reset
 *
 * @hw: pointer to hardware structure
 *
 ...
 **/
s32 rnp_reset_pipeline_vu440(struct rnp_hw *hw)
{
	s32 ret_val;
	u32 anlp1_reg = 0;
...
/**
 *  rnp_reset_hw_vu440 - Perform hardware reset
 *  @hw: pointer to hardware structure
 *
 ...
 *  reset.
 **/
//static s32 rnp_reset_hw_vu440(struct rnp_hw *hw)
//{
//	int i;
//	s32 status;
//	u32 reg = 0;
...
/**
 *  rnp_start_hw_vu440 - Prepare hardware for Tx/Rx
 *  @hw: pointer to hardware structure
 *
 ...
 **/
//static s32 rnp_start_hw_vu440(struct rnp_hw *hw)
//{
//	s32 ret_val = 0;
//	int i;
//
...
//
//	if (ret_val == 0)
//		ret_val = rnp_verify_fw_version_vu440(hw);
//out:
//	return ret_val;
//}

/**
 *  rnp_get_media_type_vu440 - Get media type
 *  @hw: pointer to hardware structure
 *
 *  Returns the media type (fiber, copper, backplane)
 **/
static enum rnp_media_type rnp_get_media_type_vu440(struct rnp_hw *hw)
{
...
/**
 *  rnp_get_supported_physical_layer_vu440 - Returns physical layer type
 *  @hw: pointer to hardware structure
 *
 *  Determines physical layer capabilities of the current configuration.
 **/
static u32 rnp_get_supported_physical_layer_vu440(struct rnp_hw *hw)
{
	u32 physical_layer = 0;
	return physical_layer;
}

static s32 rnp_get_link_capabilities_vu440(struct rnp_hw *hw,
...
/**
 *  rnp_get_mac_addr_vu440 - Generic get MAC address
 *  @hw: pointer to hardware structure
 ...
 **/
s32 rnp_get_mac_addr_vu440(struct rnp_eth_info *eth, u8 *mac_addr)
{
...
static struct rnp_phy_operations phy_ops_vu440 = {
	.identify = &rnp_identify_phy_vu440,
	.identify_sfp = &rnp_identify_sfp_module_vu440,
	.init = &rnp_init_phy_ops_vu440,
...
static void rnp_dma_set_tx_maxrate_vu440(struct rnp_dma_info *dma, u16 queue, u32 max_rate)
{
...
static void rnp_dma_set_veb_mac_vu440(struct rnp_dma_info *dma, u8 *mac, u32 vfnum, u32 ring)
{
...
static void rnp_dma_set_veb_vlan_vu440(struct rnp_dma_info *dma, u16 vlan, u32 vfnum)
{
	int port;
...
static void rnp_dma_clr_veb_all_vu440(struct rnp_dma_info *dma)
{
	int port, i;
...
static struct rnp_dma_operations dma_ops_vu440 = {
	.set_tx_maxrate = &rnp_dma_set_tx_maxrate_vu440,
	.set_veb_mac = &rnp_dma_set_veb_mac_vu440,
	.set_veb_vlan = &rnp_dma_set_veb_vlan_vu440,
	.clr_veb_all = &rnp_dma_clr_veb_all_vu440,
...
// eth ops
/**
 *  rnp_eth_set_rar_vu440 - Set Rx address register
...
/**
 *  rnp_eth_clear_rar_vu440 - Remove Rx address register
 *  @eth: pointer to eth structure
 *  @index: Receive address register to write
 *
 *  Clears an ethernet address from a receive address register.
 **/
s32 rnp_eth_clear_rar_vu440(struct rnp_eth_info *eth, u32 index)
{
	u32 rar_high;
	u32 rar_entries = eth->num_rar_entries;
...
/**
 *  rnp_eth_set_vmdq_vu440 - Associate a VMDq pool index with a rx address
 *  @eth: pointer to eth struct
 *  @rar: receive address register index to associate with a VMDq index
 *  @vmdq: VMDq pool index
 *  only mac->vf
 **/
s32 rnp_eth_set_vmdq_vu440(struct rnp_eth_info *eth, u32 rar, u32 vmdq)
{
	u32 mpsar;
	u32 rar_entries = eth->num_rar_entries;
...
/**
 *  rnp_eth_clear_vmdq_vu440 - Disassociate a VMDq pool index from a rx address
 *  @eth: pointer to eth struct
 *  @rar: receive address register index to disassociate
 *  @vmdq: VMDq pool index to remove from the rar
 **/
s32 rnp_eth_clear_vmdq_vu440(struct rnp_eth_info *eth, u32 rar, u32 vmdq)
{
	u32 rar_entries = eth->num_rar_entries;
...
/**
 *  rnp_update_mc_addr_list_vu440 - Updates MAC list of multicast addresses
 *  @hw: pointer to hardware structure
 ...
 *  multicast table.
 **/
s32 rnp_eth_update_mc_addr_list_vu440(struct rnp_eth_info *eth,
...
/* clean all mc addr */
void rnp_eth_clr_mc_addr_vu440(struct rnp_eth_info *eth)
{
	int i;
...
/**
 *  rnp_eth_update_rss_key_vu440 - Remove Rx address register
 *  @eth: pointer to eth structure
...
void rnp_eth_update_rss_key_vu440(struct rnp_eth_info *eth, bool sriov_flag)
{
	struct rnp_hw *hw = (struct rnp_hw *)eth->back;
	int i;
	u8 *key_temp;
...
/**
 *  rnp_eth_update_rss_table_vu440 - Remove Rx address register
 *  @eth: pointer to eth structure
 *
 *  update rss table to eth regs
 **/
void rnp_eth_update_rss_table_vu440(struct rnp_eth_info *eth)
{
	struct rnp_hw *hw = (struct rnp_hw *)eth->back;
...
/**
 *  rnp_eth_set_vfta_vu440 - Set VLAN filter table
 *  @eth: pointer to eth structure
 ...
 **/
s32 rnp_eth_set_vfta_vu440(struct rnp_eth_info *eth, u32 vlan, bool vlan_on)
{
	s32 regindex;
	u32 bitindex;
	u32 vfta;
...
void rnp_eth_clr_vfta_vu440(struct rnp_eth_info *eth)
{
	u32 offset;
...
/**
 *  rnp_eth_set_vlan_filter_vu440 - Set VLAN filter table
 *  @eth: pointer to eth structure
 *  @status: on |off
 *  Turn on/off VLAN filter table.
 **/
static void rnp_eth_set_vlan_filter_vu440(struct rnp_eth_info *eth, bool status)
{
...
u16 rnp_layer2_pritologic_vu440(u16 hw_id)
{
	return hw_id;
}

void rnp_eth_set_layer2_vu440(struct rnp_eth_info *eth, union rnp_atr_input *input,
				u16 pri_id, u8 queue)
{
	u16 hw_id;

	hw_id = rnp_layer2_pritologic_vu440(pri_id);
	/* enable layer2 */
...
void rnp_eth_clr_layer2_vu440(struct rnp_eth_info *eth, u16 pri_id)
{
	u16 hw_id;
...
void rnp_eth_clr_all_layer2_vu440(struct rnp_eth_info *eth)
{
	int i;
#define RNP10_MAX_LAYER2_FILTERS 16
...
u16 rnp_tuple5_pritologic_vu440(u16 hw_id)
{
	return hw_id;
}

u16 rnp_tuple5_pritologic_tcam_vu440(u16 pri_id)
{
	int i;
	int hw_id = 0;
	int step = 32;
...
void rnp_eth_set_tuple5_vu440(struct rnp_eth_info *eth, union rnp_atr_input *input,
				u16 pri_id, u8 queue)
{
	struct rnp_hw *hw = (struct rnp_hw *)eth->back;
...
#define RNP10_L4_PROTO_MASK BIT(4)
	...
	if (hw->fdir_mode != fdir_mode_tcam) {
		...
		hw_id = rnp_tuple5_pritologic_vu440(pri_id);	
		...
		hw_id = rnp_tuple5_pritologic_tcam_vu440(pri_id);
...
void rnp_eth_clr_tuple5_vu440(struct rnp_eth_info *eth, u16 pri_id)
{
	u16 hw_id;
	struct rnp_hw *hw = (struct rnp_hw *)eth->back;
...
void rnp_eth_clr_all_tuple5_vu440(struct rnp_eth_info *eth)
{
	int i;
...
static void rnp_eth_set_min_max_packets_vu440(struct rnp_eth_info *eth, int min, int max)
{
	eth_wr32(eth, RNP10_ETH_DEFAULT_RX_MIN_LEN, min); 	
	eth_wr32(eth, RNP10_ETH_DEFAULT_RX_MAX_LEN, max); 	
}

static void rnp_eth_set_vlan_strip_vu440(struct rnp_eth_info *eth, u16 queue, bool enable)
{
...
static void rnp_eth_set_vxlan_port_vu440(struct rnp_eth_info *eth, u32 port)
{
	eth_wr32(eth, RNP10_ETH_VXLAN_PORT, port);
}

static void rnp_eth_set_vxlan_mode_vu440(struct rnp_eth_info *eth, bool inner)
{
	if (inner)
...
static void rnp_eth_set_rx_hash_vu440(struct rnp_eth_info *eth, bool status, bool sriov_flag)
{
	u32 iov_en = (sriov_flag) ? RNP10_IOV_ENABLED : 0;
...
static s32 rnp_eth_set_fc_mode_vu440(struct rnp_eth_info *eth)
{
	struct rnp_hw *hw = (struct rnp_hw *)eth->back;
	s32 ret_val = 0;
	int i;
...
static struct rnp_eth_operations eth_ops_vu440 = {
	.set_rar = &rnp_eth_set_rar_vu440,
	.clear_rar = &rnp_eth_clear_rar_vu440,
	.set_vmdq = &rnp_eth_set_vmdq_vu440,
	.clear_vmdq = &rnp_eth_clear_vmdq_vu440,
	//.get_mac_addr = &rnp_eth_get_mac_addr_vu440,

	.update_mc_addr_list = &rnp_eth_update_mc_addr_list_vu440,
	.clr_mc_addr = &rnp_eth_clr_mc_addr_vu440,

	/* store rss info to eth */
	.set_rss_key = &rnp_eth_update_rss_key_vu440,
	.set_rss_table = &rnp_eth_update_rss_table_vu440,
	.set_vfta = &rnp_eth_set_vfta_vu440,
	.clr_vfta = &rnp_eth_clr_vfta_vu440,
	.set_vlan_filter = &rnp_eth_set_vlan_filter_vu440,

	.set_layer2_remapping = &rnp_eth_set_layer2_vu440,
	.clr_layer2_remapping = &rnp_eth_clr_layer2_vu440,
	.clr_all_layer2_remapping = &rnp_eth_clr_all_layer2_vu440,
	.set_tuple5_remapping = &rnp_eth_set_tuple5_vu440,
	.clr_tuple5_remapping = &rnp_eth_clr_tuple5_vu440,
	.clr_all_tuple5_remapping = &rnp_eth_clr_all_tuple5_vu440,

	.set_min_max_packet = &rnp_eth_set_min_max_packets_vu440,
	.set_vlan_strip = &rnp_eth_set_vlan_strip_vu440,
	.set_vxlan_port = &rnp_eth_set_vxlan_port_vu440,
	.set_vxlan_mode = &rnp_eth_set_vxlan_mode_vu440,
	.set_rx_hash = &rnp_eth_set_rx_hash_vu440,
	.set_fc_mode = &rnp_eth_set_fc_mode_vu440,
	// setup init sriov
...
/**
 *  rnp_init_hw_vu440 - Generic hardware initialization
 *  @hw: pointer to hardware structure
 *
 ...
 **/
s32 rnp_init_hw_ops_vu440(struct rnp_hw *hw)
{
	s32 status = 0;
...
s32 rnp_get_permtion_mac_addr_vu440(struct rnp_hw *hw, u8 *mac_addr)
{
	u32 v;
...
s32 rnp_reset_hw_ops_vu440(struct rnp_hw *hw)
{
	int i;
	s32 status;
	u32 reg = 0;
...
#define N10_NIC_RESET 0
...
#endif
	/* should set all tx-start to 1 */
	for (i = 0; i < RNP_VU440_MAX_TX_QUEUES; i++)
		dma_ring_wr32(dma, RING_OFFSET(i) + RNP_DMA_TX_START, 1);
	...
	// set 2046 --> 0x18070
	eth_wr32(eth, RNP10_ETH_RX_PROGFULL_THRESH_PORT, 2046);

	msleep(1000);
	mac_wr32(mac, RNP10_MAC_TX_CFG, 0x00010001);
	mac_wr32(mac, RNP10_MAC_RX_CFG, 0x07d001c7);
	/* Identify PHY and related function pointers */
	//status = hw->phy.ops.init(hw);
	...
	/* Store the permanent mac address */
	if (!(hw->mac.mac_flags & RNP_FLAGS_INIT_MAC_ADDRESS)) {
		rnp_get_permtion_mac_addr_vu440(hw, hw->mac.perm_addr);
		memcpy(hw->mac.addr, hw->mac.perm_addr, ETH_ALEN);
	}
...
s32 rnp_start_hw_ops_vu440(struct rnp_hw *hw)
{
	s32 ret_val = 0;
	int i;
	struct rnp_eth_info *eth = &hw->eth;
...
/* set vu440 min/max packet according to new_mtu 
 * we support mtu + 14 + 4 * 3 as max packet len*/
static void rnp_set_mtu_hw_ops_vu440(struct rnp_hw *hw, int new_mtu)
{
	struct rnp_eth_info *eth = &hw->eth;
...
/* setup vu440 vlan filter status */
static void rnp_set_vlan_filter_en_hw_ops_vu440(struct rnp_hw *hw, bool status)
{
	struct rnp_eth_info *eth = &hw->eth;
	eth->ops.set_vlan_filter(eth, status);
}

/* set vlan to vu440 vlan filter table & veb */
/* pf setup call */
static void rnp_set_vlan_filter_hw_ops_vu440(struct rnp_hw *hw, u16 vid, bool enable, bool sriov_flag)
{
	struct rnp_eth_info *eth = &hw->eth;
	struct rnp_dma_info *dma = &hw->dma;
...
static void rnp_set_vf_vlan_filter_hw_ops_vu440(struct rnp_hw *hw, u16 vid, int vf, bool enable, bool veb_only)
{
	struct rnp_eth_info *eth = &hw->eth;
	struct rnp_dma_info *dma = &hw->dma;
...
static void rnp_clr_vlan_veb_hw_ops_vu440(struct rnp_hw *hw)
{
	struct rnp_dma_info *dma = &hw->dma;
	u32 vfnum = hw->vfnum;
...
/* setup vu440 vlan strip status */
static void rnp_set_vlan_strip_hw_ops_vu440(struct rnp_hw *hw, u16 queue, bool strip)
{
	struct rnp_eth_info *eth = &hw->eth;
...
/* update new vu440 mac */
static void rnp_set_mac_hw_ops_vu440(struct rnp_hw *hw, u8 *mac, bool sriov_flag)
{
	struct rnp_eth_info *eth = &hw->eth;
	struct rnp_dma_info *dma = &hw->dma;
 ...
 **/
static int rnp_write_uc_addr_list_vu440(struct rnp_hw *hw, struct net_device *netdev, bool sriov_flag)
{
...
static void rnp_set_rx_mode_hw_ops_vu440(struct rnp_hw *hw, struct net_device *netdev, bool sriov_flag)
{
	 ...
	 */
	if (rnp_write_uc_addr_list_vu440(hw, netdev, sriov_flag) < 0) {
...
static void rnp_set_rar_with_vf_hw_ops_vu440(struct rnp_hw *hw, u8 *mac,
...
static void rnp_clr_rar_hw_ops_vu440(struct rnp_hw *hw, int idx)
{
	struct rnp_eth_info *eth = &hw->eth;
...
static void rnp_set_fcs_mode_hw_ops_vu440(struct rnp_hw *hw, bool status)
{
	struct rnp_mac_info *mac = &hw->mac;
	// call mac to up fcs
...
static void rnp_set_vxlan_port_hw_ops_vu440(struct rnp_hw *hw, u32 port)
{
	struct rnp_eth_info *eth = &hw->eth;
...
static void rnp_set_vxlan_mode_hw_ops_vu440(struct rnp_hw *hw, bool inner)
{
	struct rnp_eth_info *eth = &hw->eth;
...
static void rnp_set_mac_rx_hw_ops_vu440(struct rnp_hw *hw, bool status)
{
	struct rnp_mac_info *mac = &hw->mac;
	struct rnp_eth_info *eth = &hw->eth;
	...
	//set mac rx status
	if (status)
		eth_wr32(eth, RNP10_ETH_RX_PROGFULL_THRESH_PORT, 0x270);
	else 
		eth_wr32(eth, RNP10_ETH_RX_PROGFULL_THRESH_PORT, 2046);
 
}

static void rnp_set_sriov_status_hw_ops_vu440(struct rnp_hw *hw, bool status)
{
	struct rnp_dma_info *dma = &hw->dma;
	struct rnp_eth_info *eth = &hw->eth;
	u32 v;
...
//static void rnp_set_sriov_vf_mac_hw_ops_vu440(struct rnp_hw *hw, u8 *mac, int vf, bool enable)
//{
//
//	struct rnp_eth_info *eth = &hw->eth;
...
//
//}
static void rnp_set_sriov_vf_mc_hw_ops_vu440(struct rnp_hw *hw, u16 mc_addr)
{
	struct rnp_eth_info *eth = &hw->eth;
	u32 vector_bit;
	u32 vector_reg;
...
/*static void rnp_set_sriov_vf_vlan_hw_ops_vu440(struct rnp_hw *hw, int vf, u16 vlan ,u8 qos)
  {

	// setup veb only ?
}*/

static void rnp_update_sriov_info_hw_ops_vu440(struct rnp_hw *hw)
{

	// update sriov info to hw 
}

static void rnp_set_pause_mode_hw_ops_vu440(struct rnp_hw *hw)
{
	struct rnp_mac_info *mac = &hw->mac;
	struct rnp_eth_info *eth = &hw->eth;
...
static void rnp_update_hw_info_hw_ops_vu440(struct rnp_hw *hw)
{
	struct rnp_dma_info *dma = &hw->dma;
	struct rnp_eth_info *eth = &hw->eth;
	struct rnp_adapter *adapter = (struct rnp_adapter *)hw->back;
...
static void rnp_set_rx_hash_hw_ops_vu440(struct rnp_hw *hw, bool status, bool sriov_flag)
{
	struct rnp_eth_info *eth = &hw->eth;
 ...
 * clean vmdq 
 * clean mc addr */
static s32 rnp_init_rx_addrs_hw_ops_vu440(struct rnp_hw *hw)
{
	struct rnp_eth_info *eth = &hw->eth;
...
static void rnp_clr_vfta_hw_ops_vu440(struct rnp_hw *hw)
{
	struct rnp_eth_info *eth = &hw->eth;
...
static void rnp_set_txvlan_mode_hw_ops_vu440(struct rnp_hw *hw, bool cvlan)
{
	struct rnp_mac_info *mac = &hw->mac;
	if (cvlan) {
...
static void rnp_set_rss_key_hw_ops_vu440(struct rnp_hw *hw, bool sriov_flag)
{
	struct rnp_eth_info *eth = &hw->eth;
	struct rnp_adapter *adapter = (struct rnp_adapter *)hw->back;
	int key_len = RNP_RSS_KEY_SIZE;
...
static void rnp_set_rss_table_hw_ops_vu440(struct rnp_hw *hw)
{
	struct rnp_adapter *adapter = (struct rnp_adapter *)hw->back;
	u32 reta_entries = hw->rss_indir_tbl_num;
	u32 tc_entries = hw->rss_tc_tbl_num;
...
static void rnp_set_mbx_link_event_hw_ops_vu440(struct rnp_hw *hw, int enable)
{
#ifndef NO_MBX_VERSION
...
static void rnp_set_mbx_ifup_hw_ops_vu440(struct rnp_hw *hw, int enable)
{
#ifndef NO_MBX_VERSION
...
/**
 *  rnp_check_mac_link_vu440 - Determine link and speed status
 *  @hw: pointer to hardware structure
 ...
 **/
s32 rnp_check_mac_link_hw_ops_vu440(struct rnp_hw *hw,
...
s32 rnp_setup_mac_link_hw_ops_vu440(struct rnp_hw *hw, u32 adv, bool enable)
{
...
void rnp_clean_link_hw_ops_vu440(struct rnp_hw *hw)
{
	hw->link = 0;	
	wr32(hw, RNP_ETH_EXCEPT_DROP_PROC, 0xf);
}

static void rnp_set_layer2_hw_ops_vu440(struct rnp_hw *hw, union rnp_atr_input *input,
	u16 pri_id, u8 queue)
{
	struct rnp_eth_info *eth = &hw->eth;
...
static void rnp_clr_layer2_hw_ops_vu440(struct rnp_hw *hw, u16 pri_id)
{
	struct rnp_eth_info *eth = &hw->eth;
...
static void rnp_clr_all_layer2_hw_ops_vu440(struct rnp_hw *hw)
{
	struct rnp_eth_info *eth = &hw->eth;
...
static void rnp_clr_all_tuple5_hw_ops_vu440(struct rnp_hw *hw)
{
	struct rnp_eth_info *eth = &hw->eth;
...
static void rnp_set_tuple5_hw_ops_vu440(struct rnp_hw *hw, union rnp_atr_input *input,
	u16 pri_id, u8 queue)
{
	struct rnp_eth_info *eth = &hw->eth;
...
static void rnp_clr_tuple5_hw_ops_vu440(struct rnp_hw *hw, u16 pri_id)
{
	struct rnp_eth_info *eth = &hw->eth;
...
static void rnp_update_hw_status_hw_ops_vu440(struct rnp_hw *hw,
...
enum vu440_priv_bits
{
	vu440_mac_loopback = 0,
	vu440_switch_loopback = 1,
	vu440_veb_enable = 4,
	vu440_padding_enable = 8,
	vu440_padding_debug_enable = 0x10,
};

static const char rnp440_priv_flags_strings[][ETH_GSTRING_LEN] = {
...
#define RNP440_PRIV_FLAGS_STR_LEN ARRAY_SIZE(rnp440_priv_flags_strings)
#endif

const struct rnp_stats rnp440_gstrings_net_stats[] = {
...
#define RNP440_GLOBAL_STATS_LEN ARRAY_SIZE(rnp440_gstrings_net_stats)

static struct rnp_stats rnp440_hwstrings_stats[] = {
...
#define RNP440_HWSTRINGS_STATS_LEN ARRAY_SIZE(rnp440_hwstrings_stats)

#define RNP440_STATS_LEN \
	(RNP440_GLOBAL_STATS_LEN + RNP440_HWSTRINGS_STATS_LEN + RNP_QUEUE_STATS_LEN)


#ifndef CLOST_SELF_TEST
#ifdef ETHTOOL_TEST
static const char rnp440_gstrings_test[][ETH_GSTRING_LEN] = {
...
#define RNP440_TEST_LEN (sizeof(rnp440_gstrings_test) / ETH_GSTRING_LEN)
#else
#define RNP440_TEST_LEN 0
#endif
#else
#define RNP440_TEST_LEN 0
#endif
		...
		struct ethtool_drvinfo *drvinfo)
{
	...
	drvinfo->n_stats = RNP440_STATS_LEN;
	drvinfo->testinfo_len = RNP440_TEST_LEN;
	drvinfo->regdump_len = rnp10_get_regs_len(netdev);
#ifdef HAVE_ETHTOOL_GET_SSET_COUNT
	drvinfo->n_priv_flags = RNP440_PRIV_FLAGS_STR_LEN;
#endif
}
...
#ifndef CLOST_SELF_TEST
		case ETH_SS_TEST:
			for (i = 0; i < RNP440_TEST_LEN; i++) {
				memcpy(data, rnp440_gstrings_test[i], ETH_GSTRING_LEN);
				data += ETH_GSTRING_LEN;
			}
			break;
#endif
		case ETH_SS_STATS:
			for (i = 0; i < RNP440_GLOBAL_STATS_LEN; i++) {
				memcpy(
					p, rnp440_gstrings_net_stats[i].stat_string, ETH_GSTRING_LEN);
				p += ETH_GSTRING_LEN;
			}
			for (i = 0; i < RNP440_HWSTRINGS_STATS_LEN; i++) {
				memcpy(p, rnp440_hwstrings_stats[i].stat_string, ETH_GSTRING_LEN);
				p += ETH_GSTRING_LEN;
			}
...
#define SHORT_STATS
		...
		case ETH_SS_PRIV_FLAGS:
			memcpy(data,
				   rnp440_priv_flags_strings,
				   RNP440_PRIV_FLAGS_STR_LEN * ETH_GSTRING_LEN);
			break;
...
#ifndef CLOST_SELF_TEST
		case ETH_SS_TEST:
			return RNP440_TEST_LEN;
#endif
		case ETH_SS_STATS:
			return RNP440_STATS_LEN;
		case ETH_SS_PRIV_FLAGS:
			return RNP440_PRIV_FLAGS_STR_LEN;
		default:
			return -EOPNOTSUPP;
	}
}
...
static int rnp10_set_priv_flags(struct net_device *netdev, u32 priv_flags)
{
	...
	if (CHK_BIT(vu440_padding_enable, data_old) !=
		CHK_BIT(vu440_padding_enable, data_new)) {
		...
		u64 *data)
{
	...
	for (i = 0; i < RNP440_GLOBAL_STATS_LEN; i++) {
		p = (char *)net_stats + rnp440_gstrings_net_stats[i].stat_offset;
		data[i] = (rnp440_gstrings_net_stats[i].sizeof_stat == sizeof(u64))
					  ? *(u64 *)p
					  : *(u32 *)p;
	}
	for (j = 0; j < RNP440_HWSTRINGS_STATS_LEN; j++, i++) {
		p = (char *)adapter + rnp440_hwstrings_stats[j].stat_offset;
		data[i] = (rnp440_hwstrings_stats[j].sizeof_stat == sizeof(u64))
					  ? *(u64 *)p
					  : *(u32 *)p;
	}
...
void rnp_set_ethtool_hw_ops_vu440(struct net_device *netdev)
{
...
static struct rnp_hw_operations hw_ops_vu440 = {
	.init_hw = &rnp_init_hw_ops_vu440,
	.reset_hw = &rnp_reset_hw_ops_vu440,
	.start_hw = &rnp_start_hw_ops_vu440,

	.set_mtu = &rnp_set_mtu_hw_ops_vu440,
	.set_vlan_filter_en = &rnp_set_vlan_filter_en_hw_ops_vu440,
	.set_vlan_filter = &rnp_set_vlan_filter_hw_ops_vu440,
	.set_vf_vlan_filter = &rnp_set_vf_vlan_filter_hw_ops_vu440,
	.set_vlan_strip = &rnp_set_vlan_strip_hw_ops_vu440,
	.set_mac = &rnp_set_mac_hw_ops_vu440,
	//.set_virtualization = &rnp_set_virtualization_vu440, 
	.set_rx_mode = &rnp_set_rx_mode_hw_ops_vu440,
	// only update rar ,no veb
	.set_rar_with_vf = &rnp_set_rar_with_vf_hw_ops_vu440, 
	.clr_rar = &rnp_clr_rar_hw_ops_vu440,
	.clr_vlan_veb = &rnp_clr_vlan_veb_hw_ops_vu440,
	.set_txvlan_mode = &rnp_set_txvlan_mode_hw_ops_vu440,
	.set_fcs_mode = &rnp_set_fcs_mode_hw_ops_vu440,
	.set_vxlan_port = &rnp_set_vxlan_port_hw_ops_vu440,
	.set_vxlan_mode = &rnp_set_vxlan_mode_hw_ops_vu440,
	.set_mac_rx = &rnp_set_mac_rx_hw_ops_vu440,
	.set_rx_hash = &rnp_set_rx_hash_hw_ops_vu440,
	.set_pause_mode = &rnp_set_pause_mode_hw_ops_vu440,
	.update_hw_info = &rnp_update_hw_info_hw_ops_vu440,

	.update_sriov_info = &rnp_update_sriov_info_hw_ops_vu440,
	// sriov relative
	.set_sriov_status = &rnp_set_sriov_status_hw_ops_vu440,
	//.set_sriov_vf_mac = &rnp_set_sriov_vf_mac_hw_ops_vu440,
	.set_sriov_vf_mc = &rnp_set_sriov_vf_mc_hw_ops_vu440,
	//.set_sriov_vf_vlan = &rnp_set_sriov_vf_vlan_hw_ops_vu440,

	.init_rx_addrs = &rnp_init_rx_addrs_hw_ops_vu440,
	.clr_vfta = &rnp_clr_vfta_hw_ops_vu440,

	.set_rss_key = &rnp_set_rss_key_hw_ops_vu440,
	.set_rss_table = &rnp_set_rss_table_hw_ops_vu440,
	
	.update_hw_status = &rnp_update_hw_status_hw_ops_vu440,

	// mbx add here?
	.set_mbx_link_event = &rnp_set_mbx_link_event_hw_ops_vu440,
	.set_mbx_ifup = &rnp_set_mbx_ifup_hw_ops_vu440,
	// mbx write or read ?
	
	.check_link = &rnp_check_mac_link_hw_ops_vu440,
	.setup_link = &rnp_setup_mac_link_hw_ops_vu440,
	.clean_link = &rnp_clean_link_hw_ops_vu440,

	.set_layer2_remapping = &rnp_set_layer2_hw_ops_vu440,
	.clr_layer2_remapping = &rnp_clr_layer2_hw_ops_vu440,
	.clr_all_layer2_remapping = &rnp_clr_all_layer2_hw_ops_vu440,
	.set_tuple5_remapping = &rnp_set_tuple5_hw_ops_vu440,
	.clr_tuple5_remapping = &rnp_clr_tuple5_hw_ops_vu440,
	.clr_all_tuple5_remapping = &rnp_clr_all_tuple5_hw_ops_vu440,


	// ethtool callback 
	.setup_ethtool = &rnp_set_ethtool_hw_ops_vu440,
	// todo 
	//.set_rx_status = &rnp_rx_status_hw_ops_vu440;
	// setup mbx?
...
static void rnp_mac_set_rx_vu440(struct rnp_mac_info *mac, bool status)
{
	...
	if (status) {
		...
		if (adapter->flags & RNP_FLAG_SWITCH_LOOPBACK_EN) {
			mac_wr32(mac, RNP10_MAC_PKT_FLT, 0x00000001 | BIT(31) | BIT(4));
		} else {
...
static void rnp_mac_fcs_vu440(struct rnp_mac_info *mac, bool status)
{
	u32 value;
	// set acs cst
#define FCS_MASK (0x6)
...
/**
 *  rnp_fc_mode_vu440 - Enable flow control
 *  @hw: pointer to hardware structure
 *
 *  Enable flow control according to the current settings.
 **/
s32 rnp_mac_fc_mode_vu440(struct rnp_mac_info *mac)
{
	struct rnp_hw *hw = (struct rnp_hw *)mac->back;
	s32 ret_val = 0;
	u32 reg;
...
void rnp_mac_set_mac_vu440(struct rnp_mac_info *mac, u8 *addr, int index)
{
	u32 rar_low, rar_high = 0;
	rar_low = ((u32)addr[0] |
			((u32)addr[1] << 8) |
...
static struct rnp_mac_operations mac_ops_vu440 = {
	.set_mac_rx = &rnp_mac_set_rx_vu440,
	.set_mac_fcs = &rnp_mac_fcs_vu440,
	.set_fc_mode = &rnp_mac_fc_mode_vu440,
	.set_mac = &rnp_mac_set_mac_vu440,


//	.init_hw = &rnp_init_hw_generic,
//	.reset_hw = &rnp_reset_hw_vu440,
//
//	.start_hw = &rnp_start_hw_vu440,
//	.clear_hw_cntrs = &rnp_clear_hw_cntrs_generic,
//	.get_media_type = &rnp_get_media_type_vu440,
//	.get_supported_physical_layer = &rnp_get_supported_physical_layer_vu440,
//	.enable_rx_dma = &rnp_enable_rx_dma_vu440,
...
//	.get_link_capabilities = &rnp_get_link_capabilities_vu440,
...
//	.setup_sfp = &rnp_setup_sfp_modules_vu440,
//	.mng_fw_enabled = &rnp_mng_enabled,
};

static s32 rnp_get_invariants_vu440(struct rnp_hw *hw)
{
	struct rnp_mac_info *mac = &hw->mac;
	struct rnp_dma_info *dma = &hw->dma;
	struct rnp_eth_info *eth = &hw->eth;
	...
	dma->max_tx_queues = RNP_VU440_MAX_TX_QUEUES;
	dma->max_rx_queues = RNP_VU440_MAX_RX_QUEUES;
	dma->back = hw;
	memcpy(&hw->dma.ops, &dma_ops_vu440, sizeof(hw->dma.ops));

	/* setup eth info */
	memcpy(&hw->eth.ops, &eth_ops_vu440, sizeof(hw->eth.ops));
	...
	eth->max_rx_queues = RNP_VU440_MAX_RX_QUEUES;
	eth->max_tx_queues = RNP_VU440_MAX_TX_QUEUES;

	/* setup mac info */
	memcpy(&hw->mac.ops, &mac_ops_vu440, sizeof(hw->mac.ops));
	...
	mac->max_rx_queues = RNP_VU440_MAX_RX_QUEUES;
	mac->max_tx_queues = RNP_VU440_MAX_TX_QUEUES;
	//mac->max_msix_vectors = rnp_get_pcie_msix_count_generic(hw);
	mac->max_msix_vectors = RNP_VU440_MSIX_VECTORS;
	if (!hw->axi_mhz)
		hw->usecstocount = 62;
	else 
	...
	hw->max_msix_vectors = RNP_VU440_MSIX_VECTORS;
	...
	memcpy(&hw->ops, &hw_ops_vu440, sizeof(hw->ops));
	//sriov num

	/* PHY */
	memcpy(&hw->phy.ops, &phy_ops_vu440, sizeof(hw->phy.ops));
	/* setup pcs */
...
struct rnp_info rnp_vu440_2ports_info = {
	.one_pf_with_two_dma = false,
	.total_queue_pair_cnts = RNP_VU440_MAX_TX_QUEUES,
	.adapter_cnt = 1,
	.rss_type = rnp_rss_uv440,
	.hw_type = rnp_hw_n10,
	.get_invariants = &rnp_get_invariants_vu440,
